  ...
  topics: [
    ...
    topic({
      ...
      body: [
        ...
        "Weekly review process, updated: this paragraph originally said no dedicated weekly-review feature existed — that was accurate when written, but the platform has since shipped one. The Portfolio Workspace's Workflow Center (/portfolio-workspace) now has real, named weekly/monthly/quarterly review workflows, each with a persisted step checklist you start and check off yourself. It remains genuinely user-initiated, never calendar-scheduled or automated — see the Professional Institutional Workflows Academy's own 'Weekly & Monthly Review' lesson for the full detail. The Portfolio Health Trend chart described above (and the Report History/Trading Journal) are still real and still useful for the same purpose; the Workflow Center is simply the newer, more structured way to run that same cadence.",
      ],
      ...
      workflowSteps: [
        ...
        "For a structured weekly/monthly cadence, start a real Workflow Center review on the Portfolio Workspace — otherwise, revisit the Health Trend chart and your own Trading Journal entries on a cadence you set yourself.",
      ],
      metricsExplained: [
        ...
        { term: "Portfolio Health Trend", explanation: "A chart of your own saved Daily Reports' Health Score over 2W/1M/3M/all-time windows — real and useful, now complemented by the Portfolio Workspace's own structured, checklist-driven Weekly/Monthly Review workflows." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
      ...
      commonMistakes: [
        ...
        "Assuming no dedicated weekly-review feature exists — the Portfolio Workspace's Workflow Center now has a real, structured one; see the Professional Institutional Workflows Academy's 'Weekly & Monthly Review' lesson.",
      ],
      riskWarnings: [
      ...
      relatedModuleHrefs: ["/portfolio-ai", "/portfolio-analyst", "/institutional-mentor", "/portfolio-workspace"],
      aiCoachPrompts: [
...
const INSTITUTIONAL_INVESTING_PATH: LearningPath = {
  ...
  topics: [
    topic({
      key: "investing-executive-dashboard",
      title: "The Investing Dashboard: Account, Holdings, and Daily Workflow",
      summary: "Where a professional investor starts their day — condensed, honest reads of already-computed work, never a new score.",
      body: [
        "This platform has THREE dashboard-shaped screens that a learner could reasonably call 'the investing dashboard,' and confusing them is a real, easy mistake — this lesson names all three precisely so you land on the right one for what you're actually trying to do.",
        "The Executive Dashboard (/stock-analyst/executive-dashboard) is the genuine 'start my day' screen for the Institutional Investing Engine specifically: a Cross-Engine Snapshot of your own usage (portfolios, trades reviewed, strategies, reports, AI Coach views, learning topics), a Daily Executive Summary, Portfolio Health, Active Opportunities, a Monitoring Summary, Investment Committee Activity, AI Coach Progress, Recent Reports, Watchlists, Saved Research, and Recent Decisions — every single panel is a condensed, unmodified read of a report the Reporting Centre already computed elsewhere. It creates zero new valuation models, zero new scores, and zero new backend routes of its own.",
        "The Institutional Dashboard (/institutional-dashboard) is a DIFFERENT screen, covered in its own dedicated Platform Basics lesson — it's symbol-driven (you search one ticker and see Engine 1's Investment Committee verdict next to Engine 2's technical read for that same symbol) rather than account-wide, and it also carries an always-visible Portfolio Overview row. This lesson doesn't re-teach that page; see 'Institutional Dashboard (Cross-Engine Command Centre)' for the full walkthrough.",
        "A third, similarly-named 'Portfolio Dashboard' (/portfolio-dashboard) exists too, but it belongs to the Options Income Engine's own Paper Trading account — a completely different portfolio (real simulated options trades, not your Portfolio Construction holdings). If you're looking for stock/ETF holdings and target weights, that page is the wrong one.",
      ],
      whyItMatters: "Landing on the wrong 'dashboard' wastes real time — the Executive Dashboard shows your own institutional-investing activity and daily research summary, the Institutional Dashboard compares two engines' verdicts for one symbol, and the Portfolio Dashboard is a different engine's account entirely.",
      difficulty: "beginner",
      whyItExists: "The Executive Dashboard was built to be 'zero new valuation models, zero new scores, zero new recommendations, zero new backend routes' by design — every panel condenses a report the Reporting Centre, Institutional Mentor, or Monitoring Engine already computed, purely a reading convenience, never a second source of truth.",
      institutionalThinking: "A professional's morning routine has a fixed order: check what changed overnight (Monitoring Summary), review what's still open (Active Opportunities, Recent Decisions), then decide where today's research time goes — not a random click through nine separate pages. The permanent 'Institutional Investing Engine / Educational / Deterministic' badges on this page are a deliberate, constant reminder that nothing here is investment advice, even when the numbers look confident.",
      screenWalkthrough: [
        "Page header — 'Executive Dashboard' title with four permanent badges: Institutional Investing Engine, Educational, Deterministic, Data Driven.",
        "Cross-Engine Snapshot — your own account's usage counters: Portfolios, Trades Reviewed, Strategies, Reports, AI Coach Views, Learning Topics completed.",
        "Daily Executive Summary — a short, template-composed paragraph pulling together today's most relevant already-computed facts.",
        "Portfolio Health — a condensed read of your Portfolio Construction risk/quality scores, if you have at least one portfolio.",
        "Active Opportunities — symbols the Decision Engine or Opportunity Discovery has already flagged as worth a look, never a new ranking.",
        "Monitoring Summary — how many alerts fired recently, by severity, linking through to the full Monitoring Dashboard for detail.",
        "Investment Committee Activity — a count of recent Graham/Buffett/Tom Nash consolidated verdicts you've reviewed.",
        "AI Coach Progress — how many of the 8 Institutional AI Coach explanations you've opened, and for how many distinct symbols.",
        "Recent Reports, Watchlists, Saved Research, Recent Decisions — each a short list linking straight through to its own full page (Reporting Centre, Value Watchlist, Research Terminal Notes, Decision Engine).",
        "Research Terminal / Strategy Workbench / Trading Analytics shortcuts — quick links out to the deeper, page-specific tools this dashboard only summarizes.",
      ],
      workflowSteps: [
        "Open the Executive Dashboard first thing, before doing any new research.",
        "Read the Monitoring Summary — has anything you already own or watch changed since your last visit?",
        "Skim Active Opportunities and Recent Decisions to see what's already been flagged for follow-up.",
        "If Portfolio Health shows a concentration or sector cap breach, treat that as today's first priority, not an afterthought.",
        "Use the Research Terminal / Strategy Workbench shortcuts to jump into deeper work once you know where today's attention should go.",
      ],
      metricsExplained: [
        { term: "Cross-Engine Snapshot", explanation: "Your own account's activity counters (portfolios, trades reviewed, reports, etc.) — a usage summary, never a performance or quality score." },
        { term: "Portfolio Health", explanation: "A condensed read of the same score Portfolio Construction's own Risk tab computes — reused, not recomputed, on this page." },
        { term: "Monitoring Summary", explanation: "A count of already-fired, deterministic alerts by severity — never a live feed, always a historical record of what already happened." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A clean, quiet morning read",
          steps: [
            "Monitoring Summary shows zero critical alerts and one informational one — nothing urgent.",
            "Portfolio Health reads within both caps, no breach badges.",
            "Active Opportunities lists one or two Buy-rated symbols not yet held — worth a closer Research Terminal look later today.",
          ],
          note: "A quiet dashboard is genuinely useful information — it tells you where NOT to spend urgent attention, freeing time for deliberate, unhurried research instead.",
        },
        {
          label: "Average Opportunity",
          title: "One item worth following up, nothing urgent",
          steps: [
            "Monitoring Summary shows one warning-level alert (e.g. a rating change on a held symbol).",
            "Portfolio Health reads acceptable but trending toward a cap.",
            "Recent Decisions shows a Hold verdict from last week that hasn't been revisited.",
          ],
          note: "This is a normal day — nothing requires immediate action, but the warning alert and stale Hold decision are both worth 10 minutes of follow-up via the Research Terminal.",
        },
        {
          label: "Poor Opportunity",
          title: "A real breach that needs today's attention first",
          steps: [
            "Portfolio Health shows a red concentration-cap breach badge — one holding has grown past 25% of the portfolio.",
            "Monitoring Summary shows a critical alert for the same symbol (a downgrade to Sell/Avoid).",
            "Active Opportunities is effectively secondary today — the breach is the priority.",
          ],
          note: "The dashboard's job here is simply to surface the fact plainly — deciding what to actually do about a concentration breach happens on the Portfolio Construction Risk tab and Rebalancing Engine, not on this summary screen itself.",
        },
      ],
      commonMistakes: [
        "Confusing the Executive Dashboard, the Institutional Dashboard, and the options-side Portfolio Dashboard — they show three genuinely different things.",
        "Treating a quiet Monitoring Summary as proof nothing needs attention — it only means none of the 14 fixed, deterministic checks has fired, not that a full review is unnecessary.",
        "Skipping straight to Active Opportunities without first checking Portfolio Health for a cap breach that should take priority.",
      ],
      riskWarnings: [
        "A breached concentration or sector cap shown here is real information about the portfolio's structure, not a cosmetic warning — resolve or consciously accept it before adding new positions.",
        "Every figure on this dashboard is educational and deterministic, never investment advice — the permanent badges exist to keep that distinction visible at all times.",
      ],
      bestPractices: [
        "Open this page first, every session, before starting new research — it's built specifically as the day's starting point.",
        "Treat every panel as a link, not a final answer: click through to the Research Terminal, Monitoring Dashboard, or Decision Engine for the real detail behind any summary figure.",
        "If Portfolio Health flags a breach, resolve or at least acknowledge it before spending time on new opportunities.",
      ],
      aiCoachPrompts: [
        "What changed in my portfolio since yesterday?",
        "Why is my Portfolio Health score elevated risk?",
        "Which of my Active Opportunities is the strongest candidate right now?",
        "Explain the difference between this dashboard and the Institutional Dashboard.",
      ],
      relatedModuleHrefs: ["/stock-analyst/executive-dashboard", "/institutional-dashboard", "/reporting-centre", "/research-terminal"],
      relatedGlossaryKeys: ["portfolio-health", "concentration", "monitoring-alert"],
      nextStepKeys: ["investing-fundamental-analysis"],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "What does the Executive Dashboard's 'Portfolio Health' panel actually compute?",
          options: ["A new, dashboard-specific health formula", "A condensed, unmodified read of Portfolio Construction's own Risk tab score", "A live market-data feed", "A prediction of future portfolio value"],
          correctIndex: 1,
          explanation: "Every panel on this page reuses an already-computed figure from another module — nothing on the Executive Dashboard is a new calculation.",
        },
        {
          prompt: "Which page is symbol-driven (you search one ticker) rather than account-wide?",
          options: ["The Executive Dashboard", "The Institutional Dashboard (/institutional-dashboard)", "The Reporting Centre", "The Research Terminal's Notes tab"],
          correctIndex: 1,
          explanation: "The Institutional Dashboard pairs Engine 1 and Engine 2's own verdicts for one searched symbol — a different workflow from the Executive Dashboard's account-wide summary.",
        },
        {
          prompt: "The options-side 'Portfolio Dashboard' (/portfolio-dashboard) shows holdings from which account?",
          options: ["Your Portfolio Construction target-weight holdings", "The Options Income Engine's Paper Trading account", "A blended view of both accounts", "It doesn't exist"],
          correctIndex: 1,
          explanation: "It's a genuinely different engine's own account — a real, but unrelated, options paper-trading portfolio, not your stock/ETF holdings.",
        },
        {
          prompt: "What does a quiet Monitoring Summary (zero alerts) actually prove?",
          options: ["Nothing needs review", "None of the 14 fixed, deterministic checks has fired since it last ran — not the same as a full review", "The market is closed", "All holdings are profitable"],
          correctIndex: 1,
          explanation: "Absence of an alert only means the specific, hardcoded conditions haven't triggered — it never substitutes for periodic deliberate research.",
        },
        {
          prompt: "What are the Executive Dashboard's four permanent badges?",
          options: ["Live, Real-Time, AI-Powered, Predictive", "Institutional Investing Engine, Educational, Deterministic, Data Driven", "Beta, Experimental, Simulated, Advisory", "Buy, Hold, Sell, Avoid"],
          correctIndex: 1,
          explanation: "These four labels are shown constantly, a deliberate reminder that every figure is educational and deterministic, never investment advice.",
        },
      ],
    }),
    topic({
    ...
    topic({
      key: "investing-fundamental-analysis",
      title: "Financial Ratios, Statements, Filings, and Earnings — the Value Research Page's Own Deep Data",
      summary: "Every fundamental data module the Value Research page (/stock-analyst) genuinely computes, and exactly what it doesn't.",
      body: [
        "Business Quality and Financial Strength (the previous two lessons) give you a single scored read on a company — this lesson covers the four heavier, on-demand tabs on the same Value Research page (/stock-analyst) that supply the actual numbers behind those scores: Statements, Peers, Filings & Mgmt, and Earnings, plus the Financial Ratios card and the three named valuation models inside the main Research tab.",
        "Financial Ratios groups already-computed figures into three categories — Valuation (P/E trailing and forward, PEG, P/S, P/B, FCF Yield, Dividend Yield), Profitability (ROE, ROIC, Gross/Operating/Net Margin, Payout Ratio), and Liquidity & Leverage (Current Ratio, Debt/Equity, Interest Coverage) — plus three trend charts (Revenue/Share, EPS, FCF/Share). Honest disclosure: Quick Ratio, Return on Assets, and Asset Turnover are shown as unavailable, with an explicit reason — this platform doesn't have the full balance-sheet line items (inventory, total assets, current-liability breakdown) needed to compute them correctly, and they are never approximated or guessed.",
        "Three named valuation models — Graham Valuation (the classic Graham Number and growth formula, using trailing EPS only), DCF Valuation (a genuine multi-year cash-flow projection with a terminal value), and Buffett Valuation (a no-growth-perpetuity capitalization of owner earnings) — each independently report a fair value, and each honestly returns 'unavailable' rather than a fabricated number when its own required inputs (e.g. positive trailing EPS for Graham) aren't valid. The Margin of Safety (Consolidated) card rolls all of them, plus the platform's original blended model, into one fair-value range and average — covered in its own dedicated lesson next.",
        "The Statements tab fetches a genuine 5-year Income Statement, Balance Sheet, and Cash Flow Statement — Revenue/COGS/Gross Profit/Operating Income/Net Income; Total Assets/Liabilities/Equity/Current Assets/Current Liabilities; Operating/Investing/Financing Cash Flow, Capex, and Free Cash Flow. Every field carries its own honest SIMULATED/LIVE data-source label.",
        "The Filings & Mgmt tab has two distinct cards. Filings genuinely fetches the company's real, most recent 10-K directly from SEC EDGAR — real government data, independent of whether the fundamentals toggle is SIMULATED or LIVE. Management Quality is deterministic, template-based scoring built on top of that extracted filing text — the module's own header explicitly treats this as the highest reputational-risk area of the whole engine, and it never characterizes a named real individual; several dimensions are honestly reported unavailable rather than guessed.",
        "The Earnings tab (Earnings Intelligence) shows quarterly EPS actual-vs-estimate, revenue actual-vs-estimate, surprise percentages, a surprise streak, an earnings growth trend classification, and a consistency score — all derived from already-recorded or provider-supplied quarterly data, never a forecast of a future, unreported quarter.",
        "The Peers tab (Industry Comparison) benchmarks the company against sector peers on several of these same ratios and scores, with its own explicit SIMULATED/LIVE badge.",
      ],
      whyItMatters: "Knowing exactly which numbers on this page are computed, which are honestly unavailable, and which are real government filings (vs. simulated) is what separates informed research from mistaking a well-formatted screen for a guarantee of accuracy — this platform is deliberately transparent about every one of those distinctions.",
      difficulty: "intermediate",
      whyItExists: "Every module named here already existed as its own already-tested backend engine — this lesson introduces no new calculations, only the reading discipline for tabs a learner might otherwise skim past without understanding what each one actually is or isn't.",
      institutionalThinking: "A professional analyst never treats a single ratio in isolation — P/E means little without knowing growth (PEG), margins mean little without knowing the trend (Statements tab's own multi-year history), and a valuation model's fair value means little without checking whether it was even computable (an 'unavailable' Graham Valuation on a loss-making company is itself informative, not a gap to work around). Reading an honestly-labeled 'unavailable' as a red flag about the underlying business, rather than a platform limitation to route around, is itself a common and useful institutional habit.",
      screenWalkthrough: [
        "Financial Ratios card (Research tab) — three grouped sections (Valuation, Profitability, Liquidity & Leverage) plus three trend line charts.",
        "Graham Valuation, DCF Valuation, Buffett Valuation cards — each shows a fair value estimate, margin of safety, rating, and a methods breakdown, or an honest 'unavailable' reason.",
        "Statements tab — Income Statement / Balance Sheet / Cash Flow sub-tabs, each a 5-year table with a data-source badge.",
        "Peers tab — an Industry Comparison table against sector peers, with its own SIMULATED/LIVE badge.",
        "Filings & Mgmt tab — Filings card (real SEC EDGAR 10-K excerpt with a source link) and Management Quality card (deterministic scoring, explicit 'never an AI opinion about a named individual' disclosure).",
        "Earnings tab — a quarterly table (actual vs. estimate, surprise %) plus streak/trend/consistency badges.",
      ],
      workflowSteps: [
        "Start with the Research tab's Financial Ratios card for a quick multi-year trend read.",
        "Check all three valuation models (Graham/DCF/Buffett) — if two report 'unavailable,' treat that as real information about the company's own financial shape, not a platform gap.",
        "Open the Statements tab if you need the actual dollar figures behind a ratio, not just the ratio itself.",
        "Open Filings & Mgmt to read the company's own most recent 10-K language, especially the Risk Factors section.",
        "Open Earnings to check the recent quarterly track record before trusting a forward-looking valuation model's own assumptions.",
        "Open Peers to see whether the company's ratios are actually attractive relative to its own sector, not just in isolation.",
      ],
      metricsExplained: [
        { term: "Quick Ratio / ROA / Asset Turnover", explanation: "Honestly unavailable on this platform — computing them correctly needs full balance-sheet line items (inventory, total assets, current-liability breakdown) that aren't captured by any provider here. Never approximated." },
        { term: "Graham Number", explanation: "√(22.5 × trailing EPS × book value per share) — the classic Graham fair-value formula, using trailing EPS only, never forward estimates, matching Graham's own conservative methodology." },
        { term: "DCF Fair Value", explanation: "A genuine multi-year free-cash-flow projection discounted back to present value, plus a Gordon-growth terminal value — honestly unavailable when FCF isn't positive or the discount rate doesn't exceed the terminal growth rate." },
        { term: "Earnings Surprise %", explanation: "(Actual − Estimate) / |Estimate| for a reported quarter — a real, already-happened comparison, never a prediction of an upcoming quarter's result." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Consistent fundamentals across every module",
          steps: [
            "Financial Ratios shows steadily improving margins across the trend chart, not just a single good year.",
            "All three valuation models (Graham/DCF/Buffett) are computable and broadly agree the stock trades below fair value.",
            "Earnings tab shows a positive surprise streak and an 'accelerating' growth trend.",
          ],
          note: "Agreement across independent models and a real multi-quarter earnings track record is a stronger signal than any single ratio taken alone.",
        },
        {
          label: "Average Opportunity",
          title: "Mixed signals across modules",
          steps: [
            "Financial Ratios shows healthy margins but declining ROIC over the trend window.",
            "Graham Valuation is unavailable (trailing EPS recently turned negative), while DCF and Buffett still compute a modest positive margin of safety.",
            "Earnings shows a 'stable' growth trend with an even mix of beats and misses.",
          ],
          note: "Genuinely mixed evidence like this is common and honest — it calls for reading the Filings & Mgmt tab's own Risk Factors excerpt before forming a view, not picking whichever model happens to look most favorable.",
        },
        {
          label: "Poor Opportunity",
          title: "Deteriorating fundamentals the ratios alone would miss",
          steps: [
            "Financial Ratios shows Debt/Equity climbing steadily across the trend window.",
            "All three valuation models are unavailable or report a deeply negative margin of safety.",
            "Earnings shows a consecutive-miss streak and a 'decelerating' growth trend.",
          ],
          note: "This is the profile where the Statements tab's own actual dollar figures and the Filings tab's Risk Factors excerpt matter most — a single glance at one ratio would understate how consistently every module is pointing the same direction.",
        },
      ],
      commonMistakes: [
        "Reading a single ratio (like P/E) in isolation without checking the trend charts for the multi-year pattern behind it.",
        "Treating an 'unavailable' valuation model result as a platform bug to work around, rather than real information about the company's own financials.",
        "Skipping the Filings tab's real SEC EDGAR 10-K text and relying only on computed numbers — the filing's own Risk Factors language often surfaces context no ratio captures.",
        "Assuming the Earnings tab's surprise streak predicts the next quarter — it's a historical record, never a forecast.",
      ],
      riskWarnings: [
        "An honestly-unavailable valuation model is real information — never work around it by substituting a different model's number without understanding why the first one failed.",
        "Quick Ratio, ROA, and Asset Turnover are never approximated — treat their absence as a genuine data gap, not an oversight to fill in yourself.",
      ],
      bestPractices: [
        "Cross-check all three named valuation models rather than anchoring on whichever one gives the most favorable number.",
        "Use the Statements tab's actual dollar figures to sanity-check a ratio that looks surprising.",
        "Read the real 10-K excerpt on the Filings tab for any company you're seriously considering — it's genuine government-filed data, not a simulation.",
        "Check the Peers tab before concluding a ratio is 'cheap' or 'expensive' — sector context changes what a given number actually means.",
      ],
      aiCoachPrompts: [
        "Explain why the Graham Valuation is showing unavailable for this symbol.",
        "Summarize the trend in this company's margins over the last 6 years.",
        "What does the Filings tab's Risk Factors excerpt say about this company?",
        "Compare this company's ratios to its sector peers.",
      ],
      relatedModuleHrefs: ["/stock-analyst", "/research-terminal"],
      relatedGlossaryKeys: ["price-earnings-ratio", "return-on-invested-capital", "graham-number", "discounted-cash-flow", "owner-earnings"],
      nextStepKeys: ["investing-margin-of-safety"],
      estimatedMinutes: 8,
      knowledgeCheck: [
        {
          prompt: "Why are Quick Ratio, ROA, and Asset Turnover shown as unavailable?",
          options: ["They're too complex to compute", "The platform lacks the full balance-sheet line items needed to compute them correctly, so they're never approximated", "They're only for institutional accounts", "They were removed for performance reasons"],
          correctIndex: 1,
          explanation: "Rather than approximate with an incomplete data set, the platform honestly reports these three ratios as unavailable.",
        },
        {
          prompt: "What EPS figure does the Graham Number formula use?",
          options: ["Forward (estimated) EPS", "Trailing EPS only, matching Graham's own conservative methodology", "An average of trailing and forward EPS", "Adjusted, non-GAAP EPS"],
          correctIndex: 1,
          explanation: "Graham Valuation deliberately uses trailing EPS only, never forward estimates, preserving the original formula's conservative intent.",
        },
        {
          prompt: "Where does the Filings tab's 10-K data actually come from?",
          options: ["A simulated document generator", "SEC EDGAR — real government filing data, independent of the SIMULATED/LIVE fundamentals toggle", "The company's own investor relations page", "An AI-generated summary of the company"],
          correctIndex: 1,
          explanation: "Filings genuinely fetches the real, most recent 10-K from SEC EDGAR — always real government data, regardless of which fundamentals provider is active.",
        },
        {
          prompt: "What does an Earnings Surprise % actually measure?",
          options: ["A prediction of next quarter's result", "(Actual − Estimate) / |Estimate| for an already-reported quarter", "The stock's price change on earnings day", "A forward guidance figure"],
          correctIndex: 1,
          explanation: "Surprise % is always a backward-looking comparison against an already-reported quarter, never a forecast.",
        },
        {
          prompt: "What should you do when all three valuation models report 'unavailable' for a symbol?",
          options: ["Assume it's a platform bug and ignore the models entirely", "Treat it as real information about that company's own financial shape, then check the Filings/Statements tabs for context", "Wait 24 hours and refresh the page", "Switch to a different symbol"],
          correctIndex: 1,
          explanation: "An honest 'unavailable' across all three models (e.g. because trailing EPS or FCF isn't positive) is itself meaningful information, not a glitch to route around.",
        },
      ],
    }),
    topic({
    ...
    topic({
      key: "investing-portfolio-construction-workflow",
      title: "Building an Investment Portfolio: Create, Add Holdings, Allocate, Manage Risk",
      summary: "The real, wired workflow for constructing a target-weight portfolio on this platform — never a trade order.",
      body: [
        "Portfolio Construction (/stock-analyst/portfolio-construction), on-screen titled the 'Institutional Portfolio Manager,' is where you actually build a target-weight stock/ETF portfolio on this platform. Its own header states plainly: this page never places, schedules, or submits any trade — everything here is planning and record-keeping, always advisory.",
        "The real, wired workflow: create a portfolio (name + optional description), select it from your list, then add a holding by typing a symbol and a target weight (shares and cost basis are also independently editable, each saved on blur). An 'Add from Watchlist' button pulls every symbol from your Value Research watchlist not already held and assigns each an equal target weight (100 divided by the total holding count, rounded to 2 decimal places) — simple client-side arithmetic, not a new backend calculation.",
        "Once a portfolio has holdings, each row shows Target %, Actual % (computed from a real, freshly-resolved price), Drift (the percentage-point gap between the two), and a Rebalance badge — Buy, Sell, or Hold. The threshold is a named constant: drift beyond +5 percentage points reads 'Sell' (you're overweight), beyond −5 reads 'Buy' (you're underweight), and anything within that band reads 'Hold.' This is a label only — there is no order-submission button anywhere on this page.",
        "The Allocation tab breaks the portfolio down by Sector, Industry, Market Cap, Growth vs. Value Mix, and Quality Mix, plus Largest Position %, Top 10 Exposure %, and Cash Allocation %. Country and currency exposure are honestly shown as unavailable with an explicit reason — not fabricated.",
        "The Risk tab computes an overall risk score from three real components: Concentration (a single-symbol weight above 25% breaches a hard-coded cap), Sector Exposure (a single sector above 40% breaches its own cap), and a weighted-average Beta estimate. Breaching either cap force-caps the overall score at 60, regardless of what the rest of the blend would otherwise produce — the same two named constants (SINGLE_SYMBOL_CONCENTRATION_CAP_PCT and SECTOR_CONCENTRATION_CAP_PCT) are reused, unchanged, across the Decision Engine, the AI Coach, and Portfolio Optimisation, so a 'breach' means the same thing everywhere on this platform.",
        "Further tabs are all read-only summaries: Quality (per-holding quality/capital-allocation/growth scores and committee verdicts), Performance (unrealized P&L per holding, requiring your own entered cost basis), Income (dividend yield and estimated annual income), Snapshots/Timeline (explicit, user-triggered 'Save Portfolio Snapshot'/'Save Risk Snapshot' buttons — nothing is auto-saved), and Notes (free-text CRUD notes per portfolio).",
      ],
      whyItMatters: "This is the one place on the platform where you actually decide what a portfolio should look like — everything upstream (research, valuation, the Investment Committee) informs a single-symbol view, but only Portfolio Construction lets you weigh multiple holdings against each other and see the real concentration/sector consequences of that mix.",
      difficulty: "intermediate",
      whyItExists: "Building this feature meant a genuinely new drift/rebalance/risk-cap calculation layer — the only part of this whole lesson that isn't simply reusing an already-computed figure from elsewhere — but it deliberately reuses the exact same two concentration/sector cap constants the Decision Engine, AI Coach, and Portfolio Optimisation already use, so 'breach' has one consistent meaning platform-wide.",
      institutionalThinking: "A professional portfolio manager asks 'does adding this holding make the whole portfolio better?' rather than accumulating individually-attractive positions with no view of the aggregate — the Risk tab's hard caps exist precisely to force that question. Note carefully: the general concept 'deciding the whole portfolio deliberately, against an explicit risk budget' is its own philosophy lesson (Portfolio Construction, in the Institutional Thinking path) — this lesson is the concrete, hands-on version of that same idea, using this platform's real screen.",
      screenWalkthrough: [
        "Left panel — your list of portfolios, with a 'New Portfolio' name/description form and a Create button.",
        "Holdings tab — Symbol/Target %/Shares add-holding form, an 'Add from Watchlist' equal-weight button, and a table with inline-editable Target %, Shares, and Cost Basis, plus computed Actual %, Drift, and a Rebalance badge per row.",
        "A Position sizing / rebalancing assistant strip shows a suggested share delta per holding when computable — a suggested number only, never a submitted or scheduled order.",
        "Allocation tab — Largest Position/Top 10 Exposure/Cash Allocation badges, then weight breakdowns by Sector, Industry, Market Cap, Growth vs. Value, and Quality Mix; Country/Currency shown honestly unavailable.",
        "Risk tab — Concentration badge (red if breached), Sector badge (red if breached), a plain Beta badge, and an Extended Risk Dimensions card (Cash Risk, Dividend Dependence, Leverage Exposure, Quality Drift, Portfolio Stability).",
        "Quality / Performance / Income tabs — per-holding read-only summaries.",
        "Snapshots / Timeline tabs — explicit Save buttons; Timeline is a chronological read of what you've saved, never auto-populated.",
        "Notes tab — free-text notes, add/edit/delete per portfolio.",
        "'Open Portfolio Optimisation →' link — carries this portfolio's context into the Upgrade/Trim/Exit/Core classification covered in the next lesson.",
      ],
      workflowSteps: [
        "Create a portfolio with a clear name.",
        "Add holdings one at a time, or use 'Add from Watchlist' for a fast equal-weight starting point.",
        "Set a deliberate Target % per holding — don't leave every holding at its default equal weight unless that's genuinely your intended allocation.",
        "Check the Risk tab immediately after any addition — a red Concentration or Sector badge means the portfolio as constructed already breaches a hard cap, before you even get to drift.",
        "Return periodically to check Drift and the Rebalance badges — Buy/Sell/Hold labels, never an executable action.",
        "Enter cost basis per holding if you want the Performance tab's unrealized P&L figures to mean anything.",
        "Save a Portfolio Snapshot when you're satisfied with the current construction, so Timeline has something real to show later.",
      ],
      metricsExplained: [
        { term: "Drift", explanation: "Actual weight % minus Target weight %, in percentage points — the gap the Rebalance badge is based on." },
        { term: "Rebalance Badge (Buy/Sell/Hold)", explanation: "A label only. Sell when drift exceeds +5pp, Buy when drift is below −5pp, Hold otherwise. Never an order, never submitted, scheduled, or previewed as a trade." },
        { term: "Concentration Cap", explanation: "25% — the maximum single-symbol weight before the Risk tab's Concentration component reads 'breached' and force-caps the overall score at 60." },
        { term: "Sector Cap", explanation: "40% — the same breach/force-cap mechanism as Concentration, applied to a single sector's total weight instead of a single symbol." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A deliberately diversified, well-drifted portfolio",
          steps: [
            "10 holdings, each between 6% and 12% target weight — no single position near the 25% cap.",
            "No sector exceeds roughly 25% of total weight — well under the 40% cap.",
            "Drift on every holding sits within ±3 percentage points — mostly 'Hold' badges, no urgent rebalance signal.",
          ],
          note: "This is what deliberate construction against an explicit risk budget looks like — no single event, in one symbol or one sector, can materially damage the whole portfolio.",
        },
        {
          label: "Average Opportunity",
          title: "One holding has drifted past the threshold",
          steps: [
            "A well-diversified portfolio where one holding's price has risen sharply since it was added.",
            "Its Actual % now sits 7 percentage points above its Target % — a 'Sell' rebalance badge.",
            "Concentration and Sector caps are both still comfortably unbreached — this is drift, not a structural risk problem.",
          ],
          note: "A 'Sell' badge here reflects success (the position appreciated), not a warning sign — deciding whether to actually trim it is a judgment call the platform deliberately leaves to you.",
        },
        {
          label: "Poor Opportunity",
          title: "A genuine concentration breach",
          steps: [
            "One holding, added early and never trimmed, now sits at 31% of the portfolio — past the 25% cap.",
            "The Risk tab shows a red Concentration badge, and the Overall risk score is force-capped at 60 regardless of every other input.",
            "Two of the portfolio's other holdings are in the same sector, pushing that sector's total weight past 40% too — both caps breached simultaneously.",
          ],
          note: "This is exactly the scenario the hard caps exist to surface plainly — the platform never auto-corrects it, but it also never lets the badge stay quiet about it.",
        },
      ],
      commonMistakes: [
        "Adding holdings via 'Add from Watchlist' and never adjusting the resulting equal weights to reflect actual conviction.",
        "Treating a 'Sell' rebalance badge as an instruction rather than a label — the platform never executes it, and deciding whether to act is entirely yours.",
        "Ignoring a red Concentration or Sector badge because the overall risk score 'still looks okay' — a breach force-caps that score at 60 specifically so it can't hide behind an otherwise-fine blend.",
        "Never entering cost basis, then being surprised the Performance tab has nothing meaningful to show.",
        "Confusing this page's own drift-based rebalancing with the separate, standalone Rebalancing Engine — covered in the next lesson.",
      ],
      riskWarnings: [
        "A breached Concentration or Sector cap force-caps the Overall risk score at 60 regardless of the rest of the blend — treat this as a structural risk signal, not a cosmetic badge.",
        "This page never places, schedules, or submits any trade — every Rebalance badge and suggested share delta is advisory only, and acting on it is entirely your own decision made elsewhere.",
      ],
      bestPractices: [
        "Set Target % deliberately, based on your own conviction, rather than accepting an equal-weight default.",
        "Check the Risk tab every time you add a holding, not just periodically.",
        "Save a Snapshot whenever you make a meaningful change, so Timeline becomes a genuine record of how the portfolio evolved.",
        "Use Notes to record WHY you set a particular target weight — a portfolio without a documented rationale is hard to review honestly later.",
      ],
      aiCoachPrompts: [
        "Why does my portfolio show a Sector concentration breach?",
        "Explain the difference between Drift and the Concentration cap.",
        "What does Portfolio Fit mean for this symbol in my portfolio?",
        "Should I be concerned about my Beta estimate?",
      ],
      relatedModuleHrefs: ["/stock-analyst/portfolio-construction", "/stock-analyst/portfolio-optimisation", "/rebalancing-engine"],
      relatedGlossaryKeys: ["portfolio-construction", "concentration", "rebalancing-assistant", "portfolio-drift-alert"],
      nextStepKeys: ["investing-monitoring"],
      estimatedMinutes: 9,
      knowledgeCheck: [
        {
          prompt: "What does the Rebalance badge (Buy/Sell/Hold) actually do?",
          options: ["Automatically submits a trade order", "Schedules a trade for the next market open", "Only labels the drift — it never submits, schedules, or previews a trade", "Sends an alert to your broker"],
          correctIndex: 2,
          explanation: "The page's own header states plainly that it never places, schedules, or submits any trade — the badge is advisory labeling only.",
        },
        {
          prompt: "What happens to the Risk tab's Overall score when the Concentration cap is breached?",
          options: ["Nothing changes", "It's force-capped at 60, regardless of the rest of the blend", "It automatically improves diversification", "The breached holding is automatically sold"],
          correctIndex: 1,
          explanation: "A breach on either the Concentration or Sector cap force-caps the Overall risk score at 60, so it can't be hidden behind an otherwise-favorable blend.",
        },
        {
          prompt: "What does 'Add from Watchlist' actually compute?",
          options: ["A risk-adjusted optimal weight per symbol", "An equal target weight (100 / total holding count), simple client-side arithmetic", "A market-cap-weighted allocation", "Nothing — it just adds symbols with no weight"],
          correctIndex: 1,
          explanation: "It's deliberately simple: 100 divided by the total number of holdings after adding, rounded to 2 decimal places — no new backend calculation.",
        },
        {
          prompt: "What is honestly shown as unavailable on the Allocation tab?",
          options: ["Sector breakdown", "Country and currency exposure", "Market cap breakdown", "Quality mix"],
          correctIndex: 1,
          explanation: "Country and currency exposure are explicitly disclosed as unavailable, with a reason shown in the UI — never fabricated.",
        },
        {
          prompt: "What triggers a Portfolio Snapshot to be saved?",
          options: ["It saves automatically every time you visit the page", "An explicit, user-clicked 'Save Portfolio Snapshot' button — nothing is auto-saved", "It saves once per day automatically", "Snapshots are saved when a rebalance badge changes"],
          correctIndex: 1,
          explanation: "Snapshots and risk snapshots are both explicit, user-triggered actions — the Timeline tab is simply a chronological read of what you've deliberately saved.",
        },
      ],
    }),
    topic({
    ...
    topic({
      ...
      title: "The Investment Committee — and the One Place It's Genuinely AI-Narrated",
      summary: "Three independent analysts, one consolidated verdict — plus a real, working LLM feature many learners never notice.",
      body: [
        ...
        "Graham and Buffett are pure valuation models, not verdict-generators on their own — each casts its vote via a bucket collapse of its own rating (Cheap → Buy, Fair → Hold, Expensive or worse → Wait). Tom Nash already produces a real Buy/Hold/Wait verdict directly and votes with that unmodified.",
        "When the committee is genuinely split, the consolidated verdict defaults to the safe, neutral Hold — never a forced coin-flip. A model that's unavailable (e.g. Graham on a deeply unprofitable company) is simply excluded from the vote, never fabricated.",
        "Important naming distinction, worth getting right: 'Investment Committee Workbench' (/stock-analyst/investment-committee) is a workflow page wrapping the Decision Engine, the Investment Memo, and Decision Snapshots/Notes — it shows the Committee's consolidated verdict, but NOT the individual Graham/Buffett/Tom Nash votes or the AI narration feature described next. Those live on the Value Research page itself (/stock-analyst), inside the main research report's own Investment Committee panel.",
        "That panel has a genuine, working 'Narrate this verdict' button — a real LLM call, not a template. It streams a live explanation of why the committee reached its verdict, grounded strictly in the already-computed votes/agreement/confidence data, with an explicit instruction to the model never to invent a vote, verdict, or number not present in that data, and never to claim to be Warren Buffett, Benjamin Graham, or any real person. When the LLM is unavailable, it gracefully falls back to the deterministic reasoning text instead of failing silently — the response always discloses which happened via a narrativeSource field ('llm' or 'template').",
      ],
      whyItMatters: "Seeing every individual vote, not just the outcome, shows exactly where the analysts agree or disagree — more informative than a single blended number. And knowing the narration feature is real (not just template prose) — but also knowing exactly which page it lives on — prevents the common mistake of assuming the Workbench page has it, clicking around looking for a button that isn't there.",
      difficulty: "intermediate",
      whyItExists: "The consolidated verdict logic reuses Graham's, Buffett's, and Tom Nash's own already-computed outputs with zero new scoring — the narration feature is a later, separate addition (a genuine LLM call layered strictly on top of the deterministic verdict, never replacing it), which is why it lives specifically on the Value Research page rather than being retrofitted into the earlier-built Workbench page.",
      institutionalThinking: "A professional never mistakes 'majority' agreement for 'unanimous' agreement — two of three analysts agreeing is genuinely weaker evidence than all three independently reaching the same conclusion, even though both cases might show the identical headline verdict.",
      screenWalkthrough: [
        "Value Research page (/stock-analyst), Investment Committee panel — the consolidated verdict badge, agreement badge (unanimous/majority/split/insufficient-data), and a confidence score.",
        "Individual votes list — Graham, Buffett, and Tom Nash's own Buy/Hold/Wait vote and short rationale, shown separately from the consolidated result.",
        "'Narrate this verdict' button — click to stream a live, genuinely LLM-generated explanation grounded in the votes/agreement/confidence above; the deterministic summary and votes list stay visible the entire time, before and after narration.",
        "Investment Committee Workbench (/stock-analyst/investment-committee) — a separate page for the review WORKFLOW: Decision Engine synthesis, the deterministic Investment Memo, Decision Snapshots/Notes, and a cross-symbol Active Reviews dashboard.",
      ],
      workflowSteps: [
        "On the Value Research page, scroll to the Investment Committee panel and read the individual votes before the consolidated verdict.",
        "Note the agreement signal specifically — unanimous, majority, split, or insufficient-data.",
        "Click 'Narrate this verdict' if you want a plain-language explanation, understanding it's a real LLM call grounded in the data already shown.",
        "For the full review workflow (memo, snapshots, notes), navigate separately to the Investment Committee Workbench.",
      ],
      metricsExplained: [
        { term: "Agreement Signal", explanation: "unanimous / majority / split / insufficient-data — literally how many of the three analysts independently reached the same vote, never a synthesized 'average' feeling." },
        { term: "narrativeSource", explanation: "'llm' or 'template' — the response always honestly discloses which produced the narration text you're reading, never silently pretending a template fallback is genuine LLM output." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Unanimous agreement, high confidence",
          steps: [
            "Graham, Buffett, and Tom Nash all independently vote Buy.",
            "Agreement signal reads 'unanimous,' confidence score around 85/100.",
            "The narrated explanation (if requested) simply walks through why all three independently agree — it adds no new information, only plain-language framing.",
          ],
          note: "Unanimous agreement across three genuinely independent models is meaningfully stronger evidence than any single model's own vote taken alone.",
        },
        {
          label: "Average Opportunity",
          title: "Majority agreement, one dissenting vote",
          steps: [
            "Graham and Tom Nash vote Hold, Buffett votes Wait.",
            "Agreement signal reads 'majority,' consolidated verdict is Hold, confidence around 55/100.",
            "The narrated explanation should explicitly name which analyst dissented and why, since that's exactly the kind of detail a single headline number would hide.",
          ],
          note: "A majority verdict deserves a closer read of the dissenting vote's own rationale before treating the consolidated Hold as settled.",
        },
        {
          label: "Poor Opportunity",
          title: "Split committee, safe default to Hold",
          steps: [
            "Graham votes Buy, Buffett votes Wait, Tom Nash votes Hold — genuine three-way disagreement.",
            "Agreement signal reads 'split,' and the consolidated verdict defaults to the safe, neutral Hold rather than a forced coin-flip.",
            "This is the case where reading each individual vote's own reasoning matters most — the consolidated verdict alone tells you the committee disagrees, but not why.",
          ],
          note: "A split committee isn't a platform failure — it's an honest reflection of genuinely mixed evidence, and the safe-default-to-Hold design exists specifically so disagreement never gets forced into a false consensus.",
        },
      ],
      commonMistakes: [
        "Looking for the 'Narrate this verdict' button on the Investment Committee Workbench page instead of the Value Research page, where it actually lives.",
        "Treating a 'majority' agreement signal the same as 'unanimous' — they represent meaningfully different levels of evidence.",
        "Assuming the narration is a template even when narrativeSource reports 'llm' (or vice versa) — always check the actual field rather than guessing.",
        "Reading only the consolidated verdict and skipping the individual votes, missing exactly which analyst disagrees and why.",
      ],
      riskWarnings: [
        "A narrated explanation is still educational, never investment advice — the prompt explicitly forbids the model from inventing a vote, verdict, or number not already present in the deterministic data.",
        "A 'split' committee's default Hold is a safe neutral, not a signal that the underlying evidence is weak — read each dissenting vote's own rationale before drawing a conclusion.",
      ],
      bestPractices: [
        "Always check the agreement signal, not just the consolidated verdict — 'split' and 'unanimous' carry very different weight even when the headline verdict looks similar.",
        "Use 'Narrate this verdict' as a plain-language companion to the deterministic votes, never as a replacement for reading them yourself.",
        "For a full documented review (memo, snapshot, notes), use the Investment Committee Workbench, not the Value Research panel.",
      ],
      aiCoachPrompts: [
        "Why did the committee split on this symbol?",
        "Explain the difference between Graham's and Buffett's votes here.",
        "Is this verdict genuinely AI-narrated or a template fallback?",
        "What would need to change for this committee to reach a unanimous verdict?",
      ],
      relatedModuleHrefs: ["/stock-analyst", "/stock-analyst/investment-committee"],
      relatedGlossaryKeys: ["investment-committee-workbench", "conviction-score", "decision-confidence-score"],
      nextStepKeys: ["investing-ai-coach"],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "Which page has the real 'Narrate this verdict' LLM feature?",
          options: ["The Investment Committee Workbench (/stock-analyst/investment-committee)", "The Value Research page (/stock-analyst), inside the Investment Committee panel", "The Decision Engine page", "The Executive Dashboard"],
          correctIndex: 1,
          explanation: "The narration button lives specifically on the Value Research page's own Investment Committee panel — the similarly-named Workbench page does not have it.",
        },
        {
          prompt: "What happens when the committee is genuinely split three ways?",
          options: ["A random tie-breaker is used", "The consolidated verdict defaults to the safe, neutral Hold", "The system shows an error", "The most recent vote wins"],
          correctIndex: 1,
          explanation: "A split committee always defaults to Hold, deliberately, rather than forcing a coin-flip.",
        },
        {
          prompt: "How do Graham and Buffett cast their Buy/Hold/Wait votes?",
          options: ["They produce a verdict directly, just like Tom Nash", "Via a bucket collapse of their own valuation rating (Cheap→Buy, Fair→Hold, Expensive-or-worse→Wait)", "By reading the same filing text as Management Quality", "Randomly, weighted by conviction"],
          correctIndex: 1,
          explanation: "Graham and Buffett are pure valuation models — their vote is derived from their own rating, unlike Tom Nash who already produces a real verdict directly.",
        },
        {
          prompt: "What does the narrativeSource field tell you?",
          options: ["The stock's data source (SIMULATED/LIVE)", "Whether the narration text you're reading is genuine LLM output ('llm') or the deterministic fallback ('template')", "Which analyst wrote the narration", "The confidence score"],
          correctIndex: 1,
          explanation: "The response always honestly discloses which path produced the narration — never silently presenting a template fallback as if it were real LLM output.",
        },
        {
          prompt: "What's the difference between 'unanimous' and 'majority' agreement signals?",
          options: ["They mean the same thing", "Unanimous means all three analysts independently agree; majority means only two of three do — meaningfully different strength of evidence", "Majority is stronger evidence than unanimous", "Agreement signals don't affect the consolidated verdict"],
          correctIndex: 1,
          explanation: "Unanimous agreement is genuinely stronger evidence than a majority, even when both produce the same headline consolidated verdict.",
        },
      ],
    }),
    topic({
      key: "investing-ai-coach",
      title: "The Institutional AI Coach: 8 Deterministic Coaches, Zero Free-Form Chat",
      summary: "Every explanation quotes an already-computed engine output — never a new judgment, prediction, or recommendation.",
      body: [
        "The Institutional AI Coach (/institutional-ai-coach) offers 8 named, deterministic explanation coaches for a searched symbol — Investment, Portfolio, Decision, Valuation, Risk, Research, Monitoring, and Committee. None of them is free-form LLM chat: every one composes its explanation strictly from already-computed figures elsewhere on the platform, and every response carries the same fixed disclaimer confirming this module creates no new valuation model, scoring system, or investment recommendation.",
        "Investment Coach explains Business Quality, Moat, Financial Strength, the Investment Committee, Tom Nash's conviction, and the Decision Engine's own supporting evidence for a symbol. Portfolio Coach explains the Decision Engine's Portfolio Fit for a specific portfolio, plus your own Portfolio Construction holdings, diversification/risk scores, and concentration caps. Decision Coach walks through the Decision Engine's own checklist and supporting/contradicting evidence. Valuation Coach compares the Blended, Graham, DCF, and Buffett models plus the Consolidated Margin of Safety. Risk Coach explains the report's own risk flags, Financial Strength flags, and the Decision Engine's Risk/Diversification checklist items. Research Coach explains Business Quality factors, Competitive Advantage dimensions, and Investment Quality. Monitoring Coach reads your own recorded alert history for that specific symbol — historical facts, never re-scored. Committee Coach explains the Investment Committee's votes and reasoning verbatim.",
        "Each coach's response always ends with the same fixed disclaimer: 'The Coach never invents a recommendation, score, or forecast: every figure above is a direct quote from an existing, already-computed engine... this is not investment advice.'",
        "This is a genuinely different feature from the similarly-structured '8 coaches' on the Trading Engine's own AI Coach page (/trading-ai-coach) — that one covers Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, and Psychology & Discipline, a completely different Engine 2 vocabulary. Don't confuse the two when someone mentions '8 coaches' generically.",
      ],
      whyItMatters: "Knowing every coach explanation is a direct quote from an already-computed figure — never a new opinion — is what makes this a genuinely trustworthy learning tool rather than a black-box AI feature you'd otherwise have to take on faith.",
      difficulty: "beginner",
      whyItExists: "The only genuinely new content in the AI Coach module is static, per-coach educational copy explaining how to read an already-existing figure — it never encodes a new judgment about any specific company, and it introduces zero new scoring logic across all 8 coaches.",
      institutionalThinking: "A coach that only ever quotes evidence you could independently verify elsewhere on the platform builds a very different kind of trust than a black-box signal generator — this is a deliberate design choice, not a limitation to work around.",
      screenWalkthrough: [
        "Symbol search box — type a ticker to load that symbol's data across all 8 coaches.",
        "Coach-type tabs — Investment, Portfolio, Decision, Valuation, Risk, Research, Monitoring, Committee — switch between them to see a different lens on the same symbol.",
        "Each coach's explanation panel — plain-language prose, always closing with the fixed disclaimer.",
        "Guided Learning Mode — an optional walkthrough reusing this platform's own Learning Path system to introduce each coach in sequence.",
        "CoachDrawer — a smaller, embeddable version of the same coach explanations, reachable from other pages (e.g. the Monitoring Dashboard's 'Ask the AI Coach' link on a specific alert).",
      ],
      workflowSteps: [
        "Search a symbol on the Institutional AI Coach page.",
        "Start with Investment Coach for a general read, then switch to whichever coach matches your actual question.",
        "Use Monitoring Coach specifically when you want to understand a past alert for this symbol, since it reads your own alert history rather than re-scoring anything.",
        "Use Committee Coach if you want the Investment Committee's votes explained without leaving this page to visit the Value Research report.",
        "Treat every coach's explanation as a starting point for your own further reading, never as a final answer — it's explicitly designed to point back to the source module, not replace it.",
      ],
      metricsExplained: [
        { term: "COACH_DISCLAIMER", explanation: "A fixed sentence appended to every one of the 8 coaches' responses, confirming the explanation quotes already-computed figures and creates no new recommendation." },
        { term: "Coach vs. Free-Form Chat", explanation: "None of the 8 named coaches accepts an open-ended question — each is a fixed explanation type over a fixed set of already-computed inputs for the searched symbol." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Using the right coach for the right question",
          steps: [
            "You want to understand why a symbol's Decision Engine recommendation changed — you open Decision Coach, which explains the checklist and evidence directly.",
            "You then open Committee Coach to see whether the Investment Committee's own votes moved in the same direction.",
            "Both explanations quote the same underlying figures you could independently verify on the Value Research page.",
          ],
          note: "Matching the coach to the actual question (rather than defaulting to Investment Coach for everything) gets a more focused, useful explanation.",
        },
        {
          label: "Average Opportunity",
          title: "Using Monitoring Coach after an alert fires",
          steps: [
            "A monitoring alert fired for a held symbol — you open Monitoring Coach for that symbol from the Monitoring Dashboard's own 'Ask the AI Coach' link.",
            "The coach explains the historical alert record, never re-scoring the symbol fresh.",
            "You still need to separately check Valuation Coach or Research Coach if you want an updated read, since Monitoring Coach is deliberately historical only.",
          ],
          note: "Monitoring Coach answers 'what already happened and why,' not 'what should I do now' — a subtle but important distinction worth remembering.",
        },
        {
          label: "Poor Opportunity",
          title: "Expecting free-form chat that doesn't exist",
          steps: [
            "A user tries to type an open-ended, unrelated question expecting the AI Coach to answer it like a chatbot.",
            "None of the 8 coaches accepts free-form input — each is a fixed explanation over fixed inputs for the searched symbol.",
            "The genuinely free-form Q&A feature lives elsewhere: the 'Ask the AI Investment Analyst' panel on the Value Research page.",
          ],
          note: "Knowing this platform's real distinction between fixed-explanation coaches and genuine free-form Q&A prevents a frustrating, avoidable mismatch of expectations.",
        },
      ],
      commonMistakes: [
        "Expecting free-form chat from the Institutional AI Coach — all 8 coaches are fixed explanation types, not open-ended conversation.",
        "Confusing this page's 8 coaches with the Trading Engine's own, differently-named 8 coaches on /trading-ai-coach.",
        "Treating Monitoring Coach's historical alert read as an up-to-date, freshly-scored opinion.",
        "Skipping the fixed disclaimer and treating a coach's explanation as investment advice.",
      ],
      riskWarnings: [
        "Every coach's fixed disclaimer exists for a reason — this module creates no new valuation model or scoring system, and none of its 8 explanations should be treated as investment advice.",
        "Monitoring Coach's read is historical only — don't mistake it for a fresh, up-to-date judgment about a symbol's current condition.",
      ],
      bestPractices: [
        "Pick the specific coach that matches your actual question rather than defaulting to the same one every time.",
        "Use Committee Coach and Valuation Coach together when you want both the consolidated verdict and the underlying valuation math explained.",
        "Remember every coach explanation is a quote of an already-computed figure — cross-check the source module (Value Research, Decision Engine, Portfolio Construction) when you want the full detail.",
      ],
      aiCoachPrompts: [
        "Explain this symbol's Business Quality score.",
        "What does the Portfolio Coach say about adding this symbol to my portfolio?",
        "Walk me through the Decision Engine's checklist for this symbol.",
        "What alerts have fired for this symbol recently?",
      ],
      relatedModuleHrefs: ["/institutional-ai-coach", "/stock-analyst", "/decision-engine", "/monitoring-dashboard"],
      relatedGlossaryKeys: ["institutional-decision-engine", "conviction-score", "concentration"],
      nextStepKeys: ["investing-institutional-mentor"],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "How many named coaches does the Institutional AI Coach page offer?",
          options: ["3", "5", "8", "12"],
          correctIndex: 2,
          explanation: "Eight: Investment, Portfolio, Decision, Valuation, Risk, Research, Monitoring, and Committee.",
        },
        {
          prompt: "Does any of the 8 coaches accept free-form, open-ended questions?",
          options: ["Yes, all of them", "Yes, but only Committee Coach", "No — each is a fixed explanation over a fixed set of already-computed inputs", "Only with a premium subscription"],
          correctIndex: 2,
          explanation: "None of the 8 coaches is free-form chat — the genuine free-form Q&A feature lives on the Value Research page's separate 'Ask the AI Investment Analyst' panel.",
        },
        {
          prompt: "What does Monitoring Coach explain?",
          options: ["A fresh, re-scored opinion on the symbol", "Your own recorded alert history for that symbol — historical facts, never re-scored", "Live market data", "A prediction of future alerts"],
          correctIndex: 1,
          explanation: "Monitoring Coach reads already-recorded platform_notifications rows for the symbol — a historical record, not a fresh score.",
        },
        {
          prompt: "Is the Institutional AI Coach's '8 coaches' the same feature as the Trading Engine's '8 coaches' on /trading-ai-coach?",
          options: ["Yes, identical", "No — genuinely different coaches (Structure/Liquidity/Session/etc. vs. Investment/Portfolio/Decision/etc.) for a different engine", "They share the same backend function", "The Trading Engine version was deprecated"],
          correctIndex: 1,
          explanation: "These are two separate, similarly-structured features for two different engines — a naming coincidence worth knowing to avoid confusion.",
        },
        {
          prompt: "What does every one of the 8 coaches' responses end with?",
          options: ["A buy/sell recommendation", "A fixed disclaimer confirming the explanation quotes already-computed figures and creates no new recommendation", "A prompt to upgrade your account", "A random educational fact"],
          correctIndex: 1,
          explanation: "COACH_DISCLAIMER is appended to every response, every time, without exception.",
        },
      ],
    }),
    topic({
      ...
      nextStepKeys: ["investing-rebalancing-and-review"],
      guidedTourRequired: false,
    ...
    topic({
      key: "investing-rebalancing-and-review",
      title: "Ongoing Portfolio Review: The Rebalancing Engine and Reviewing What You Own",
      summary: "Planning and analysis only — never a new score, never an executed trade.",
      body: [
        "Once a portfolio exists in Portfolio Construction, reviewing it over time genuinely means two things on this platform: the standalone Rebalancing Engine (/rebalancing-engine) for ongoing drift analysis, and Portfolio Construction's own Performance/Snapshots/Timeline tabs for tracking what's actually changed. Alerts and watchlists — the two other pieces of 'monitoring' — are already covered in depth in the previous lesson and in the platform's own Watchlist coverage; this lesson deliberately doesn't repeat that content.",
        "The Rebalancing Engine's own header is explicit: 'PLANNING AND ANALYSIS ONLY. Zero trade recommendations, zero buy/sell signals, zero automatic portfolio optimisation, zero automatic rebalancing, zero auto execution, zero AI predictions, zero forecasting, zero machine learning, zero broker integration changes.' It reuses the exact same REBALANCE_DRIFT_THRESHOLD_PCT (5 percentage points) and the same concentration/sector caps already covered in the Portfolio Construction lesson — nothing new is computed here, only a dedicated what-if planning surface.",
        "Its own 'proposed allocation comparison' computes a capital-movement dollar figure per holding — literally −(driftPct / 100) × total market value — but this is explicitly never a share count and never an order. It answers 'how many dollars would need to move to bring this holding back to target,' not 'submit this trade.'",
        "An honest scope disclosure worth knowing: the Rebalancing Engine only works for Investing-side (target-weight) portfolios. Neither Trading Engine positions nor Options Income Engine positions have a stored target-weight field anywhere in this codebase, so rebalancing planning simply doesn't apply to those two engines — this isn't a bug, it's a real, disclosed scope boundary.",
        "For reviewing what's actually changed, use Portfolio Construction's own Performance tab (unrealized P&L per holding, based on your own entered cost basis) alongside the Snapshots and Timeline tabs — both require an explicit, user-triggered 'Save' action, never auto-populated, so a review history only exists if you deliberately built one.",
        "This platform's 'AI-generated portfolio insights' are, without exception in this scope, deterministic and template-based — the Rebalancing Engine's own Coach panel is explicitly labeled 'the deterministic AI Coach' in its own page code, producing fixed, lookup-table prose about CONCEPTS only, never about your specific symbols or account figures.",
      ],
      whyItMatters: "Knowing the Rebalancing Engine never executes anything — and that it only applies to Investing portfolios, not Trading or Options positions — prevents both the mistaken expectation of automation and the mistaken assumption that it covers your whole account.",
      difficulty: "intermediate",
      whyItExists: "Every dollar-movement calculation here is a direct, unmodified reuse of Portfolio Construction's own drift math — this module's only genuinely new logic is the what-if comparison framing itself, never a second, competing rebalance formula.",
      institutionalThinking: "A professional treats a drift-triggered 'Sell' or 'Buy' label as a prompt to ask 'why did this drift happen, and is it still the right target weight?' — not as an instruction to act mechanically. Reviewing periodically (via Performance/Snapshots/Timeline) rather than only reacting to alerts is what separates deliberate portfolio management from purely alert-driven reaction.",
      screenWalkthrough: [
        "Rebalancing Engine (/rebalancing-engine) — select a Portfolio Construction portfolio, see each holding's current vs. target weight, drift, and the same buy/sell/hold badge from Portfolio Construction.",
        "Proposed Allocation Comparison — a capital-movement dollar figure per holding (never a share count or order).",
        "'The deterministic AI Coach' panel — fixed, concept-level explanations of rebalancing terminology, never a symbol-specific opinion.",
        "Portfolio Construction's Performance tab — unrealized P&L $ and % per holding, requiring your own entered cost basis.",
        "Portfolio Construction's Snapshots tab — an explicit 'Save Portfolio Snapshot' / 'Save Risk Snapshot' button.",
        "Portfolio Construction's Timeline tab — a chronological read of whatever you've explicitly saved, never auto-populated.",
      ],
      workflowSteps: [
        "Periodically (not only when an alert fires) open the Rebalancing Engine for each of your portfolios.",
        "Review drift per holding and ask whether the original target weight still reflects your current conviction.",
        "Use the capital-movement dollar figure as planning input only — deciding to actually act happens outside this tool entirely.",
        "Separately, open Portfolio Construction's Performance tab to check unrealized P&L against your own entered cost basis.",
        "Save a Snapshot after any deliberate review, so the Timeline tab accumulates a genuine record over time.",
      ],
      metricsExplained: [
        { term: "Capital-Movement Dollars", explanation: "−(driftPct / 100) × total portfolio market value — a planning figure only, never a share count or an order." },
        { term: "TARGET_ALLOCATION_AVAILABILITY", explanation: "The Rebalancing Engine's own honest scope flag: only Investing-side target-weight portfolios have this field — Trading and Options positions don't, so rebalancing planning doesn't apply to them." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A disciplined periodic review",
          steps: [
            "You open the Rebalancing Engine once a month, regardless of whether any alert has fired.",
            "One holding shows modest drift, well within a range you're comfortable holding through.",
            "You save a Snapshot noting the review happened and no action was needed — a real, useful record for next month.",
          ],
          note: "Reviewing on a schedule, not only reacting to alerts, is what separates deliberate portfolio management from purely alert-driven behavior.",
        },
        {
          label: "Average Opportunity",
          title: "Drift worth reconsidering, not yet acting on",
          steps: [
            "The Rebalancing Engine shows one holding with meaningful positive drift — its own capital-movement figure suggests trimming a real dollar amount.",
            "You check the Performance tab and see this holding also carries the portfolio's largest unrealized gain.",
            "You decide the drift reflects a genuine, deliberate overweight (not neglect) and leave it, recording that reasoning in Notes.",
          ],
          note: "The tool surfaces the drift plainly; deciding whether it's a problem or a deliberate choice is explicitly left to you, and documenting that decision is what makes the next review meaningful.",
        },
        {
          label: "Poor Opportunity",
          title: "Mistaking the tool for automation",
          steps: [
            "A user opens the Rebalancing Engine expecting a 'rebalance now' button that actually submits trades.",
            "No such button exists anywhere on the page — the header explicitly disclaims automatic rebalancing and auto execution.",
            "The same user then tries to apply this tool to their Options Income Engine positions, only to find target-weight data doesn't exist there at all.",
          ],
          note: "Both mistakes come from the same source: expecting this planning tool to do more than its own explicit, disclosed scope — reading the page's own header disclaimer first would have prevented both.",
        },
      ],
      commonMistakes: [
        "Expecting the Rebalancing Engine to execute trades — it's explicitly planning and analysis only.",
        "Trying to use it for Trading Engine or Options Income Engine positions, which have no stored target-weight field at all.",
        "Treating the deterministic AI Coach's concept-level explanations as a symbol-specific opinion about your own holdings.",
        "Never saving a Snapshot, then wondering why the Timeline tab has nothing to show.",
        "Skipping periodic review entirely and relying only on alerts to prompt attention.",
      ],
      riskWarnings: [
        "The Rebalancing Engine's own header is explicit: zero automatic rebalancing, zero auto execution, zero AI predictions — every figure here is planning input only, never an instruction to act.",
        "This module doesn't apply to Trading or Options Income positions at all — don't assume it silently covers your whole account when it only covers Investing-side target-weight portfolios.",
      ],
      bestPractices: [
        "Review the Rebalancing Engine on a schedule, not only when an alert fires.",
        "Treat the capital-movement dollar figure as one input to a decision, never as an instruction.",
        "Pair drift review with Performance-tab P&L, since a large drift and a large unrealized gain are often the same underlying event.",
        "Document your reasoning in Notes whenever you deliberately choose NOT to rebalance a drifted holding.",
      ],
      aiCoachPrompts: [
        "Explain what drift means for this portfolio's holdings.",
        "What does the capital-movement figure actually represent?",
        "Why doesn't the Rebalancing Engine apply to my Options Income positions?",
        "What's the difference between reviewing via Snapshots and reacting to a Monitoring alert?",
      ],
      relatedModuleHrefs: ["/rebalancing-engine", "/stock-analyst/portfolio-construction", "/monitoring-dashboard"],
      relatedGlossaryKeys: ["rebalancing-assistant", "portfolio-drift-alert", "portfolio-construction"],
      nextStepKeys: ["investing-investment-committee"],
      estimatedMinutes: 7,
      knowledgeCheck: [
        {
          prompt: "What does the Rebalancing Engine's own header explicitly disclaim?",
          options: ["Nothing — it's fully automated", "Automatic rebalancing, auto execution, AI predictions, and forecasting — planning and analysis only", "Only broker connectivity", "It only disclaims price predictions"],
          correctIndex: 1,
          explanation: "The page's own header states plainly it has zero automatic rebalancing, zero auto execution, zero AI predictions — planning and analysis only.",
        },
        {
          prompt: "What does the capital-movement dollar figure represent?",
          options: ["A share count to submit as an order", "A planning figure: −(driftPct/100) × total market value, never a share count or order", "The portfolio's total realized P&L", "A brokerage fee estimate"],
          correctIndex: 1,
          explanation: "It's explicitly a dollar-planning figure only, never converted into a share count, order, or submission.",
        },
        {
          prompt: "Does the Rebalancing Engine work for Options Income Engine positions?",
          options: ["Yes, identically to Investing portfolios", "No — neither Trading nor Options positions have a stored target-weight field, an honest, disclosed scope boundary", "Only for closed positions", "Only with a premium account"],
          correctIndex: 1,
          explanation: "This is a real, disclosed limitation, not a bug — target-weight data simply doesn't exist for Trading or Options positions anywhere in this codebase.",
        },
        {
          prompt: "What triggers Portfolio Construction's Timeline tab to show a history entry?",
          options: ["It updates automatically every day", "An explicit, user-clicked Save Snapshot action — nothing is auto-populated", "It logs every page visit", "It only shows entries after a rebalance badge changes"],
          correctIndex: 1,
          explanation: "Both Portfolio and Risk Snapshots require an explicit save action — Timeline is purely a chronological read of what you've deliberately recorded.",
        },
        {
          prompt: "What kind of 'AI insight' does the Rebalancing Engine's Coach panel provide?",
          options: ["A free-form chatbot", "Genuinely LLM-generated, symbol-specific investment advice", "Fixed, deterministic, template-based prose about concepts only, never a symbol-specific opinion", "A live market forecast"],
          correctIndex: 2,
          explanation: "The panel is explicitly labeled 'the deterministic AI Coach' in its own page code — concept-level explanations only, never a real judgment about your specific holdings.",
        },
      ],
    }),
    topic({
      key: "investing-margin-of-safety",
      title: "Margin of Safety Across Four Independent Valuation Models",
      summary: "How much room for error is priced in — and where the underlying formulas come from.",
      body: [
        "Margin of safety is (fair value − price) / fair value across four independent, already-computed valuation models (Blended, Graham, DCF, Buffett) — a positive number means the model reads the stock as undervalued. This deepens the Financial Ratios lesson's own brief mention of these models, going one level further into how each one actually works.",
        "Graham's model averages the classic Graham Number (√(22.5 × trailing EPS × book value per share)) with Graham's own growth formula, using trailing EPS only — a deliberately conservative choice matching Graham's original methodology. DCF projects free cash flow forward over a multi-year horizon with a Gordon-growth terminal value, discounted back to the present. Buffett's model capitalizes owner earnings as a no-growth perpetuity, adjusted for the business's own quality and moat rating. All three, plus the platform's original Blended model, are computed completely independently — none feeds into another.",
        "The Consolidated Margin of Safety reports how many of the four models agree on direction (cheap/fair/expensive), not just an average number — model disagreement is itself useful information, since four independent methods converging on the same conclusion is meaningfully stronger evidence than any single one taken alone.",
        "Any model can honestly report itself unavailable rather than fabricate a number — Graham requires positive trailing EPS, DCF requires positive free cash flow, and both require internally consistent assumptions (e.g. DCF's discount rate must exceed its terminal growth rate) — when those conditions aren't met, the model simply doesn't produce a fair value.",
      ],
      whyItMatters: "No single valuation model is precise — the discipline is in cross-checking several independent methods and weighing convergence, not trusting one number. A model reporting itself 'unavailable' is real information about the underlying business, never a gap to route around.",
      externalHref: "/stock-analyst",
      relatedModuleHrefs: ["/stock-analyst", "/research-terminal"],
      relatedGlossaryKeys: ["margin-of-safety", "intrinsic-value", "discounted-cash-flow", "graham-number", "owner-earnings"],
      nextStepKeys: ["investing-opportunity-discovery"],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "How is Margin of Safety calculated?",
          options: ["(price − fair value) / price", "(fair value − price) / fair value", "fair value / price", "price / fair value"],
          correctIndex: 1,
          explanation: "A positive margin of safety means the model reads the stock as trading below its own computed fair value.",
        },
        {
          prompt: "Which EPS figure does Graham's model use?",
          options: ["Forward (estimated) EPS", "Trailing EPS only", "A blend of trailing and forward", "Adjusted, non-GAAP EPS"],
          correctIndex: 1,
          explanation: "Graham's model deliberately uses trailing EPS only, matching Graham's own conservative original methodology.",
        },
        {
          prompt: "Why does the Consolidated Margin of Safety report agreement, not just an average?",
          options: ["Averaging is computationally expensive", "Convergence across independent methods is meaningfully stronger evidence than any single model, and disagreement is itself useful information", "Because only two of the four models actually work", "Averaging would violate SEC rules"],
          correctIndex: 1,
          explanation: "Four independent models agreeing is stronger evidence than one confident-looking number — and disagreement is disclosed honestly, never averaged away.",
        },
      ],
    }),
    topic({
...
const TRADING_ENGINE_PATH: LearningPath = {
  ...
  topics: [
    ...
    topic({
      ...
      title: "The Trading AI Coach: 8 Deterministic Coaches, Zero Free-Form Chat",
      summary: "Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, and Psychology & Discipline — every explanation quotes an already-computed engine output, never a new signal.",
      body: [
        "The Trading AI Coach (/trading-ai-coach) offers 8 named, deterministic explanation coaches for a searched symbol — Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, and Psychology & Discipline. Despite the 'AI' in its name, none of the 8 is free-form LLM chat and none makes a real language-model call: every one composes its explanation strictly from already-computed figures elsewhere in the Trading Engine, and every response carries the same fixed disclaimer confirming this module creates no new signal, prediction, or recommendation.",
        "Structure Coach explains the Market Structure Workbench's own trend/swing-point/support-resistance reading for the symbol. Liquidity Coach explains the Liquidity Workbench's own volume/spread/session-window reading. Session Coach explains which trading session (pre-market, regular, after-hours) is active and what that means for the symbol's own liquidity profile. Risk Coach explains the Trade Planning & Risk Studio's own position-sizing and risk-budget figures. Trade Plan Coach explains a specific saved trade plan's own entry/stop/target and checklist state. Journal Coach reads your own recorded Trading Journal entries for that symbol — historical facts, never re-scored. Scenario Coach explains the Trade Planning & Risk Studio's own scenario-comparison output. Psychology & Discipline Coach reports discipline purely as documentation consistency (lesson-learned rate, win/loss tallies from your own recorded R-multiples) — never a fabricated psychological diagnosis.",
        "The Evidence Explorer (present on every coach's response) shows exactly which metrics and supporting evidence produced each reading, so no explanation is ever a black box you have to take on faith.",
        "This is a genuinely different feature from the similarly-structured '8 coaches' on the Institutional Investing Engine's own AI Coach page (/institutional-ai-coach) — that one covers Investment, Portfolio, Decision, Valuation, Risk, Research, Monitoring, and Committee, a completely different Engine 1 vocabulary. It is also a completely separate feature from the genuinely LLM-powered, free-form 'AI Trade Coach' chat panel (/ai-trading-coach and embedded on /trading-research) — that one makes real language-model calls and accepts open-ended questions; this one never does either. Three similarly-named things, three genuinely different implementations — see 'Meet Your AI Team' for the full disambiguation.",
      ],
      whyItMatters: "Knowing this coach is 8 fixed, rule-based explanation types — not a chatbot, and not the same feature as the similarly-named AI Trade Coach — sets the right expectation before you go looking for a message box that doesn't exist here.",
      difficulty: "beginner",
      whyItExists: "The only genuinely new content in this module is static, per-coach educational copy explaining how to read an already-existing Trading Engine figure — it introduces zero new scoring logic across all 8 coaches and makes zero language-model calls.",
      institutionalThinking: "A coach that only ever quotes evidence you could independently verify elsewhere on the Trading Engine builds a very different kind of trust than a black-box signal generator — this is a deliberate design choice, the same one the Investing Engine's own AI Coach makes, not a limitation to work around.",
      screenWalkthrough: [
        "Symbol search box — type a ticker to load that symbol's data across all 8 coaches.",
        "Coach-type tabs — Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, Psychology & Discipline — switch between them to see a different lens on the same symbol.",
        "Each coach's explanation panel — plain-language prose, always closing with the fixed disclaimer.",
        "Evidence Explorer — expands to show the exact metrics and supporting figures behind the current coach's explanation.",
      ],
      workflowSteps: [
        "Search a symbol on the Trading AI Coach page.",
        "Start with Structure Coach or Liquidity Coach for a general technical read, then switch to whichever coach matches your actual question.",
        "Use Trade Plan Coach or Risk Coach specifically when you're evaluating a saved plan you're about to act on.",
        "Use Journal Coach when you want your own past trading history for this symbol summarized, not a fresh opinion.",
        "Treat every coach's explanation as a starting point for further reading on the source workbench, never as a final answer.",
      ],
      metricsExplained: [
        { term: "TRADING_COACH_DISCLAIMER", explanation: "A fixed sentence appended to every one of the 8 coaches' responses, confirming the explanation quotes already-computed figures and creates no new trading signal or recommendation." },
        { term: "Coach vs. Free-Form Chat", explanation: "None of the 8 named coaches accepts an open-ended question or makes a real LLM call — each is a fixed explanation type over a fixed set of already-computed inputs for the searched symbol. Free-form chat lives on a separate page, /ai-trading-coach." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Using the right coach before acting on a trade plan",
          steps: [
            "You've built a trade plan on the Trade Planning & Risk Studio and want it explained plainly before acting — you open Trade Plan Coach for that symbol.",
            "You then open Risk Coach to see the same plan's position-sizing and risk-budget figures explained.",
            "Both explanations quote figures you could independently verify on the source workbench.",
          ],
          note: "Matching the coach to the actual question gets a more focused, useful explanation than defaulting to the same coach every time.",
        },
        {
          label: "Average Opportunity",
          title: "Using Journal Coach to review your own history",
          steps: [
            "Before re-entering a symbol you've traded before, you open Journal Coach to see your own recorded entries for it summarized.",
            "The coach reports your own past lesson-learned notes and win/loss tally, never re-scoring the symbol fresh.",
            "You still separately check Structure Coach or Liquidity Coach if you want an updated technical read.",
          ],
          note: "Journal Coach answers 'what did I record before,' not 'what should I do now' — a subtle but important distinction worth remembering.",
        },
        {
          label: "Poor Opportunity",
          title: "Expecting free-form chat that lives on a different page",
          steps: [
            "A user tries to type an open-ended, unrelated question into the Trading AI Coach expecting a chatbot reply.",
            "None of the 8 coaches accepts free-form input or makes a real language-model call — each is a fixed explanation over fixed inputs for the searched symbol.",
            "The genuinely free-form, LLM-powered AI Trade Coach lives at a different, similarly-named page: /ai-trading-coach.",
          ],
          note: "Knowing this platform's real distinction between fixed-explanation coaches and genuine free-form Q&A prevents a frustrating, avoidable mismatch of expectations.",
        },
      ],
      commonMistakes: [
        "Expecting free-form chat from the Trading AI Coach — all 8 coaches are fixed explanation types, not open-ended conversation, and none makes a real LLM call.",
        "Confusing this page's 8 coaches with the Investing Engine's own, differently-named 8 coaches on /institutional-ai-coach.",
        "Confusing this deterministic coach page with the genuinely LLM-powered, similarly-named AI Trade Coach at /ai-trading-coach.",
        "Skipping the fixed disclaimer and treating a coach's explanation as a trading recommendation.",
      ],
      riskWarnings: [
        "Every coach's fixed disclaimer exists for a reason — this module creates no new trading signal, prediction, or recommendation, and none of its 8 explanations should be treated as trading advice.",
        "Journal Coach's read is historical only — don't mistake it for a fresh, up-to-date judgment about the symbol's current condition.",
      ],
      bestPractices: [
        "Pick the specific coach that matches your actual question rather than defaulting to the same one every time.",
        "Use Trade Plan Coach and Risk Coach together when evaluating a plan you're about to act on.",
        "Remember every coach explanation is a quote of an already-computed figure — cross-check the source workbench (Market Structure, Liquidity, Trade Planning & Risk Studio, Trading Journal) when you want the full detail.",
      ],
      aiCoachPrompts: [
        "Explain this symbol's current market structure reading.",
        "What does Risk Coach say about my saved trade plan's position sizing?",
        "Summarize my own journal history for this symbol.",
        "Walk me through the Scenario Coach's comparison for this trade idea.",
      ],
      relatedModuleHrefs: ["/trading-ai-coach", "/trading-research", "/trade-planning-studio", "/trading-journal"],
      relatedGlossaryKeys: ["market-structure", "trade-plan", "deterministic-ai-coach"],
      nextStepKeys: [],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "How many named coaches does the Trading AI Coach page offer?",
          options: ["3", "5", "8", "12"],
          correctIndex: 2,
          explanation: "Eight: Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, and Psychology & Discipline.",
        },
        {
          prompt: "Does the Trading AI Coach make real language-model calls?",
          options: ["Yes, all 8 coaches call an LLM", "No — every coach is deterministic, composed strictly from already-computed engine figures", "Only Journal Coach calls an LLM", "Only when Live Trading is enabled"],
          correctIndex: 1,
          explanation: "Despite the 'AI' in its name, none of the 8 coaches makes a real language-model call — each is a fixed, rule-based explanation over already-computed inputs.",
        },
        {
          prompt: "Where does this platform's genuinely free-form, LLM-powered trade coach chat actually live?",
          options: ["On the same /trading-ai-coach page", "At a separate page, /ai-trading-coach", "It doesn't exist", "Only in the Institutional AI Coach"],
          correctIndex: 1,
          explanation: "/ai-trading-coach is a separate, genuinely LLM-powered free-form chat feature — a confirmed naming collision with this deterministic /trading-ai-coach page, not the same feature.",
        },
        {
          prompt: "What does Journal Coach explain?",
          options: ["A fresh, re-scored opinion on the symbol", "Your own recorded Trading Journal entries for that symbol — historical facts, never re-scored", "Live market data", "A prediction of future trades"],
          correctIndex: 1,
          explanation: "Journal Coach reads your own already-recorded journal entries for the symbol — a historical record, not a fresh score.",
        },
        {
          prompt: "Is the Trading AI Coach's '8 coaches' the same feature as the Institutional Investing Engine's '8 coaches' on /institutional-ai-coach?",
          options: ["Yes, identical", "No — genuinely different coaches (Structure/Liquidity/Session/etc. vs. Investment/Portfolio/Decision/etc.) for a different engine", "They share the same backend function", "The Investing Engine version was deprecated"],
          correctIndex: 1,
          explanation: "These are two separate, similarly-structured features for two different engines — a naming coincidence worth knowing to avoid confusion.",
        },
      ],
...
// v1.4.0, Sprint L2J — AI Coach & Institutional Mentor Academy. A new,
// thirteenth Learning Path teaching users to work effectively with every
// real AI assistant on the platform — deliberately cross-cutting across
// all three engines, matching PLATFORM_BASICS_PATH's own "how to use the
// software itself" scope rather than any one engine's own concept
// vocabulary. This path introduces ZERO new AI capability of its own — it
// only teaches the already-shipped ones, cross-referencing (never
// duplicating) the already-rich existing coverage of ai-coach-overview
// (/assistant, Platform Basics), investing-ai-coach and
// investing-institutional-mentor and investing-investment-committee
// (Institutional Investing), and portfolio-ai-review-workflow (Portfolio).
const AI_ACADEMY_PATH: LearningPath = {
  key: "ai-academy",
  title: "AI Coach & Institutional Mentor Academy",
  description: "How to work effectively with every real AI assistant on this platform — what each one does, when to use it, what data it uses, and how to read what it tells you.",
  glossaryCategory: "platform",
  topics: [
    topic({
      key: "ai-team-overview",
      title: "Meet Your AI Team",
      summary: "Every real AI assistant on this platform, in one place — and the honest line between genuine LLM output and deterministic template prose.",
      body: [
        "This platform has more AI-named features than any single page reveals — a real, working free-form chat, several narrow LLM-narration buttons layered on top of deterministic reports, and over a dozen 'AI Coach' panels that are explicitly, deliberately NOT AI at all. This lesson is the map: what every one of them actually is, so you never guess wrong about which kind you're looking at.",
        "Two genuinely LLM-powered chat surfaces exist: the original AI Coach (/assistant) — a mode-selectable chat whose default path is mostly a keyword-routed dispatcher to deterministic templates, with only 3 of its ~20 response branches (Explain Trade, Teach Greeks, Value Research) actually calling the LLM — and the newer, unified AI Trade Coach (/ai-trading-coach), a genuinely free-form question box with persistent chat history, grounded across Engine 2's market-structure/risk/probability engines AND Engine 3's options-income portfolio, scanner, and journal data in one composed context.",
        "Several narrower, single-purpose LLM buttons exist layered on top of already-computed reports, never replacing them: 'Ask the AI Investment Analyst' (free-form, on the Value Research page), 'Narrate this verdict' (explains only the Investment Committee's already-reached consolidated verdict), the AI Market Briefing and Report Comparison narration (on the options-income Portfolio AI page), and 'Narrate My Day' (an optional overlay on the Cross-Engine Daily Report's always-visible deterministic summary). Every one of these has a hand-written deterministic fallback and a `source: \"llm\" | \"template\"` field so you can always tell which path actually served a given answer.",
        "The platform's single most tightly-guarded AI use case is Management Quality Analysis's Communication Quality and Long-Term Focus dimensions — genuinely LLM-narrated from a company's own SEC filing text, with NO fallback score at all (an honestly `unavailable` result beats a fabricated number here) and a structural guard that discards any response that characterizes a named individual rather than the filing itself.",
        "Everything else — the Institutional AI Coach's 8 coaches (Engine 1), the Institutional Trading AI Coach's 9 coaches (Engine 2, a genuine naming collision with the unrelated LLM-powered AI Trade Coach — don't confuse the two), Institutional Mentor, the AI Portfolio Analyst, the Watchlists Engine's own 'AI Coach,' and roughly a dozen more topic-keyed coach panels across Portfolio Risk, Compliance, Rebalancing, Scenario, and related modules — are deterministic, template-based prose over already-computed platform data. Institutional Mentor's own header states this most plainly of all: 'THIS IS NOT an LLM, a chatbot, predictive AI, financial advice, portfolio optimisation, or a trade recommendation engine.'",
      ],
      whyItMatters: "Knowing which AI you're actually talking to — a real, grounded LLM answering your specific question, or a fixed template explaining a concept — sets the right expectation before you ask it something it was never built to answer.",
      difficulty: "beginner",
      whyItExists: "Every AI feature on this platform reuses already-computed, already-tested data from an existing engine — none of them recomputes a score or invents a fact. This lesson exists because that discipline is only useful if you actually know which pattern (genuine LLM vs. deterministic template) you're looking at on any given page.",
      institutionalThinking: "A professional treats an AI explanation the way they'd treat a junior analyst's summary: useful for understanding WHY a number looks the way it does, never a substitute for their own judgment about what to do next — and they always know whether that 'analyst' is reasoning freely or reading from a script, because the two carry very different levels of trust.",
      screenWalkthrough: [
        "Genuinely free-form chat: AI Coach (/assistant) and the unified AI Trade Coach (/ai-trading-coach) — type any question, get a real LLM-composed answer grounded in your own already-computed data.",
        "Narrow LLM narration buttons layered on deterministic reports: 'Ask the AI Investment Analyst' and 'Narrate this verdict' (Value Research page, /stock-analyst), AI Market Briefing and Report Comparison narration (Portfolio AI, /portfolio-ai), 'Narrate My Day' (Cross-Engine Daily Report, /daily-report).",
        "Deterministic 'AI Coach' panels (zero LLM calls, ever): Institutional AI Coach (/institutional-ai-coach), Institutional Trading AI Coach (/trading-ai-coach), Institutional Mentor (/institutional-mentor), AI Portfolio Analyst (/portfolio-analyst), Watchlists Engine's Coach tab (/watchlists-engine), and roughly a dozen more topic-keyed coaches across Rebalancing, Compliance, Scenario, and similar pages.",
        "The one dimension with no fallback: Management Quality's Communication Quality and Long-Term Focus (Filings & Mgmt tab, /stock-analyst) — honestly `unavailable` rather than a guessed score whenever the LLM path can't safely complete.",
      ],
      workflowSteps: [
        "Before typing a question anywhere on this platform, ask yourself: is this box genuinely free-form (AI Coach, AI Trade Coach), or is it a fixed 'explain this already-computed thing' button?",
        "For a fixed coach panel, remember it can only explain what's already been computed elsewhere — it will never answer a question outside that scope.",
        "For a free-form chat, check whether the response mentions being unable to answer something outside its own grounding data — that's the prompt's own honesty discipline working correctly, not a bug.",
        "When a response matters to a real decision, look for a `source` field or similar indicator showing whether it was genuinely LLM-generated or the deterministic fallback.",
        "Treat Management Quality's two narrated dimensions with extra care — an `unavailable` result there is deliberate honesty, not a broken feature.",
      ],
      metricsExplained: [
        { term: "source: \"llm\" | \"template\"", explanation: "A field carried on every narration response across this platform, honestly disclosing whether the text you're reading was genuinely LLM-generated or the hand-written deterministic fallback used when no API key is configured or the live call failed." },
        { term: "COACH_DISCLAIMER", explanation: "A fixed disclaimer sentence guaranteed on every coach response across the platform (three separately-named but functionally identical constants exist for the options/investing/trading engines) — appended even to genuine LLM output, never something the model can omit." },
        { term: "Deterministic Coach", explanation: "A panel that takes only a topic key (or an already-computed report/score) as input, never a live quote or account figure — structurally incapable of producing a trade recommendation, since no function inside it accepts the kind of input a recommendation would require." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Picking the right AI for the question",
          steps: [
            "You want to know why the Investment Committee reached a Hold verdict on a specific stock — you click 'Narrate this verdict,' the narrow, purpose-built LLM button for exactly that question.",
            "You separately want a general explanation of what 'margin of safety' means — you open the Institutional AI Coach's Valuation coach, a deterministic explainer that needs no live LLM call.",
            "Both give you a correct, useful answer, because each was matched to what it was actually built for.",
          ],
          note: "Matching the tool to the question, rather than defaulting to whichever chat box is closest, gets a better answer faster.",
        },
        {
          label: "Average Opportunity",
          title: "Asking a free-form chat something slightly outside its grounding",
          steps: [
            "You ask the unified AI Trade Coach a question about a symbol you don't currently hold and haven't searched.",
            "The response honestly states the DATA it was given doesn't cover that symbol, rather than fabricating an answer.",
            "You then search that symbol on the Trading Research page first, so the coach has real grounding data to answer from.",
          ],
          note: "A free-form chat's honesty about its own grounding gaps is a feature, not a limitation to work around by rephrasing until it guesses.",
        },
        {
          label: "Poor Opportunity",
          title: "Mistaking a deterministic coach for a live LLM analyst",
          steps: [
            "A user asks the Institutional Trading AI Coach's Structure coach a genuinely open-ended question, expecting a conversational reply.",
            "The coach can only explain the already-computed Market Structure reading for a symbol — it has no mechanism to answer an unrelated question at all.",
            "The user finds the actual free-form surface (AI Trade Coach, a different, LLM-powered module with a confusingly similar name) and gets a real answer there instead.",
          ],
          note: "This exact naming collision — 'Trading AI Coach' (deterministic) vs. 'AI Trade Coach' (genuinely LLM-powered) — is disclosed directly in this platform's own engineering notes; knowing it exists here prevents the same confusion.",
        },
      ],
      commonMistakes: [
        "Assuming every panel with 'AI' in its name makes a real LLM call — most of this platform's AI-named features are deterministic templates by explicit design.",
        "Confusing the Institutional Trading AI Coach (9 deterministic coaches) with the unrelated, similarly-named AI Trade Coach (genuinely free-form LLM chat) — a real, disclosed naming collision.",
        "Expecting a fixed-topic deterministic coach to answer an open-ended question it was never built to accept.",
        "Treating an `unavailable` Management Quality narration dimension as a bug rather than the platform's own strictest honesty guarantee.",
      ],
      riskWarnings: [
        "No AI feature on this platform — genuine LLM or deterministic template — is built to produce a trade or investment recommendation; every one of them, without exception, exists to explain already-computed figures, never to tell you what to do next.",
        "A `source: \"template\"` response is not lower-quality data, but it is not a live, freshly-reasoned answer either — don't mistake a deterministic fallback for genuine LLM judgment about your specific question.",
      ],
      bestPractices: [
        "Learn which of the two genuinely free-form chats (AI Coach or the unified AI Trade Coach) fits your question before typing it.",
        "Use the narrow narration buttons ('Narrate this verdict,' 'Narrate My Day') when you specifically want the already-computed facts explained in prose, not a new analysis.",
        "Check for a `source`/`narrativeSource` field when a response matters to a real decision, so you know whether it was genuinely LLM-generated.",
        "Never treat any AI response on this platform — genuine LLM or deterministic template — as a trade or investment recommendation; none of them is built to give one.",
      ],
      aiCoachPrompts: [
        "Which AI feature should I use to understand why my portfolio's risk score changed?",
        "Is this coach panel a real LLM or a deterministic template?",
        "What's the difference between the Institutional Trading AI Coach and the AI Trade Coach?",
        "What does it mean when a Management Quality dimension shows 'unavailable'?",
      ],
      relatedModuleHrefs: ["/assistant", "/ai-trading-coach", "/institutional-ai-coach", "/trading-ai-coach", "/institutional-mentor", "/portfolio-analyst", "/stock-analyst"],
      relatedGlossaryKeys: ["llm-narration-source", "deterministic-ai-coach", "coach-disclaimer"],
      nextStepKeys: ["ai-writing-better-prompts"],
      estimatedMinutes: 8,
      knowledgeCheck: [
        {
          prompt: "Which of these is a genuinely free-form, LLM-powered chat interface?",
          options: ["The Institutional Trading AI Coach's Structure panel", "The unified AI Trade Coach (/ai-trading-coach)", "Institutional Mentor", "The Watchlists Engine's Coach tab"],
          correctIndex: 1,
          explanation: "The unified AI Trade Coach accepts a genuinely open-ended question and grounds a real LLM answer in your own composed platform data — unlike the deterministic, topic-keyed coaches.",
        },
        {
          prompt: "What does Institutional Mentor's own header state about itself?",
          options: ["It is a genuine LLM chatbot", "It is NOT an LLM, chatbot, predictive AI, or trade recommendation engine — every statement is a pass-through or disclosed template", "It predicts future portfolio performance", "It automatically rebalances your portfolio"],
          correctIndex: 1,
          explanation: "This is the platform's most explicit self-disclaimer, stated verbatim in the module's own header comment and repeated on its frontend page.",
        },
        {
          prompt: "What happens with Management Quality's Communication Quality dimension when the LLM narration can't safely complete?",
          options: ["It shows a fabricated mid-range score", "It honestly reports the dimension as unavailable — no fallback score exists", "It falls back to a deterministic template score", "It retries indefinitely"],
          correctIndex: 1,
          explanation: "This is the one dimension across the whole platform with no template fallback — a fabricated number would be indistinguishable from a genuine signal, so honesty wins over completeness.",
        },
        {
          prompt: "What does a `source: \"template\"` field on a narration response tell you?",
          options: ["The response is more trustworthy than usual", "The text is the hand-written deterministic fallback, not genuine LLM output", "The response came from a different engine", "Nothing — the field is decorative"],
          correctIndex: 1,
          explanation: "Every narration response honestly discloses which path produced it — a template response was used because the LLM was unavailable or the live call failed, never presented as if it were genuine LLM prose.",
        },
        {
          prompt: "What structurally prevents a deterministic 'AI Coach' panel from ever producing a trade recommendation?",
          options: ["A content filter checks the output after generation", "The underlying functions take only a topic key or already-computed report as input — never a live quote, position, or account figure that a recommendation would require", "A human reviews every response first", "Nothing — it's purely a policy, not a structural guarantee"],
          correctIndex: 1,
          explanation: "Several of these modules' own header comments state this explicitly: since no function accepts the kind of input a recommendation would need, one is structurally impossible to produce, not merely discouraged.",
        },
      ],
    }),
    topic({
      key: "ai-writing-better-prompts",
      title: "Writing Better Prompts",
      summary: "Real examples from this platform's own free-form AI boxes — what makes a question answerable, and what doesn't.",
      body: [
        "This platform's genuinely free-form AI surfaces (AI Coach at /assistant, the unified AI Trade Coach at /ai-trading-coach, 'Ask the AI Investment Analyst' on the Value Research page) all share the same real constraint, stated directly in their own prompts: they can only answer from the specific, already-computed DATA they were given for that call — never from general knowledge, live market feeds, or anything about a symbol or account you haven't actually loaded. Writing a better prompt on this platform mostly means writing a question the DATA can actually answer.",
        "A good prompt names the specific thing you want explained, using the platform's own vocabulary. 'Why does the Investment Committee say Hold?' is directly answerable — it's asking about a field (`consolidatedVerdict`) that's already in the grounding DATA the moment you're viewing that stock's report. 'Explain my Portfolio Health Score' works the same way on the AI Trade Coach, since your own portfolio risk figures are already part of its composed context.",
        "A prompt the platform genuinely cannot answer honestly is one asking for something outside the DATA entirely — a future price prediction, a real-time quote, information about a symbol you haven't searched, or a recommendation to buy or sell. Every one of these platforms' prompts explicitly instructs the model to say plainly that the report doesn't cover that, rather than inventing an answer — so if you ask 'Will this stock go up tomorrow?' you should expect an honest 'I can't answer that' rather than a fabricated forecast, and that response is the system working correctly, not failing.",
        "Follow-up prompts work well because your prior turns and the underlying grounding data stay available — you can ask 'Why is that?' after an answer and get a genuinely connected reply, especially on the AI Trade Coach, which persists your whole conversation history server-side rather than losing it on refresh.",
        "Refining a request that got an unhelpful or too-generic answer usually means adding the specific field name or panel you actually care about — 'Explain my risk' is vaguer than 'Why is my Portfolio Risk score's Sector Exposure component elevated?' — because the second version points the model at exactly which already-computed number to explain.",
      ],
      whyItMatters: "A prompt that names a real, already-computed field gets a precise, useful answer every time; a prompt asking for something outside the platform's own data gets an honest refusal instead of a fabricated one — knowing the difference in advance saves you a wasted question.",
      difficulty: "beginner",
      whyItExists: "Every free-form AI surface on this platform is deliberately grounded-only, by explicit prompt instruction, as a safety property, not an accident — this lesson exists to turn that constraint into a practical skill rather than a source of confusing 'I can't answer that' replies.",
      institutionalThinking: "A professional analyst asking a colleague a question already knows the colleague only has the report in front of them, not a crystal ball — the same discipline applies here: ask what the DATA can answer, and treat 'that's outside what I have' as a correct, informative response rather than a failure.",
      screenWalkthrough: [
        "'Ask the AI Investment Analyst' (Value Research page, /stock-analyst) — a plain text box, placeholder example already hints at the right shape: 'e.g. Why does the Investment Committee say Hold?'",
        "AI Trade Coach (/ai-trading-coach) — a persistent chat panel; prior turns and your own trading-position context stay available across the whole session.",
        "AI Coach (/assistant) — mode selector plus a chat box; picking a specific mode (Explain Trade, Teach Greeks, Value Research) narrows what the underlying dispatcher looks for, often producing a more precise answer than leaving it on Auto-detect.",
        "Every response transcript — read the actual wording of an 'I can't answer that' reply; it usually names exactly what kind of thing was missing (a symbol, a live quote, a future prediction), which tells you how to rephrase.",
      ],
      workflowSteps: [
        "Before asking, check what's actually on screen — the fields, scores, and sections you can see are exactly what the AI's grounding DATA contains.",
        "Name a specific field or panel in your question rather than asking generically.",
        "If the answer feels too generic, ask a tighter follow-up referencing the specific number or section you actually meant.",
        "If you get an honest 'that's outside the data' response, treat it as accurate information, not a failure — either search the missing symbol, or accept the platform genuinely doesn't track that.",
        "Never rephrase repeatedly trying to trick a free-form AI into a future price prediction or a buy/sell instruction — every one of these prompts is deliberately built to refuse that regardless of phrasing.",
      ],
      metricsExplained: [
        { term: "Grounding DATA", explanation: "The specific, already-computed object (a full research report, a trading-risk analysis, a portfolio snapshot) passed into an LLM prompt for one call — the only source of fact the AI is instructed to use." },
        { term: "Honest Refusal", explanation: "A response stating plainly that a question falls outside the provided DATA — an intentional, prompt-instructed behavior across every free-form surface on this platform, never a bug." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A precise, answerable prompt",
          steps: [
            "On the Value Research page for a searched symbol, you ask 'Why is the Graham Valuation showing unavailable for this symbol?'",
            "The Ask panel answers directly, since Graham's own `available: false` reason is already part of the grounding report.",
            "You follow up with 'What about the DCF model?' and get a connected answer about the second model, since both are already in the same report.",
          ],
          note: "Naming the specific model and the specific symptom (unavailable) points the AI at an exact field it can genuinely explain.",
        },
        {
          label: "Average Opportunity",
          title: "A vague prompt that needs refining",
          steps: [
            "You ask the AI Trade Coach 'How's my portfolio doing?' — a real but generic question.",
            "The answer covers several things at once (risk, open positions, recent journal entries) without deep focus on any one.",
            "You refine with 'Specifically, is my Portfolio Risk score's Concentration component a problem?' and get a much more targeted answer.",
          ],
          note: "The first answer wasn't wrong — it just had to guess which of several available things you actually cared about; naming the specific component removes the guesswork.",
        },
        {
          label: "Poor Opportunity",
          title: "A prompt the platform is built to refuse",
          steps: [
            "You ask 'Will AAPL go up next week?' on the Value Research page's Ask panel.",
            "The response states plainly that a future price prediction isn't something the report covers, rather than inventing a forecast.",
            "Rephrasing the same question five different ways produces the same honest refusal each time, since the underlying prompt instruction is unconditional, not a phrasing trick to route around.",
          ],
          note: "This refusal is the platform's safety design working exactly as intended — no phrasing unlocks a fabricated prediction, by explicit, deliberate instruction to the model.",
        },
      ],
      commonMistakes: [
        "Asking a free-form AI about a symbol or account feature you haven't actually searched or opened — its grounding data simply doesn't include it yet.",
        "Trying to rephrase a future-price-prediction question until it 'works' — every one of this platform's prompts refuses this unconditionally, by design.",
        "Asking overly generic questions ('how am I doing?') and being surprised the answer feels unfocused.",
        "Forgetting that the AI Trade Coach persists history — asking the same question repeatedly instead of building on the prior answer with a follow-up.",
      ],
      riskWarnings: [
        "An honest refusal from a free-form AI ('that's outside the data') is the safety design working correctly — never rephrase repeatedly trying to extract a forecast or recommendation it's deliberately built to withhold.",
        "A precise, well-grounded answer still isn't investment or trading advice — every free-form surface on this platform carries the same fixed disclaimer for a reason.",
      ],
      bestPractices: [
        "Name the specific field, panel, or section you want explained, using the platform's own on-screen labels.",
        "Use follow-up questions to go deeper rather than restarting with a new, unrelated question each time.",
        "Read an 'I can't answer that' response carefully — it usually tells you exactly what to search or open first.",
        "Match your question to the right AI surface (see the previous lesson) before worrying about phrasing at all.",
      ],
      aiCoachPrompts: [
        "Why does the Investment Committee say Hold for this symbol?",
        "What does my Portfolio Risk score's Sector Exposure component mean?",
        "Explain the difference between the Graham and DCF valuation models for this stock.",
        "Why can't you tell me if this stock will go up?",
      ],
      relatedModuleHrefs: ["/stock-analyst", "/ai-trading-coach", "/assistant"],
      relatedGlossaryKeys: ["llm-narration-source", "coach-disclaimer"],
      nextStepKeys: ["ai-research-workflow"],
      estimatedMinutes: 6,
      knowledgeCheck: [
        {
          prompt: "What can a free-form AI on this platform actually answer from?",
          options: ["Its own general training knowledge", "Only the specific, already-computed DATA it was given for that call", "Live internet search results", "Anything you ask, regardless of context"],
          correctIndex: 1,
          explanation: "Every free-form prompt is explicitly instructed to use ONLY the provided DATA — never general knowledge or live external data.",
        },
        {
          prompt: "What happens when you ask a future price prediction question?",
          options: ["A best-guess forecast is generated", "An honest refusal — the prompt instructs the model to say plainly that this isn't covered", "The request is silently ignored", "It depends on how the question is phrased"],
          correctIndex: 1,
          explanation: "This refusal is unconditional and prompt-instructed — no rephrasing unlocks a fabricated prediction.",
        },
        {
          prompt: "Why does naming a specific field in your question usually get a better answer?",
          options: ["It doesn't matter, all questions get the same answer", "It points the model at an exact, already-computed value rather than making it guess which of several things you meant", "Specific questions cost less", "Field names are required syntax"],
          correctIndex: 1,
          explanation: "A generic question forces the model to guess your intent across several available topics; naming a field removes that ambiguity.",
        },
        {
          prompt: "Which AI surface persists your full conversation history server-side across visits?",
          options: ["The Institutional AI Coach's 8 coaches", "The unified AI Trade Coach (/ai-trading-coach)", "Institutional Mentor", "The Watchlists Engine Coach"],
          correctIndex: 1,
          explanation: "The unified AI Trade Coach writes every turn to a persistent table, unlike the stateless, per-request deterministic coaches.",
        },
        {
          prompt: "You keep rephrasing a question trying to get a future price prediction. What should you expect?",
          options: ["Eventually a forecast is produced", "The same honest refusal every time — the underlying prompt instruction is unconditional, not a phrasing puzzle", "The system will time out", "A random guess is returned after 3 attempts"],
          correctIndex: 1,
          explanation: "Every free-form prompt on this platform is instructed to refuse a price/outcome prediction unconditionally — no phrasing routes around it, by explicit design.",
        },
      ],
    }),
    topic({
      key: "ai-research-workflow",
      title: "AI Research Workflow",
      summary: "Using AI to analyse a company, review its statements, and stress-test your own conclusions — every answer grounded in an already-computed report.",
      body: [
        "This platform's AI research tools are not a separate research engine — they're a set of ways to ask questions about the exact same Value Research report you can already read on the page. Two AI surfaces cover this specifically: the Institutional AI Coach's deterministic Research/Valuation coaches (fixed explanations of Business Quality, Competitive Advantage, and the 4 valuation models), and 'Ask the AI Investment Analyst,' the genuinely free-form question box grounded in the entire report — including Investment Quality, Competitive Advantage, all 4 named valuation models, the Consolidated Margin of Safety, the full Tom Nash pillar analysis, and the Investment Committee's votes.",
        "A real end-to-end AI-assisted research workflow: search a company on the Value Research page, read the deterministic report first (Business Quality, Financial Ratios, Statements, Filings, Earnings — covered in the Institutional Investing Academy's own Research & Fundamental Analysis lesson), then use the Research or Valuation coach for a plain-language walkthrough of any section you want explained, and finally use 'Ask the AI Investment Analyst' for anything genuinely open-ended the fixed coaches don't cover — comparing two valuation models' disagreement, for instance.",
        "Reviewing financial statements with AI means asking about the real, already-fetched 5-year Income Statement/Balance Sheet/Cash Flow data on the Statements tab — the AI can explain a trend you're looking at, but it never re-derives the underlying numbers itself.",
        "Evaluating valuation with AI means using the Valuation coach or the Ask panel to walk through why Graham, DCF, Buffett, and the Blended model reached their specific fair-value figures — and, honestly, why one of them might report itself unavailable rather than a number.",
        "Reviewing earnings and comparing competitors both reuse already-computed data: the Earnings Intelligence tab's own quarterly surprise/streak/trend figures, and the Peers tab's Industry Comparison — an AI explanation of either is a narration of numbers already on screen, never a live analyst call.",
        "Building an investment thesis with AI means using the Committee coach or 'Narrate this verdict' to understand where Graham, Buffett, and Tom Nash agree or disagree, then using the Ask panel to press on the specific disagreement — the AI never writes the thesis for you; it helps you read the evidence the platform already assembled.",
      ],
      whyItMatters: "AI research assistance on this platform genuinely speeds up reading a report you'd otherwise have to work through section by section — but it never replaces reading the Filings tab's real SEC-EDGAR text or the Statements tab's actual numbers, since every AI answer is itself just a narration of those same underlying facts.",
      difficulty: "intermediate",
      whyItExists: "Institutional AI Coach's Research and Valuation coaches and the Ask panel all reuse the same already-computed ValueResearchReport with zero new scoring logic — this lesson exists to show the practical workflow of stitching those pieces together into one research session, not to introduce anything new.",
      institutionalThinking: "A professional analyst never treats an AI's explanation of a valuation model as a second opinion independent of the model itself — it's the same number, in prose. The actual second opinion comes from the model disagreement the Consolidated Margin of Safety already surfaces (unanimous vs. split), which the AI can help you read but never resolves for you.",
      screenWalkthrough: [
        "Value Research page (/stock-analyst) — search a symbol, read the full deterministic report top to bottom first.",
        "Institutional AI Coach (/institutional-ai-coach), Research and Valuation tabs — fixed, deterministic explanations for the searched symbol.",
        "'Ask the AI Investment Analyst' panel — free-form question box grounded in the full report, including the Investment Committee and Tom Nash sections.",
        "Statements, Peers, Filings & Mgmt, Earnings tabs — the real underlying data any AI explanation is narrating; always worth opening directly, not only through an AI summary.",
      ],
      workflowSteps: [
        "Search a company on the Value Research page and read the deterministic report first.",
        "Open the Institutional AI Coach's Research coach for a plain-language walkthrough of Business Quality and Competitive Advantage.",
        "Open the Valuation coach to understand how Graham/DCF/Buffett/Blended relate to each other.",
        "Use 'Ask the AI Investment Analyst' for anything specific the fixed coaches didn't cover — a particular disagreement, a specific ratio, a filing detail.",
        "Cross-check any AI explanation against the Statements/Filings/Earnings tabs directly before treating it as settled.",
        "Use the Committee coach or 'Narrate this verdict' to understand agreement/disagreement before forming your own thesis.",
      ],
      metricsExplained: [
        { term: "Research Coach", explanation: "One of the Institutional AI Coach's 8 deterministic coaches — explains Business Quality factors, Competitive Advantage dimensions, and Investment Quality, all already-computed figures, never a new judgment." },
        { term: "Valuation Coach", explanation: "Explains the Blended, Graham, DCF, and Buffett valuation models plus the Consolidated Margin of Safety — same already-computed figures the report itself shows, narrated in prose." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A full, disciplined AI-assisted research session",
          steps: [
            "You read the full deterministic report, noting the Investment Committee shows 'unanimous' agreement on Buy.",
            "You use the Valuation coach to understand why all 4 models agree the stock is cheap.",
            "You ask the Investment Analyst panel a specific follow-up about the Filings tab's Risk Factors excerpt before finalizing your view.",
          ],
          note: "Each AI interaction added a specific piece of understanding, layered on top of the deterministic report you'd already read — never a replacement for it.",
        },
        {
          label: "Average Opportunity",
          title: "Using AI to interpret genuine model disagreement",
          steps: [
            "The Consolidated Margin of Safety shows a 'split' signal — Graham reads cheap, Buffett reads expensive.",
            "You use the Ask panel to ask specifically why the two models disagree.",
            "The answer explains the different assumptions (trailing EPS vs. owner-earnings capitalization) without resolving which one is 'right' — that judgment stays yours.",
          ],
          note: "AI explaining a genuine disagreement, rather than papering over it with a false consensus, is the honest and useful outcome here.",
        },
        {
          label: "Poor Opportunity",
          title: "Treating an AI summary as a substitute for the real filing",
          steps: [
            "A user reads only the Research coach's summary of Business Quality, never opening the Filings tab's own real SEC EDGAR 10-K text.",
            "They form a view based entirely on narrated, already-computed scores without reading the company's own disclosed Risk Factors.",
            "A more disciplined approach uses the AI explanation as a starting point, then reads the primary source before finalizing a thesis.",
          ],
          note: "An AI narration is a faster way to understand an already-computed number — it is never a substitute for reading the underlying real government filing when the decision actually matters.",
        },
      ],
      commonMistakes: [
        "Treating an AI's valuation explanation as a second, independent opinion rather than a narration of the same number already on screen.",
        "Skipping the real Filings/Statements/Earnings tabs entirely in favor of only AI-narrated summaries.",
        "Expecting the Ask panel to resolve genuine model disagreement rather than explain it.",
        "Using the fixed Research/Valuation coaches for a question they weren't built to answer, instead of switching to the free-form Ask panel.",
      ],
      riskWarnings: [
        "Every AI answer in this workflow is a narration of an already-computed report — none of it is a substitute for reading the real Filings tab text or the actual 5-year Statements data when a decision genuinely matters.",
        "Neither the fixed coaches nor the Ask panel produce a buy/sell recommendation — the Investment Committee's own consolidated verdict, itself just a synthesis of Graham/Buffett/Tom Nash, is the closest thing to a recommendation this platform offers, and even that carries the same disclaimer as everything else.",
      ],
      bestPractices: [
        "Read the deterministic report before reaching for an AI explanation of it.",
        "Use the fixed coaches for quick, reliable explanations of a specific section; use the Ask panel for anything genuinely open-ended.",
        "Always cross-check an AI narration of a filing detail against the real Filings tab excerpt.",
        "Treat committee/model disagreement as information to investigate, not something to average away via an AI summary.",
      ],
      aiCoachPrompts: [
        "Explain this company's Business Quality score.",
        "Why do Graham and Buffett disagree on this stock's valuation?",
        "Summarize the trend in this company's margins over the last 6 years.",
        "What does the Investment Committee's agreement signal tell me here?",
      ],
      relatedModuleHrefs: ["/stock-analyst", "/institutional-ai-coach", "/research-terminal"],
      relatedGlossaryKeys: ["llm-narration-source", "deterministic-ai-coach"],
      nextStepKeys: ["ai-trading-workflow"],
      estimatedMinutes: 7,
      knowledgeCheck: [
        {
          prompt: "What does the Institutional AI Coach's Research coach actually explain?",
          options: ["A newly-computed research score", "Already-computed Business Quality, Competitive Advantage, and Investment Quality figures", "A live news feed", "Nothing about the researched company"],
          correctIndex: 1,
          explanation: "Every figure the Research coach explains is already present on the ValueResearchReport — nothing new is computed.",
        },
        {
          prompt: "What is the correct interpretation of a 'split' Consolidated Margin of Safety signal?",
          options: ["A platform error", "The 4 valuation models genuinely disagree on direction — useful information, not a bug", "Always a Buy signal", "The AI couldn't complete its analysis"],
          correctIndex: 1,
          explanation: "Model disagreement is itself disclosed as meaningful information — never averaged away into a false consensus.",
        },
        {
          prompt: "Should you rely only on an AI narration of a company's Filings tab, without reading the real text?",
          options: ["Yes, the narration is always complete", "No — the AI narration is a starting point; the real SEC EDGAR text should be read directly for any decision that matters", "AI narrations replace the need for filings entirely", "Filings are never referenced by AI"],
          correctIndex: 1,
          explanation: "AI explanations narrate the underlying real data — they never substitute for reading the primary source when it matters.",
        },
        {
          prompt: "Which AI surface would you use for a genuinely open-ended research question the fixed coaches don't cover?",
          options: ["The Research coach only", "'Ask the AI Investment Analyst,' the free-form panel", "The Watchlists Engine Coach", "Institutional Mentor"],
          correctIndex: 1,
          explanation: "The Ask panel is the genuinely free-form surface grounded in the full report, built exactly for questions the fixed coaches weren't designed to answer.",
        },
        {
          prompt: "Does any AI surface on the Value Research page produce a buy or sell recommendation?",
          options: ["Yes, the Ask panel gives direct buy/sell instructions", "No — the closest thing is the Investment Committee's own consolidated verdict, which still carries the same disclaimer as every other AI response", "Yes, but only for symbols in the original 10-symbol universe", "Only the Valuation coach can recommend a trade"],
          correctIndex: 1,
          explanation: "No AI surface on this platform is built to give a trade instruction — the Investment Committee's verdict is a synthesis of existing analyst votes, not a new recommendation engine, and it too carries the standard disclaimer.",
        },
      ],
    }),
    topic({
      key: "ai-trading-workflow",
      title: "AI Trading Workflow",
      summary: "Market prep, trade planning, risk analysis, and post-trade review — using the platform's real Engine 2 and Engine 3 AI tools end to end.",
      body: [
        "A real AI-assisted trading workflow on this platform spans two genuinely different modules working together: the Institutional Trading AI Coach's fixed, deterministic coaches (Structure, Liquidity, Session, Risk, Trade Plan, Journal, Scenario, Psychology & Discipline, Strategy) for explaining specific already-computed Engine 2 readings, and the unified AI Trade Coach (/ai-trading-coach) for genuinely open-ended questions grounded across BOTH Engine 2's market analysis AND Engine 3's options-income portfolio, scanner, and journal — the broadest single grounding context of any AI feature on the platform.",
        "Market preparation: the Structure, Liquidity, and Session coaches explain a symbol's current Market Structure reading, liquidity band, and active trading session — each a direct narration of an already-computed Engine 2 analysis, never a live prediction of where the market is headed next.",
        "Trade planning and risk analysis: the Trade Plan coach explains a saved trade plan's own recorded details; the Risk coach explains your Trading Risk analysis (position sizing, stop discipline, portfolio budget) computed from your own real `trading_positions` rows — genuinely your own account data, not a generic example.",
        "Options analysis on the options-income side reuses the original AI Coach's (/assistant) Explain Trade mode — one of the 3 genuinely LLM-narrated branches in that dispatcher — which narrates a specific trade candidate's own already-computed Greeks, POP, EV, and Ravish Score.",
        "Trade review and post-trade journaling: the Journal coach explains patterns in your own recorded trading-journal entries, and the Psychology & Discipline coach reports discipline purely as documentation consistency — what percentage of entries recorded a lesson learned, tallied literally from your own already-written fields, never a psychological diagnosis it invented.",
        "The unified AI Trade Coach ties all of this together in one free-form conversation: ask it about a specific symbol's regime and your own portfolio risk in the same question, and it composes both Engine 2's technical read and Engine 3's options-income account context into a single grounded answer — with your full conversation history persisted so you can return to it later.",
      ],
      whyItMatters: "Knowing which coach explains which already-computed reading — and that the unified AI Trade Coach is the one surface that sees both Engine 2 and Engine 3 at once — means you spend less time hunting for the right panel and more time actually reviewing your own trading data.",
      difficulty: "intermediate",
      whyItExists: "The Institutional Trading AI Coach reuses Engine 2's already-tested Market Structure, Liquidity, Regime, and Risk modules with zero new trading signal of its own; the unified AI Trade Coach composes those same modules plus Engine 3's options-income data through the identical `narrateTradeFreeform()` grounding discipline already proven by the earlier, narrower AI Trade Coach — this lesson exists to show the practical difference in scope, not introduce new logic.",
      institutionalThinking: "A professional trader reviews market context, checks their own risk posture, and journals the outcome as three genuinely distinct steps — never one blended judgment. This platform's AI tools deliberately mirror that separation: Structure/Liquidity/Session coaches for context, the Risk coach for your own exposure, and the Journal/Psychology coaches for the review afterward — never one tool claiming to do all three at once.",
      screenWalkthrough: [
        "Trading Research page (/trading-research) — search a symbol, view the real Structure/Multi-Timeframe/Regime/Probability/Liquidity cards, and open the embedded AI Trade Coach question box.",
        "Institutional Trading AI Coach (/trading-ai-coach) — 9 coach tabs, symbol-scoped or account-scoped depending on the coach.",
        "Unified AI Trade Coach — reachable via the docked panel (bell-adjacent launcher) app-wide, or the full page at /ai-trading-coach, with persisted message history.",
        "AI Coach (/assistant), Explain Trade mode — narrates a specific scanner candidate's own computed Greeks/POP/EV/Ravish Score.",
        "Trading Journal (/trading-journal) — the real recorded entries the Journal and Psychology & Discipline coaches read from.",
      ],
      workflowSteps: [
        "Before trading, check the Structure/Liquidity/Session coaches (or the equivalent cards on Trading Research) for the symbol's current read.",
        "Check the Risk coach for your own current position-sizing and portfolio-budget standing before adding a new position.",
        "Use the unified AI Trade Coach for any question spanning both a symbol's technical read and your own account risk at once.",
        "After a trade closes, record it in the Trading Journal so the Journal and Psychology & Discipline coaches have real data to review.",
        "Periodically ask the Psychology & Discipline coach how consistently you've been recording lessons learned — a documentation-habit check, not a psychological profile.",
      ],
      metricsExplained: [
        { term: "Trade Plan Coach", explanation: "Explains a saved trading_trade_plans row's own recorded details — narrates what you already planned, never generates a new plan." },
        { term: "Psychology & Discipline Coach", explanation: "Reports discipline as documentation consistency — the percentage of journal entries with a recorded lesson learned, and win/loss tallies by R-multiple sign — a literal count over your own fields, never an invented diagnosis." },
        { term: "Unified AI Trade Coach's grounding scope", explanation: "The broadest single AI context on the platform: Engine 2's Structure/Multi-Timeframe/Liquidity/Regime/Probability plus your own Trading Risk, and Engine 3's options-income Portfolio/Dashboard/Scanner and recent journal reflections — all in one composed answer." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A full AI-assisted trading review cycle",
          steps: [
            "Before entering a position, you check the Structure and Liquidity coaches for the symbol, then the Risk coach for your current portfolio budget standing.",
            "You use the unified AI Trade Coach to ask a combined question: 'Given this symbol's regime and my current portfolio risk, what should I be watching?'",
            "After the trade closes, you journal it, and later ask the Journal coach what patterns it notices across your recent entries.",
          ],
          note: "Each step used the right tool for that specific stage — market context, your own risk, then post-trade review — never one tool trying to do all three.",
        },
        {
          label: "Average Opportunity",
          title: "Using the Psychology coach honestly",
          steps: [
            "You ask the Psychology & Discipline coach for a read on your recent trading discipline.",
            "It reports that 60% of your last 10 entries recorded a lesson learned — a literal tally, not a judgment about your character.",
            "You use that as a prompt to be more consistent about documentation going forward, not as a verdict on your trading skill.",
          ],
          note: "The coach's own honesty about measuring documentation habits, not psychology, is what makes its output actually trustworthy.",
        },
        {
          label: "Poor Opportunity",
          title: "Expecting a live market prediction from a deterministic coach",
          steps: [
            "A user asks the Structure coach what the symbol's price will do next.",
            "The coach can only explain the already-computed trend/zone reading — it has no mechanism to predict a future move.",
            "The user instead needs to accept the honest, already-computed read as the best available information, or ask the unified AI Trade Coach, which will also honestly decline to forecast.",
          ],
          note: "No AI surface on this platform predicts future prices — every one is explicit about narrating already-computed, historical/current readings only.",
        },
      ],
      commonMistakes: [
        "Confusing the fixed, deterministic Institutional Trading AI Coach with the genuinely LLM-powered, similarly-named AI Trade Coach.",
        "Expecting any coach to predict a future price move — none of them does, by explicit design.",
        "Never recording trades in the Trading Journal, then being surprised the Journal/Psychology coaches have nothing meaningful to say.",
        "Treating the Psychology & Discipline coach's output as a character judgment rather than a literal documentation-consistency tally.",
      ],
      riskWarnings: [
        "Every trading-AI response on this platform is explicitly educational — none of them, including the unified AI Trade Coach's genuinely free-form answers, is an instruction to enter, exit, or size a real position.",
        "A Structure or Regime reading explains the current, already-computed state of a symbol — it is never a prediction of what happens next, no matter how the question is phrased.",
      ],
      bestPractices: [
        "Use the unified AI Trade Coach when your question spans both a symbol's technical read and your own account risk.",
        "Use the fixed coaches for a quick, specific explanation of one already-computed reading.",
        "Journal consistently so the Journal and Psychology coaches have real data to work from.",
        "Never treat any trading-AI response here as an instruction to buy, sell, or enter a position — every one is explicitly educational only.",
      ],
      aiCoachPrompts: [
        "Explain this symbol's current Market Structure reading.",
        "Why is my Portfolio Risk score's Position Sizing component elevated?",
        "What patterns do you notice in my recent Trading Journal entries?",
        "Given this symbol's regime and my current risk, what should I watch?",
      ],
      relatedModuleHrefs: ["/trading-research", "/trading-ai-coach", "/ai-trading-coach", "/trading-journal", "/assistant"],
      relatedGlossaryKeys: ["llm-narration-source", "deterministic-ai-coach", "coach-disclaimer"],
      nextStepKeys: ["ai-portfolio-review"],
      estimatedMinutes: 8,
      knowledgeCheck: [
        {
          prompt: "What does the unified AI Trade Coach ground its answers in that the Institutional Trading AI Coach's fixed coaches do not?",
          options: ["Nothing extra — they're identical", "Both Engine 2's technical analysis AND Engine 3's options-income portfolio/scanner/journal data in one composed context", "Only live market quotes", "A prediction engine"],
          correctIndex: 1,
          explanation: "The unified coach's grounding context spans both engines at once — the broadest single AI context on the platform.",
        },
        {
          prompt: "How does the Psychology & Discipline coach measure discipline?",
          options: ["A proprietary psychological algorithm", "A literal tally of documentation consistency — what % of journal entries recorded a lesson learned", "By analyzing your trading account's P&L directly", "It doesn't measure anything real"],
          correctIndex: 1,
          explanation: "It counts already-recorded fields in your own journal entries — never an invented psychological diagnosis.",
        },
        {
          prompt: "What happens when you ask a Trading AI coach to predict a symbol's future price?",
          options: ["A confident forecast is generated", "An honest explanation that this isn't something any coach on the platform does", "The request silently fails", "It depends which coach you ask"],
          correctIndex: 1,
          explanation: "No AI surface on this platform predicts prices — every one narrates already-computed, historical/current readings only.",
        },
        {
          prompt: "Which AI feature narrates a specific options trade candidate's own Greeks/POP/EV/Ravish Score?",
          options: ["The Institutional Trading AI Coach's Structure coach", "AI Coach's (/assistant) Explain Trade mode", "The Psychology & Discipline coach", "Institutional Mentor"],
          correctIndex: 1,
          explanation: "Explain Trade is one of the 3 genuinely LLM-narrated branches in the /assistant dispatcher, narrating an already-computed trade candidate's own figures.",
        },
        {
          prompt: "Is any trading-AI response on this platform an instruction to enter or size a real position?",
          options: ["Yes, the unified AI Trade Coach can tell you exactly what to trade", "No — every trading-AI response, including the free-form coach, is explicitly educational, never an execution instruction", "Only Risk Coach gives sizing instructions", "Only when Live Trading is enabled"],
          correctIndex: 1,
          explanation: "Every trading-AI surface on this platform is built to explain already-computed figures, never to instruct a real trade — this holds whether the response is genuinely LLM-generated or a deterministic template.",
        },
      ],
    }),
    topic({
      key: "ai-portfolio-review",
      title: "AI Portfolio Review",
      summary: "Health, risk, diversification, and rebalancing guidance — reading your own portfolio through both the Options Income and Institutional Investing AI tools.",
      body: [
        "Portfolio review on this platform genuinely spans two separate accounts and two separate sets of AI tools: your Options Income Engine's real, simulated-trades portfolio (reviewed via the AI Portfolio Analyst and Institutional Mentor), and your Institutional Investing Engine's target-weight Portfolio Construction holdings (reviewed via the Institutional AI Coach's Portfolio coach and Institutional Mentor's own separate portfolio-review sections). Neither AI blends the two into one number — a target-weight stock model and a live options P&L ledger are structurally different things, and this platform's own Institutional Dashboard deliberately shows them side by side rather than combined.",
        "The AI Portfolio Analyst (/portfolio-analyst) is deterministic, not genuine AI — its own header states plainly it is 'NOT an LLM, a chatbot, predictive AI, financial advice, or a trade recommendation engine.' It reports a Portfolio Snapshot (health score, risk rating, buying power, open positions, theta income), reused Institutional Mentor-style observation/explanation/health/summary engines, event-risk overlays, and a trend read over your own historical snapshots — every sentence a disclosed template gated by an already-computed threshold.",
        "Institutional Mentor produces a 9-category Portfolio Scorecard (capital allocation, risk management, diversification, discipline, income generation, position sizing, greeks management, event preparation, portfolio health) for your options-income account, PLUS separate Watchlist, Portfolio, Decision Engine, and Opportunity Discovery review sections reading directly from your Institutional Investing data — the single place on the platform where both accounts' AI reviews sit on one page, even though they're never blended into one score.",
        "Risk review reuses Portfolio Construction's own Risk tab — the Institutional AI Coach's Risk coach and the free-form Investment Analyst panel can both explain a concentration or sector-cap breach, but the underlying 25%/40% hard caps and the force-capped-at-60 overall score are computed identically whether or not you ever open an AI panel.",
        "Rebalancing guidance is always advisory-only — the Rebalancing Engine's own deterministic Coach panel explains rebalancing concepts, never a specific symbol's trade; the actual drift/buy-sell-hold badges come from Portfolio Construction's own already-computed math, narrated but never recomputed by any AI layer.",
        "The Investment Committee workflow — reviewing where Graham, Buffett, and Tom Nash agree or disagree on a specific holding — connects portfolio review back to single-symbol research: the Committee coach and 'Narrate this verdict' both explain the same already-computed consolidated verdict you'd see by opening that symbol's own Value Research report directly.",
      ],
      whyItMatters: "Knowing that portfolio-level AI review genuinely spans two separate accounts, and that every 'AI' summary here — Portfolio Analyst, Institutional Mentor, the Rebalancing Coach — is deterministic and disclosed rather than a live LLM judgment, sets the right level of trust: useful for reading your own numbers quickly, never a second opinion independent of them.",
      difficulty: "intermediate",
      whyItExists: "Institutional Mentor's own portfolio-review sections were built specifically to reuse, not duplicate, the Portfolio Concentration, Stress Test, and Portfolio Dashboard engines' own already-computed scores — the same discipline the AI Portfolio Analyst follows independently for the options-income side. This lesson exists to show how to actually read both together during a real review session.",
      institutionalThinking: "A professional portfolio manager reviews concentration, risk, and income separately, then asks whether the whole portfolio still reflects deliberate intent — never trusting one blended AI-generated score to answer all three questions at once. This platform's own two-accounts, never-blended design mirrors that discipline structurally, not just as a suggestion.",
      screenWalkthrough: [
        "AI Portfolio Analyst (/portfolio-analyst) — Portfolio Snapshot, event-risk overlay, and a historical trend read, for the options-income account.",
        "Institutional Mentor (/institutional-mentor) — the 9-category Portfolio Scorecard plus separate Watchlist/Portfolio/Decision Engine/Opportunity Discovery review sections, spanning both accounts on one page.",
        "Portfolio Construction's Risk tab (/stock-analyst/portfolio-construction) — the real concentration/sector-cap numbers any AI panel narrates but never recomputes.",
        "Institutional AI Coach's Portfolio coach (/institutional-ai-coach) — explains Decision Engine Portfolio Fit and your own Portfolio Construction diversification/risk scores for a specific portfolio.",
        "Rebalancing Engine's deterministic Coach panel (/rebalancing-engine) — concept-level explanations only, never a specific symbol's trade.",
      ],
      workflowSteps: [
        "Open the AI Portfolio Analyst for your options-income account's health/risk snapshot first.",
        "Open Institutional Mentor for the fuller 9-category scorecard, plus your Institutional Investing watchlist/portfolio/decision reviews on the same page.",
        "Check Portfolio Construction's Risk tab directly for any concentration or sector-cap breach, using the Portfolio coach if you want it narrated.",
        "Use the Rebalancing Engine's Coach for concept-level guidance if a drift badge is unclear, understanding it never recommends a specific trade.",
        "For any specific holding's own valuation disagreement, use the Committee coach or 'Narrate this verdict' to connect back to single-symbol research.",
      ],
      metricsExplained: [
        { term: "Portfolio Scorecard (Institutional Mentor)", explanation: "9 graded categories (Excellent/Good/Fair/Poor) reusing already-computed Portfolio Concentration/Stress Test/Dashboard/Journal figures — zero new scoring logic of its own, a genuinely deterministic composition." },
        { term: "Portfolio Snapshot (AI Portfolio Analyst)", explanation: "Health score, risk rating, buying power, open positions, and theta income for the options-income account — a disclosed template gated by already-computed thresholds, never a live LLM judgment." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A full two-account AI-assisted review",
          steps: [
            "You open Institutional Mentor and review both the 9-category options-income scorecard and the separate Investing Portfolio review section on the same page.",
            "You confirm Portfolio Construction's Risk tab shows no concentration/sector-cap breach.",
            "You check the AI Portfolio Analyst's trend read to see whether health/risk has improved or worsened over recent snapshots.",
          ],
          note: "Reviewing both accounts deliberately, on their own separate terms, is more informative than looking for one blended number that doesn't exist by design.",
        },
        {
          label: "Average Opportunity",
          title: "Using the Rebalancing Coach for concept clarity",
          steps: [
            "A drift badge on Portfolio Construction shows 'Sell' for a holding, and you're unsure what that badge actually means.",
            "You open the Rebalancing Engine's Coach panel and ask about the rebalancing_concepts topic.",
            "You get a concept-level explanation of drift and thresholds, but no specific instruction about that particular holding — deciding what to do stays yours.",
          ],
          note: "The coach correctly explains the concept without ever crossing into a symbol-specific recommendation, exactly as its own design promises.",
        },
        {
          label: "Poor Opportunity",
          title: "Expecting a blended net-worth AI summary",
          steps: [
            "A user expects Institutional Mentor to report one combined score across both the options-income account and the Investing portfolios.",
            "No such blended figure exists anywhere on the platform — both accounts' reviews sit on the same page but are deliberately never combined.",
            "The user instead reviews each account's own scorecard/review section separately, as designed.",
          ],
          note: "This platform's own explicit design choice — never blending a target-weight model with a live options ledger — means looking for a single combined AI verdict is looking for something that intentionally doesn't exist.",
        },
      ],
      commonMistakes: [
        "Expecting a single, blended AI score across both the options-income account and the Investing portfolios — this never exists, by design.",
        "Treating the AI Portfolio Analyst or Institutional Mentor as genuine LLM judgment rather than disclosed deterministic templates.",
        "Asking the Rebalancing Coach for a specific trade recommendation, which it structurally cannot provide.",
        "Skipping Portfolio Construction's Risk tab directly and relying only on an AI narration of it.",
      ],
      riskWarnings: [
        "No portfolio-review AI on this platform — the AI Portfolio Analyst, Institutional Mentor, or the Rebalancing Coach — is a portfolio optimisation or trade recommendation engine; each states this explicitly in its own header, and none accepts the kind of live input a real recommendation would require.",
        "A Portfolio Health Score or Overall Risk Rating explanation narrates already-computed figures — always confirm the underlying number on the real Risk/Scorecard tab before acting on an AI's summary of it.",
      ],
      bestPractices: [
        "Review both accounts' own AI summaries separately, understanding they're deliberately never blended.",
        "Use Institutional Mentor as the single page that surfaces both accounts' reviews together, even though the numbers stay distinct.",
        "Check the real Risk tab numbers directly before relying solely on an AI narration of a cap breach.",
        "Use the Committee coach to connect a portfolio-level holding back to its own single-symbol research when reviewing conviction.",
      ],
      aiCoachPrompts: [
        "Explain my Portfolio Health Score.",
        "Why is my Overall Risk Rating elevated?",
        "What does my Institutional Investing portfolio's diversification review show?",
        "Walk me through my Portfolio Scorecard's income generation category.",
      ],
      relatedModuleHrefs: ["/portfolio-analyst", "/institutional-mentor", "/stock-analyst/portfolio-construction", "/rebalancing-engine", "/institutional-ai-coach"],
      relatedGlossaryKeys: ["deterministic-ai-coach", "coach-disclaimer"],
      nextStepKeys: ["ai-understanding-responses"],
      estimatedMinutes: 8,
      knowledgeCheck: [
        {
          prompt: "Does this platform combine your options-income account and your Investing portfolios into one blended AI score?",
          options: ["Yes, always", "No — the two are deliberately never blended, by explicit platform design", "Only in Institutional Mentor", "Only when both accounts are empty"],
          correctIndex: 1,
          explanation: "A target-weight stock model and a live options P&L ledger are structurally different things — this platform never combines them into one number.",
        },
        {
          prompt: "What does the AI Portfolio Analyst's own header state about itself?",
          options: ["It is a genuine LLM", "It is NOT an LLM, chatbot, predictive AI, or trade recommendation engine — every sentence is a disclosed template", "It predicts future portfolio value", "It automatically executes rebalancing trades"],
          correctIndex: 1,
          explanation: "Its self-disclosure uses nearly identical wording to Institutional Mentor's own — both are deterministic, disclosed templates.",
        },
        {
          prompt: "What can the Rebalancing Engine's Coach panel actually explain?",
          options: ["A specific symbol's exact trade recommendation", "Rebalancing concepts only — no function accepts a symbol, position, or live figure as input", "Live market rebalancing predictions", "Automatic execution instructions"],
          correctIndex: 1,
          explanation: "It's concept-level only, structurally incapable of a symbol-specific recommendation since it never accepts that kind of input.",
        },
        {
          prompt: "Where do both your options-income and Investing-portfolio reviews appear together on one page?",
          options: ["The AI Portfolio Analyst", "Institutional Mentor", "The Rebalancing Engine", "AI Coach (/assistant)"],
          correctIndex: 1,
          explanation: "Institutional Mentor is the one page surfacing both accounts' own review sections, even though the underlying numbers stay separate.",
        },
        {
          prompt: "Can the AI Portfolio Analyst or Institutional Mentor optimise your portfolio or place a rebalancing trade for you?",
          options: ["Yes, both can execute trades automatically", "No — neither accepts the kind of live input a real optimisation or execution engine would need, by explicit design", "Only Institutional Mentor can execute trades", "Only when both accounts agree"],
          correctIndex: 1,
          explanation: "Both modules' own header comments state plainly they are not optimisation or trade-recommendation engines — they explain already-computed figures, nothing more.",
        },
      ],
    }),
    topic({
      key: "ai-understanding-responses",
      title: "Understanding AI Responses",
      summary: "Confidence isn't certainty, data has a freshness label, and every response tells you — if you know where to look — whether to trust it as genuine analysis or a fallback template.",
      body: [
        "Every AI response on this platform, genuine LLM or deterministic template, is built around one shared discipline: never fabricate a fact that isn't already computed. That means the honest failure modes look different from what you might expect — an 'unavailable' result, an honest refusal to answer, or a template substituted for a live call are all the system working correctly, not breaking.",
        "Confidence versus certainty: a Decision Engine confidence score, a Tom Nash conviction score, or an Investment Committee agreement signal (unanimous/majority/split) are all real, deterministic figures — but none of them is a probability of a correct outcome. A 'unanimous' committee vote is stronger evidence than a 'split' one, but neither guarantees anything about what actually happens to the stock afterward. Treat every confidence figure as 'how much the available evidence agrees,' never as 'how likely this is to work out.'",
        "Data freshness: every fundamentals-driven report carries an honest SIMULATED or LIVE label, and every narration response carries a `source: \"llm\" | \"template\"` field. A SIMULATED report is deterministically-seeded, not real market data; a `\"template\"` narration is the hand-written fallback used when no LLM key is configured or a live call failed. Neither is a lesser-quality bug to hide — both are honestly labeled so you always know what you're actually looking at.",
        "Missing information: this platform's own convention is to report a genuinely uncomputable figure as `available: false` or `unavailable`, with a stated reason, rather than approximate or guess. Quick Ratio/ROA/Asset Turnover on the Financial Ratios card, Strategic Consistency on Management Quality, and a valuation model with non-positive EPS all follow this exact pattern — an honest gap is more useful than a plausible-looking wrong number.",
        "Human judgement and verification: every coach disclaimer on this platform — three separately-worded but functionally identical constants across the options, investing, and trading engines — says some version of the same thing: this is educational, not a trade or investment recommendation, and a human decision is always required. The single most tightly-guarded case, Management Quality's LLM-narrated dimensions, takes this furthest of all: it has no fallback score at all, because a fabricated number there would be indistinguishable from a genuine signal — verification isn't optional, it's built into the architecture.",
        "Practically: before treating any AI response as decision-relevant, check three things — is this a genuine LLM answer or a template (the `source` field), is the underlying data SIMULATED or LIVE, and does the response itself disclose any missing or unavailable piece rather than silently omitting it. All three are already visible on this platform if you know to look.",
      ],
      whyItMatters: "The gap between 'this is a real, well-evidenced figure' and 'this is a fabricated-sounding but wrong one' is exactly where honest AI-assisted research either helps or actively misleads — this platform's own discipline of labeling data source, narration source, and availability plainly is what makes trusting it, appropriately, actually possible.",
      difficulty: "intermediate",
      whyItExists: "This lesson exists because every other lesson in this Academy assumes you already know how to read a confidence score, a data-source badge, and an `unavailable` result correctly — this is the one place that discipline is taught directly, rather than assumed.",
      institutionalThinking: "A professional risk manager treats 'high confidence' and 'guaranteed outcome' as two entirely different claims, and never conflates them — the same discipline this platform's own honest-labeling convention is built to support. Verification isn't a courtesy step at the end of a workflow; it's the default posture toward any single figure, AI-narrated or not.",
      screenWalkthrough: [
        "Data-source badges — SIMULATED/LIVE labels appear throughout the Value Research page, Statements/Peers/Filings/Earnings tabs, and Trading Research's own cards.",
        "`source`/`narrativeSource`/`answerSource` fields — carried on every narration API response, surfaced in the UI wherever a narration button exists ('llm' vs 'template').",
        "Honest `unavailable`/`available: false` results — Financial Ratios' Quick Ratio/ROA/Asset Turnover, Management Quality's Strategic Consistency and (conditionally) its 2 LLM-narrated dimensions, valuation models on non-positive-EPS companies.",
        "Agreement/confidence signals — Investment Committee's unanimous/majority/split, Tom Nash's conviction score, the Decision Engine's confidence score — all deterministic, all disclosed as evidence-strength, never outcome probability.",
      ],
      workflowSteps: [
        "Before acting on any figure, check its data-source label — SIMULATED or LIVE.",
        "Before trusting a narration's prose, check whether it came from a genuine LLM call or the deterministic template fallback.",
        "Read an honest 'unavailable' result as real information about a genuine data gap, never as a bug to route around.",
        "Treat every confidence/agreement/conviction score as evidence strength, never as a guarantee of outcome.",
        "For the platform's most safety-critical AI dimension (Management Quality's Communication Quality/Long-Term Focus), expect and accept an honest 'unavailable' more often than you might for other figures — that's the design working as intended.",
      ],
      metricsExplained: [
        { term: "Confidence Score", explanation: "A deterministic measure of how much the available, already-computed evidence agrees — never a probability of a correct real-world outcome." },
        { term: "SIMULATED vs. LIVE", explanation: "The honest label distinguishing deterministically-seeded platform data from real provider-sourced (FMP/Alpha Vantage) data — always disclosed, never hidden." },
        { term: "source: \"llm\" | \"template\"", explanation: "The field distinguishing genuine LLM-generated prose from the hand-written deterministic fallback used when the LLM is unavailable — carried on every narration response across the platform." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Correctly reading a strong, well-evidenced signal",
          steps: [
            "A stock shows a 'unanimous' Investment Committee agreement, high Tom Nash conviction, and a LIVE data-source label.",
            "You correctly interpret this as strong, well-evidenced agreement among independent methods — not a guarantee of a good outcome.",
            "You still read the underlying Filings tab directly before treating this as settled research.",
          ],
          note: "Strong agreement across genuinely independent, disclosed evidence is the most trustworthy pattern this platform can produce — and it's still not certainty.",
        },
        {
          label: "Average Opportunity",
          title: "Reading a template-fallback narration correctly",
          steps: [
            "You click 'Narrate this verdict' and the response carries `narrativeSource: \"template\"`.",
            "You recognize this is the deterministic fallback text, byte-identical to the report's own already-computed reasoning, not a fabricated LLM guess.",
            "You treat the content as reliable (it's the same real deterministic reasoning either way) while noting the prose itself wasn't freshly LLM-composed this time.",
          ],
          note: "A template fallback is never lower-quality data — it's the exact same deterministic facts, just without the LLM's own additional phrasing.",
        },
        {
          label: "Poor Opportunity",
          title: "Misreading an honest unavailable result as a system failure",
          steps: [
            "A user sees Management Quality's Communication Quality dimension reported as unavailable and assumes the feature is broken.",
            "In reality, this is the platform's own strictest honesty guarantee — no fallback score exists specifically so a fabricated number can never masquerade as a real signal.",
            "The correct read is that this particular filing/LLM call didn't produce a result that passed the platform's own safety guard — an honest gap, not a bug.",
          ],
          note: "The dimension with the fewest guarantees (no template fallback) is deliberately the platform's most cautious one — 'unavailable' there is the system doing exactly what it was built to do.",
        },
      ],
      commonMistakes: [
        "Conflating a high confidence/conviction score with a guaranteed good outcome.",
        "Treating a `source: \"template\"` narration as lower-quality or wrong, rather than the same deterministic facts in fixed prose.",
        "Assuming an honest `unavailable` result means the feature is broken, rather than the platform's own honesty discipline working correctly.",
        "Skipping the SIMULATED/LIVE data-source label entirely when deciding how much weight to put on a figure.",
      ],
      riskWarnings: [
        "A high confidence, conviction, or agreement score is still not a guarantee of any real-world outcome — every one of these figures measures how strongly already-computed evidence agrees, never the probability that a stock, trade, or portfolio decision works out.",
        "SIMULATED data is deterministically generated for demonstration, never a real market quote — never treat a SIMULATED-labeled figure as if it were live, provider-sourced data, regardless of how plausible it looks.",
      ],
      bestPractices: [
        "Always check the data-source and narration-source labels before treating a figure as decision-relevant.",
        "Read confidence/agreement scores as evidence strength, never as outcome probability.",
        "Treat every honest `unavailable` result as real information, worth investigating why, not a defect.",
        "Apply extra scrutiny expectation to the platform's most safety-critical dimensions (Management Quality's 2 LLM-narrated fields) — honest gaps there are more common by design, not less trustworthy.",
      ],
      aiCoachPrompts: [
        "Is this report SIMULATED or LIVE data?",
        "Was this narration genuinely LLM-generated or the template fallback?",
        "Why is this valuation model showing unavailable?",
        "What does a 'majority' committee agreement actually tell me, versus 'unanimous'?",
      ],
      relatedModuleHrefs: ["/stock-analyst", "/institutional-ai-coach", "/institutional-mentor"],
      relatedGlossaryKeys: ["llm-narration-source", "deterministic-ai-coach", "coach-disclaimer"],
      nextStepKeys: [],
      estimatedMinutes: 7,
      knowledgeCheck: [
        {
          prompt: "What does a 'unanimous' Investment Committee agreement signal actually guarantee?",
          options: ["A correct outcome for the stock", "Nothing about outcome — only that the evidence available agrees strongly, which is stronger evidence than a split signal", "That the data is LIVE, not SIMULATED", "That the LLM narration succeeded"],
          correctIndex: 1,
          explanation: "Confidence and agreement signals measure evidence strength, never a guarantee of what will actually happen.",
        },
        {
          prompt: "What does a `source: \"template\"` field mean about the underlying facts?",
          options: ["The facts are less reliable than an LLM response", "The facts are the same real, deterministic data — only the prose wasn't freshly LLM-composed for this call", "The response is fabricated", "The feature is broken"],
          correctIndex: 1,
          explanation: "A template fallback carries the exact same deterministic reasoning — it's a different narration path, not lower-quality data.",
        },
        {
          prompt: "Why does Management Quality's Communication Quality dimension have no fallback score?",
          options: ["It was never finished", "A fabricated number there would be indistinguishable from a genuine signal, so honest unavailability is the platform's strictest safety guarantee", "Fallback scores are too expensive to compute", "It's a bug"],
          correctIndex: 1,
          explanation: "This is the platform's most deliberate safety design — no template exists specifically so a wrong-but-plausible number can never appear.",
        },
        {
          prompt: "What should you check before treating any platform figure as decision-relevant?",
          options: ["Nothing — all figures are equally reliable", "Its data-source label (SIMULATED/LIVE) and, for narrations, whether the source was genuine LLM output or a template", "Only whether it's a whole number", "Only the page's color scheme"],
          correctIndex: 1,
          explanation: "Both labels are honestly disclosed throughout the platform specifically so you can make this exact judgment before relying on a figure.",
        },
        {
          prompt: "Does a high Investment Committee confidence score mean a trade or investment is likely to succeed?",
          options: ["Yes, high confidence means a likely good outcome", "No — confidence measures how strongly the available evidence agrees, never a probability of real-world success", "Only for LIVE data, not SIMULATED", "Confidence scores don't exist on this platform"],
          correctIndex: 1,
          explanation: "This is the single most important distinction in this lesson — evidence strength and outcome probability are two different claims, and this platform's figures only ever measure the former.",
        },
      ],
    }),
  ],
...
// v1.4.0, Sprint L2K — Professional Institutional Workflows Academy. A new,
// 15th Learning Path, deliberately cross-engine — like AI_ACADEMY_PATH
// (Sprint L2J), this teaches how a professional actually WORKS the
// platform across a full trading/investing cycle, never a single engine's
// own vocabulary. `glossaryCategory: "platform"` matches that precedent.
// Every lesson composes already-taught concepts from the engine-specific
// paths above (cross-referenced via relatedModuleHrefs/nextStepKeys, never
// duplicated) into one coherent, real, source-confirmed workflow.
const PROFESSIONAL_WORKFLOWS_PATH: LearningPath = {
  key: "professional-workflows",
  title: "Professional Institutional Workflows Academy",
  description: "How professional traders, portfolio managers, and investment analysts actually use this platform across a full daily, weekly, and monthly cycle — real workflows over real, already-taught platform features, never a new capability of its own.",
  glossaryCategory: "platform",
  topics: [
    topic({
      key: "workflow-morning-preparation",
      title: "Morning Market Preparation",
      summary: "Five real dashboards, three independent (never-merged) regime reads, and one honest gap: this platform has no news feed at all.",
      body: [
        "This platform has no single canonical 'start of day' screen — it has 5 deliberately separate dashboards, each documented in its own source as distinct: Home (/, the real default landing page — a personal, pinnable/reorderable widget dashboard), Command Center (/command-center, the fuller executive view), Institutional Dashboard (/institutional-dashboard, Trading Engine's per-symbol view), Executive Dashboard (/stock-analyst/executive-dashboard, Investing Engine's own consolidated view), and the original Options Dashboard (/options-dashboard). A professional morning routine picks the one or two that match the day's actual focus rather than expecting one page to show everything.",
        "Three independent 'market regime' reads exist, and none of them is a live feed: the AI Market Briefing (Portfolio AI, /portfolio-ai — a deterministic synthetic-VIX/IV-rank/breadth read, genuinely narrated by a real LLM call via streamed prose), the Investing Macro Context (/stock-analyst's own macro panel — explicitly self-labeled SIMULATED, a deterministic rising/falling/stable-rates proxy, its own source comment stating plainly no real macro feed is wired anywhere in this codebase), and the Trading Regime (Engine 2 — genuinely derived from real price-action, trend + liquidity + realized volatility). Home's own 'AI Portfolio Briefing' widget is worth reading precisely: it actually surfaces the Cross-Engine Daily Report's summary text, not the Portfolio AI Market Briefing itself — a small but real distinction.",
        "Command Center and Institutional Dashboard both show a 'Cross-Engine Verdict' (Engine 1's Investment Committee next to Engine 2's Market Regime) and a 'Macro/Regime Side-by-Side' section (all three regime reads shown together) — genuinely useful for a morning scan, but both sections are explicit, disclosed **display juxtapositions only**: nothing here averages, blends, or reconciles the three reads into one number.",
        "Watchlist preparation is real on the Investing side — the flat Value Watchlist (StockResearch.tsx's Watchlist tab) and the fuller, named Watchlists Engine (/watchlists-engine, tagged/manually-ordered lists) — but the Trading Engine has no watchlist concept at all, confirmed by direct inspection finding zero matches for 'watchlist' anywhere in its pages.",
        "News review does not exist on this platform in any form — no news API, no RSS feed, no headline list, confirmed by a direct, broad source search. A morning routine cannot include 'read the news feed' here; that step has to happen outside the platform. Market Structure review is genuinely real and thorough: /trading-research's own Structure card, and the deeper /market-structure-workbench, which documents its own real step sequence (Select Instrument → Select Timeframe → Review Current Structure → Inspect Swing Sequence → Compare Timeframes → Review Support/Resistance → Review Session Context → Record Notes). 'Session planning,' by contrast, is only a narrow, read-only panel (which of the 4 global sessions — Sydney/Tokyo/London/New York — is currently active, embedded only inside the Liquidity Workbench) — there is no dedicated 'plan today's session' page or goal-setting feature.",
      ],
      whyItMatters: "Knowing exactly which of this platform's real features cover morning preparation — and which honestly don't (news) — prevents both wasted time hunting for a feature that doesn't exist, and the mistake of treating a display juxtaposition as one combined signal.",
      difficulty: "beginner",
      whyItExists: "Every screen and figure in this workflow reuses an already-shipped, already-tested hook or engine — Home/Command Center/Institutional Dashboard/Executive Dashboard are pure composition layers with zero new calculations of their own, and this lesson's only job is sequencing them into one coherent morning routine.",
      institutionalThinking: "A professional's morning routine is a disciplined sequence through a fixed set of real inputs, not a search for one dashboard that shows everything — and knowing which inputs are genuinely independent (three separate regime reads) versus genuinely absent (news) is itself a risk-management habit, since assuming a feature exists when it doesn't is its own kind of blind spot.",
      screenWalkthrough: [
        "Home (/) — your personal widget dashboard: Portfolio Health, Market Status, Open Positions, Today's P/L, AI Portfolio Briefing, Institutional Mentor Summary, Watchlist summary, Notifications, Quick Actions.",
        "Command Center (/command-center) / Institutional Dashboard (/institutional-dashboard) — the fuller executive views, including the Cross-Engine Verdict and Macro/Regime Side-by-Side sections.",
        "Portfolio AI (/portfolio-ai) — the AI Market Briefing card, genuinely streamed LLM prose over deterministic inputs.",
        "Trading Research (/trading-research) or Market Structure Workbench (/market-structure-workbench) — real Structure/Multi-Timeframe/Regime/Liquidity/Probability cards.",
        "Stock Research's Watchlist tab (/stock-analyst) or the Watchlists Engine (/watchlists-engine) — reviewing or adding to your prepared symbol list.",
      ],
      workflowSteps: [
        "Open Home for the personal, at-a-glance headline numbers across both accounts.",
        "Read the AI Market Briefing on Portfolio AI for genuinely narrated context on the day's broader market backdrop.",
        "Cross-check the Investing Macro Context and Trading Regime reads if your day involves both engines — remembering all three are independent, never blended.",
        "Review your prepared watchlist(s) for symbols worth a closer look today.",
        "Open Market Structure Workbench (or the Structure card on Trading Research) for a real technical read on your priority symbols.",
        "Accept, explicitly, that there is no in-platform news step — source any overnight headlines elsewhere before starting research.",
      ],
      metricsExplained: [
        { term: "3 independent regime reads", explanation: "Portfolio AI's Market Briefing (Options, real LLM narration over deterministic inputs), the Investing Macro Context (explicitly SIMULATED), and the Trading Regime (Engine 2, real price-action-derived) — never merged into one score, always shown separately even when displayed side by side." },
        { term: "Cross-Engine Verdict / Macro Side-by-Side", explanation: "Display sections on Command Center/Institutional Dashboard pairing Engine 1's and Engine 2's own already-computed reads for the same symbol or the same day — a juxtaposition for your own judgment, never an algorithmic combination." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A disciplined, honest morning sequence",
          steps: [
            "You open Home for the headline numbers, then Portfolio AI's Market Briefing for narrated context.",
            "You check your Investing watchlist and the Trading Regime read for your priority symbols separately, keeping the three regime signals mentally distinct rather than averaging them yourself.",
            "You accept there's no in-platform news feed and check headlines elsewhere before starting deeper research.",
          ],
          note: "Using every real feature for exactly what it is — and consciously filling the one real gap from outside the platform — is the accurate, professional routine.",
        },
        {
          label: "Average Opportunity",
          title: "Treating the Macro/Regime Side-by-Side as one combined signal",
          steps: [
            "You open the Macro/Regime Side-by-Side section and read the three regime badges as if they were meant to average into a single verdict.",
            "You realize, on closer reading, that the section's own design is explicit about never merging them — you go back and weigh each source independently instead.",
          ],
          note: "The information itself was correct; the mistake was in how it was combined, not in what the platform showed.",
        },
        {
          label: "Poor Opportunity",
          title: "Searching for a news feed that doesn't exist",
          steps: [
            "A user spends several minutes looking through Home, Command Center, and Portfolio AI for a headline or news panel.",
            "None exists anywhere on the platform — this is a confirmed, honest gap, not a hidden feature waiting to be found.",
          ],
          note: "Knowing in advance that news review is not a platform feature saves real time versus discovering the gap by searching.",
        },
      ],
      commonMistakes: [
        "Expecting one dashboard to show everything, rather than picking the 1-2 real dashboards that match the day's actual focus.",
        "Treating the Macro/Regime Side-by-Side or Cross-Engine Verdict sections as a combined, averaged signal rather than three/two genuinely independent reads.",
        "Confusing Home's 'AI Portfolio Briefing' widget (which shows the Cross-Engine Daily Report) with Portfolio AI's own Market Briefing card — related, but not the same data.",
        "Looking for a news feed or session-planning workspace that don't exist on this platform in any form.",
      ],
      riskWarnings: [
        "Every regime/briefing read described here is either explicitly SIMULATED or, where genuinely real, still a derived signal — none is a substitute for your own independent market awareness, especially given the confirmed absence of any real news feed.",
        "Treating a display-only juxtaposition (Cross-Engine Verdict, Macro/Regime Side-by-Side) as a single combined recommendation risks over-trusting agreement that was never actually computed as agreement.",
      ],
      bestPractices: [
        "Pick the dashboard(s) that match today's actual focus rather than defaulting to the same one every day.",
        "Read each of the 3 independent regime signals for what it is, on its own terms, before forming an overall market view.",
        "Prepare your watchlist(s) before diving into research, using the flat Value Watchlist for quick adds and the named Watchlists Engine for organized, tagged lists.",
        "Build a personal habit for the one real gap (news) outside the platform, since no in-app step will ever fill it.",
      ],
      aiCoachPrompts: [
        "Explain today's Market Briefing regime read.",
        "What does the Trading Regime say about this symbol right now?",
        "Institutional Mentor: what does my portfolio's Health Score look like at the start of the day?",
        "Ask the Institutional AI Coach's Investment coach to summarize this symbol before I add it to my watchlist.",
      ],
      relatedModuleHrefs: ["/", "/command-center", "/institutional-dashboard", "/stock-analyst/executive-dashboard", "/portfolio-ai", "/trading-research", "/market-structure-workbench", "/watchlists-engine"],
      relatedGlossaryKeys: ["simulated-vs-live", "llm-narration-source", "market-structure"],
      nextStepKeys: ["workflow-research"],
      estimatedMinutes: 9,
      knowledgeCheck: [
        {
          prompt: "How many genuinely separate 'start of day' dashboards does this platform have?",
          options: ["1", "2", "5", "10"],
          correctIndex: 2,
          explanation: "Home, Command Center, Institutional Dashboard, Executive Dashboard, and the original Options Dashboard — 5 deliberately separate, never-merged pages.",
        },
        {
          prompt: "Are the platform's 3 independent market-regime reads ever combined into one score?",
          options: ["Yes, always", "No — even where shown side by side, they remain 3 independent reads, never algorithmically merged", "Only on Fridays", "Only for LIVE data"],
          correctIndex: 1,
          explanation: "The Cross-Engine Verdict and Macro/Regime Side-by-Side sections are explicit display juxtapositions, never a combined calculation.",
        },
        {
          prompt: "Does this platform have a real news-review feature?",
          options: ["Yes, a full RSS feed", "Yes, but only for LIVE mode", "No — confirmed absent anywhere in the codebase", "Only on the Options Dashboard"],
          correctIndex: 2,
          explanation: "A direct, broad source search confirms zero news-fetching feature exists anywhere on this platform.",
        },
        {
          prompt: "What does Home's 'AI Portfolio Briefing' widget actually show?",
          options: ["Portfolio AI's own Market Briefing card, word for word", "The Cross-Engine Daily Report's summary text", "A live news feed", "Nothing — it's a placeholder"],
          correctIndex: 1,
          explanation: "A precise, real distinction: the widget surfaces the Cross-Engine Daily Report, not the separate Portfolio AI Market Briefing feature.",
        },
        {
          prompt: "Does the Trading Engine have its own watchlist feature?",
          options: ["Yes, identical to the Investing Engine's", "No — confirmed absent from Trading Research and the Scanner", "Only for options symbols", "Only in Live Trading mode"],
          correctIndex: 1,
          explanation: "A direct source search found zero watchlist concept anywhere on the Trading Engine's own pages.",
        },
      ],
    }),
    topic({
      key: "workflow-research",
      title: "Research Workflow",
      summary: "From selecting a company to recording your own investment idea — real screens, real AI touchpoints, one honest boundary on 'technical confirmation.'",
      body: [
        "Selecting companies to research starts in one of three real places: Opportunity Discovery (/opportunity-discovery, an advisory-only screener that never previews, schedules, or submits an order), the Value Research symbol search itself (/stock-analyst), or the Investing Engine's own Stock Scanner (/stock-analyst/scanner, distinct from the options-side Scanner). Saved screens on Opportunity Discovery persist as a genuinely real feature — create, list, delete.",
        "Fundamental research happens on the Value Research report, and it is genuinely deep: Business Quality, Investment Quality, Competitive Advantage, Financial Strength, Financial Ratios, 4 named valuation models plus a Consolidated Margin of Safety, Tom Nash's own conviction pillars, and the Investment Committee's consolidated vote — all real, populated sections, plus on-demand Statements/Peers/Filings/Earnings tabs.",
        "'Technical confirmation' is real, but narrower than it might sound: Command Center and Institutional Dashboard's Cross-Engine Verdict section shows Engine 1's Investment Committee verdict directly next to Engine 2's Market Regime read for the same symbol — a genuine, useful juxtaposition, but its own design is explicit that nothing here merges the two into a new combined signal. Treat it as 'read both, then judge for yourself,' not 'the platform confirms this fundamentally-attractive stock is also technically attractive.'",
        "AI-assisted research draws on the same touchpoints the AI Academy already taught in depth: the Institutional AI Coach's Research and Valuation coaches (deterministic, explaining already-computed figures), 'Ask the AI Investment Analyst' (genuinely free-form, grounded in the full report), and 'Narrate this verdict' (a narrow LLM button explaining only the Investment Committee's own reached verdict).",
        "Comparing opportunities uses the Research Terminal's real Compare mode (N-symbol side-by-side, /research-terminal) and Split-screen mode, plus the Value Research page's own Peers/Industry Comparison tab. Recording an investment idea has 4 real, distinct places: Research Notes (persisted per symbol, reused identically on both the Value Research page and the Research Terminal), the Investment Committee Workbench's own Memo Viewer (/stock-analyst/investment-committee — a templated, deterministic writeup of already-computed report fields, explicitly zero LLM calls despite the word 'memo'), Portfolio Construction's Notes tab, and Decision Engine notes tied to a decision snapshot.",
      ],
      whyItMatters: "A research session that moves through selection, deep fundamental reading, an honest (not overstated) technical cross-check, targeted AI assistance, comparison, and a genuinely recorded idea produces a real, revisitable research trail — rather than a scattered set of tab visits with nothing captured at the end.",
      difficulty: "intermediate",
      whyItExists: "Every step here reuses an already-shipped Investing Engine module with zero new scoring logic — this lesson's only job is sequencing Opportunity Discovery, the Value Research report, the AI Coach/Ask panel, Research Terminal, and the 4 note-recording surfaces into one coherent workflow, and correcting the common overstatement of what the Cross-Engine Verdict actually does.",
      institutionalThinking: "A professional analyst treats a fundamentally-strong read and a technically-favorable read as two separate, genuinely independent pieces of evidence to weigh together themselves — never as something a tool has already reconciled for them — and always closes a research session by writing something down, since an unrecorded conclusion is effectively lost the next time the symbol comes up.",
      screenWalkthrough: [
        "Opportunity Discovery (/opportunity-discovery) — run a scan, save a screen for reuse.",
        "Value Research (/stock-analyst) — search a symbol, read the full report top to bottom, open Statements/Peers/Filings/Earnings as needed.",
        "Command Center / Institutional Dashboard — the Cross-Engine Verdict section for a side-by-side (never merged) fundamental + technical read.",
        "Institutional AI Coach (/institutional-ai-coach) — Research and Valuation coaches for a plain-language walkthrough.",
        "'Ask the AI Investment Analyst' and 'Narrate this verdict' — on the Value Research page itself.",
        "Research Terminal (/research-terminal) — Compare or Split-screen mode for multiple symbols at once.",
        "Research Notes, Investment Committee Workbench's Memo Viewer, Portfolio Construction Notes, Decision Engine notes — 4 real places to record what you concluded.",
      ],
      workflowSteps: [
        "Select candidates via Opportunity Discovery, a saved screen, or a direct symbol search.",
        "Read the full Value Research report for your top candidates.",
        "Check the Cross-Engine Verdict section for a technical cross-check, treating it as two independent reads, not one combined answer.",
        "Use the Research/Valuation coaches or 'Ask the AI Investment Analyst' for anything the report itself didn't make clear.",
        "Use Research Terminal's Compare mode to weigh your finalists side by side.",
        "Record your conclusion in Research Notes, the Investment Memo, or a Decision Engine note before moving on.",
      ],
      metricsExplained: [
        { term: "Cross-Engine Verdict", explanation: "Engine 1's Investment Committee verdict shown directly next to Engine 2's Market Regime for the same symbol — a real, useful juxtaposition, explicitly never algorithmically combined into a new score." },
        { term: "Investment Memo (Committee Workbench)", explanation: "A deterministic, templated writeup composing already-computed report fields — genuinely zero LLM calls, despite the word 'memo' sounding like AI-authored prose." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "A complete, recorded research session",
          steps: [
            "You select a candidate via a saved Opportunity Discovery screen, read its full Value Research report, and check the Cross-Engine Verdict for both a fundamental and a technical read.",
            "You use 'Ask the AI Investment Analyst' for one specific open question the report didn't cover.",
            "You record your conclusion in Research Notes before moving to the next candidate.",
          ],
          note: "Every step used a real feature for exactly what it does, and the session ends with something genuinely captured.",
        },
        {
          label: "Average Opportunity",
          title: "Overstating what the Cross-Engine Verdict confirms",
          steps: [
            "You see the Investment Committee verdict and the Market Regime read agree, and treat this as the platform having 'confirmed' the opportunity.",
            "On reflection, you recognize the section only ever juxtaposes two independent reads — the agreement is real information, but it wasn't computed as a combined confirmation.",
          ],
          note: "The underlying data was genuinely useful; the risk was in reading more into the pairing than the platform's own design claims.",
        },
        {
          label: "Poor Opportunity",
          title: "Researching a stock and recording nothing",
          steps: [
            "A user reads a full Value Research report, checks a few coaches, and moves on without touching Research Notes, the Memo, or any other recording surface.",
            "The next time the symbol comes up, none of that reasoning is retrievable.",
          ],
          note: "This platform gives 4 real places to record an idea — using none of them turns a real research session into a wasted one.",
        },
      ],
      commonMistakes: [
        "Treating the Cross-Engine Verdict as a single combined signal rather than two independently-computed reads shown together.",
        "Confusing the Investment Committee Workbench's 'Memo' with an LLM-authored document — it's a deterministic template, zero LLM calls.",
        "Using only the Value Research page's own Peers tab and never opening Research Terminal's fuller Compare/Split modes when weighing multiple finalists.",
        "Finishing a research session without recording a conclusion anywhere.",
      ],
      riskWarnings: [
        "Every AI touchpoint in this workflow narrates or explains already-computed figures — none of them, including 'Ask the AI Investment Analyst,' produces a buy/sell recommendation.",
        "The Cross-Engine Verdict's agreement or disagreement is information to weigh yourself, never a computed confirmation that should replace your own judgment.",
      ],
      bestPractices: [
        "Save reusable Opportunity Discovery screens rather than rebuilding the same scan from scratch each time.",
        "Read the Cross-Engine Verdict's two reads independently before forming a combined view yourself.",
        "Use Research Terminal's Compare mode whenever you're actually choosing between multiple real finalists, not just researching one symbol.",
        "Pick one of the 4 real recording surfaces and use it consistently, rather than switching between them without a habit.",
      ],
      aiCoachPrompts: [
        "Explain this company's Business Quality score.",
        "Why do Graham and Buffett disagree on this stock's valuation?",
        "Summarize the Cross-Engine Verdict for this symbol — what does each engine actually say?",
        "Institutional Mentor: how does this symbol fit my current portfolio?",
      ],
      relatedModuleHrefs: ["/opportunity-discovery", "/stock-analyst", "/stock-analyst/scanner", "/institutional-ai-coach", "/research-terminal", "/stock-analyst/investment-committee"],
      relatedGlossaryKeys: ["deterministic-ai-coach", "llm-narration-source"],
      nextStepKeys: ["workflow-professional-trade"],
      estimatedMinutes: 10,
      knowledgeCheck: [
        {
          prompt: "What does the Cross-Engine Verdict section actually do?",
          options: ["Combines Engine 1 and Engine 2's reads into one new score", "Shows Engine 1's Investment Committee verdict next to Engine 2's Market Regime, never merged", "Only shows Engine 1's data", "Predicts a future price move"],
          correctIndex: 1,
          explanation: "It's an explicit, disclosed display juxtaposition — the two engines' reads stay independent, always.",
        },
        {
          prompt: "Does the Investment Committee Workbench's 'Memo' feature involve any real LLM call?",
          options: ["Yes, it's fully AI-generated", "No — it's a deterministic, templated composition of already-computed report fields", "Only for symbols outside the original 10-symbol universe", "Only in Live mode"],
          correctIndex: 1,
          explanation: "Its own source header is explicit: zero LLM calls, zero new scoring logic — pure, deterministic template composition.",
        },
        {
          prompt: "Which of these is NOT a real place to record an investment idea on this platform?",
          options: ["Research Notes", "The Investment Committee Workbench's Memo Viewer", "A dedicated 'Investment Ideas' inbox page", "Decision Engine notes"],
          correctIndex: 2,
          explanation: "No such dedicated inbox page exists — the 4 real recording surfaces are Research Notes, the Memo Viewer, Portfolio Construction Notes, and Decision Engine notes.",
        },
        {
          prompt: "Where would you compare 3 finalist symbols side by side after narrowing down your research?",
          options: ["The Value Research page's own single-symbol view only", "Research Terminal's Compare or Split-screen mode", "There is no way to compare more than one symbol at a time", "Opportunity Discovery only shows one result at a time"],
          correctIndex: 1,
          explanation: "Research Terminal (/research-terminal) has a real, dedicated N-symbol Compare mode plus a Split-screen mode.",
        },
        {
          prompt: "What is 'Ask the AI Investment Analyst' built to do?",
          options: ["Give a buy/sell recommendation", "Answer genuinely open-ended questions, grounded in the full Value Research report", "Automatically fill in Research Notes for you", "Compare two different symbols automatically"],
          correctIndex: 1,
          explanation: "It's a real, free-form question box grounded in the full report — never a recommendation engine.",
        },
      ],
    }),
    topic({
      key: "workflow-professional-trade",
      title: "Professional Trade Workflow",
      summary: "Market analysis to post-trade review, end to end — and one thing every step of this workflow guarantees: no order here ever reaches a real market.",
      body: [
        "Market analysis starts on Trading Research (/trading-research), which composes real Structure, Multi-Timeframe, Regime, Liquidity, and Probability cards for a searched symbol — every one of these already covered in depth in the Trading Engine's own Learning Path; this workflow's job is sequencing them into a repeatable pre-trade routine, not re-teaching the math.",
        "Opportunity identification is the Scanner's job (/scanner) — its results carry a real Ravish Score, genuinely used as a hard execution gate: AutoPilot's automated cycle rejects any candidate scoring below the platform's configured floor before it's ever eligible for auto-execution. The separate Scoring leaderboard (/scoring) shows the same underlying score ranked across symbols.",
        "Risk evaluation happens before a ticket is ever built: Position Sizing (/position-sizing), Order Preview (/order-preview), and Portfolio Stress Test (/stress-test) are all real, pre-trade what-if tools — none of them contacts a broker or submits anything.",
        "Strategy selection has one genuinely important nuance: the Strategy Academy and Strategy Library teach 9 named strategies (covered call, cash-secured put, wheel, vertical spreads, iron condor, iron fly, calendar, diagonal), but the real, live scanner/execution engine only actually builds and prices **4** of them — iron condor, iron fly, calendar spread, and earnings plays. The Strategy Framework and Strategy Workbench pages are a separate, Trading-Engine-specific tool for authoring your own general trading methodology (trend/reversal/breakout/etc.) — they are not where you pick an options strategy for a real trade; that happens via the Scanner's own strategy filter.",
        "Trade execution runs through the Trade Ticket (with a real Pre-Trade Risk Validation section) or the fully guided Trade Execution Center (/trade-execution-center, Scanner → AI Score → Strategy → Order Preview → Risk Review → Confirm → Submission → Monitor). This platform's broker integration is hardcoded to Alpaca's paper-trading API endpoint — there is no live-trading path anywhere in this codebase, by unconditional design.",
        "Position monitoring uses two genuinely separate decision logs: AutoPilot's own log (/autopilot, entry decisions) and the Adjustments page's Auto-Adjustment log (/adjustments, exit/adjustment decisions) — plus Portfolio AI's real, always-on 'Position Threat Radar' section. Post-trade review closes the loop through 3 distinct journal systems (the options-side Journal, the Trading Engine's own Trading Journal, and the deterministic behavioral-analysis AI Trade Journal) and Trade History/Trade Performance's own real, local-data-only figures.",
      ],
      whyItMatters: "Following the real sequence — analysis, scoring, risk-checking, strategy selection matched to what actually trades, paper-only execution, dual-log monitoring, and a genuine post-trade write-up — turns 7 separate features into one repeatable professional discipline, and knowing the 9-vs-4 strategy gap and the paper-only broker boundary in advance prevents two real, easy misunderstandings.",
      difficulty: "advanced",
      whyItExists: "Every step of this workflow is an already-shipped, already-tested Trading/Options Engine feature — Scanner, Position Sizing, Order Preview, Stress Test, the Trade Ticket, AutoPilot, Adjustments, and the 3 journal systems all predate this lesson; the only genuinely new thing here is the sequencing and the two disclosed nuances (the real 4-strategy execution set, and Alpaca's paper-only endpoint) that a workflow-level view makes newly important to state clearly.",
      institutionalThinking: "A professional trader's process is a fixed sequence they run every time, not an improvised path through whichever screen is open — and knowing precisely which of a platform's advertised capabilities are real trading capacity (4 strategies, paper execution only) versus educational catalog (9 named strategies) is exactly the kind of due diligence that prevents a costly false assumption.",
      screenWalkthrough: [
        "Trading Research (/trading-research) — Structure/Multi-Timeframe/Regime/Liquidity/Probability cards for pre-trade analysis.",
        "Scanner (/scanner) — real results carrying a genuine Ravish Score; Scoring leaderboard (/scoring) for a ranked cross-symbol view.",
        "Position Sizing (/position-sizing), Order Preview (/order-preview), Portfolio Stress Test (/stress-test) — pre-trade risk tools, none of which contacts a broker.",
        "Trade Execution Center (/trade-execution-center) — the fully guided Scanner-to-Monitor flow.",
        "Trade Ticket (/ticket/:scannerId) — Pre-Trade Risk Validation, order submission (Alpaca paper API only).",
        "AutoPilot (/autopilot) — entry decision log; Adjustments (/adjustments) — Attention Queue and exit/adjustment decision log.",
        "Journal (/journal), Trading Journal (/trading-journal), AI Trade Journal (/trade-journal-ai), Trade History (/trade-history), Trade Performance (/trade-performance) — post-trade review surfaces.",
      ],
      workflowSteps: [
        "Analyze a symbol's real Structure/Multi-Timeframe/Regime/Liquidity/Probability reads on Trading Research.",
        "Identify a real opportunity via the Scanner, noting its genuine Ravish Score.",
        "Evaluate risk with Position Sizing, Order Preview, and (for a broader check) Portfolio Stress Test — before building any ticket.",
        "Select a strategy the real execution engine can actually build (iron condor, iron fly, calendar spread, or an earnings play) via the Scanner's own filter — or use the Trade Execution Center's guided flow end to end.",
        "Submit through the Trade Ticket, remembering every real order here lands on Alpaca's paper-trading API, never a live market.",
        "Monitor via AutoPilot's entry log, Adjustments' exit log, and Portfolio AI's Position Threat Radar.",
        "Review post-trade in your journal of choice and Trade History/Trade Performance.",
      ],
      metricsExplained: [
        { term: "Ravish Score", explanation: "A real, computed opportunity score on every Scanner result — genuinely used as a hard execution gate; AutoPilot rejects any candidate below the platform's configured floor." },
        { term: "9 taught vs. 4 tradeable strategies", explanation: "The Strategy Academy/Library teach 9 named strategy concepts; the real, live scanner/execution engine only builds and prices 4 (iron condor, iron fly, calendar spread, earnings) — a real, disclosed gap between education and live execution capacity." },
        { term: "Paper-only broker endpoint", explanation: "This platform's Alpaca integration is hardcoded to the paper-trading API host — there is no code path anywhere that reaches a real, live market." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Running the full workflow in order",
          steps: [
            "You analyze a symbol on Trading Research, find it on the Scanner with a strong real Ravish Score, and check Position Sizing and Order Preview before touching a ticket.",
            "You select iron condor, one of the 4 structures the real execution engine actually builds, and submit through the guided Trade Execution Center.",
            "After the trade closes, you write a real journal entry and check Trade Performance.",
          ],
          note: "Every step reused a real feature in its intended order, and the strategy chosen matched what the platform can genuinely build.",
        },
        {
          label: "Average Opportunity",
          title: "Assuming a taught strategy trades live",
          steps: [
            "You study the diagonal spread in the Strategy Academy and expect to trade it through the Scanner the same way.",
            "You discover the real execution engine only builds 4 structures — diagonal isn't one of them — and pivot to a supported strategy or use the concept manually via Order Preview.",
          ],
          note: "The educational content was accurate about the concept; the mismatch was assuming every taught strategy is also a live-tradeable one.",
        },
        {
          label: "Poor Opportunity",
          title: "Skipping risk evaluation entirely",
          steps: [
            "A user goes straight from the Scanner to the Trade Ticket, skipping Position Sizing and Order Preview.",
            "The Pre-Trade Risk Validation on the ticket itself still runs, but the user missed the earlier, more detailed sizing and preview tools that would have flagged an issue sooner.",
          ],
          note: "Every risk tool in this workflow exists specifically to be used before the ticket, not discovered at the last step.",
        },
      ],
      commonMistakes: [
        "Assuming all 9 taught strategies are live-tradeable — only 4 (iron condor, iron fly, calendar spread, earnings) are actually built by the real execution engine.",
        "Confusing the Strategy Framework/Workbench (a general trading-methodology authoring tool) with the actual options-strategy picker, which lives on the Scanner itself.",
        "Expecting any real order on this platform to reach a live market — every path terminates at Alpaca's paper-trading endpoint by design.",
        "Conflating AutoPilot's entry log with Adjustments' exit/adjustment log — they are two genuinely separate decision histories.",
      ],
      riskWarnings: [
        "This is a Paper Trading platform end to end — no order submitted anywhere in this workflow, guided or manual, ever reaches a real, live market.",
        "A strong Ravish Score is a real, useful signal, but it is not a guarantee of a profitable outcome, and it should never be the sole input to a trade decision.",
      ],
      bestPractices: [
        "Run risk evaluation (Position Sizing, Order Preview, Stress Test) before building a ticket, not after.",
        "Confirm a strategy is one of the 4 the real execution engine builds before relying on the Scanner to price it.",
        "Use the Trade Execution Center's guided flow when you want the full sequence enforced for you, especially early on.",
        "Check both AutoPilot's and Adjustments' logs when reviewing what actually happened to a position — they cover different decision types.",
      ],
      aiCoachPrompts: [
        "Explain this symbol's current Ravish Score and Structure reading together.",
        "What does Risk Coach say about my saved Position Sizing result?",
        "Institutional Mentor: how does this candidate fit my existing risk budget?",
        "Walk me through why this candidate was rejected by AutoPilot's floor.",
      ],
      relatedModuleHrefs: ["/trading-research", "/scanner", "/scoring", "/position-sizing", "/order-preview", "/stress-test", "/trade-execution-center", "/autopilot", "/adjustments", "/journal", "/trading-journal", "/trade-history", "/trade-performance"],
      relatedGlossaryKeys: ["ravish-score", "position-sizing", "defined-risk"],
      nextStepKeys: ["workflow-portfolio-review"],
      estimatedMinutes: 12,
      knowledgeCheck: [
        {
          prompt: "How many options strategies does the real, live scanner/execution engine actually build and price?",
          options: ["9", "4", "1", "0 — it's all simulated"],
          correctIndex: 1,
          explanation: "Iron condor, iron fly, calendar spread, and earnings plays — 4 of the 9 the Strategy Academy/Library teach as concepts.",
        },
        {
          prompt: "Where does this platform's real order submission actually land?",
          options: ["A live market, if Live Trading is enabled", "Alpaca's paper-trading API endpoint, unconditionally", "It depends on the strategy chosen", "Nowhere — orders are only simulated client-side"],
          correctIndex: 1,
          explanation: "The broker integration is hardcoded to Alpaca's paper-api host — there is no live-market code path anywhere in this codebase.",
        },
        {
          prompt: "What is the Strategy Framework/Workbench actually for?",
          options: ["Selecting an options strategy for a real trade", "Authoring your own general Trading Engine methodology (trend/reversal/breakout/etc.)", "Viewing your portfolio's Greeks", "Submitting a live order"],
          correctIndex: 1,
          explanation: "It's a Trading-Engine-specific methodology tool — the real options-strategy picker for a trade is the Scanner's own filter.",
        },
        {
          prompt: "What does a genuinely low Ravish Score do to a candidate in AutoPilot's automated cycle?",
          options: ["Nothing — it's a display-only number", "It's rejected before ever becoming eligible for auto-execution", "It gets flagged for manual review only", "It automatically triggers a Position Sizing recalculation"],
          correctIndex: 1,
          explanation: "The Ravish Score is a real, hard execution gate — AutoPilot rejects any candidate below the configured floor.",
        },
        {
          prompt: "Are AutoPilot's decision log and Adjustments' decision log the same thing?",
          options: ["Yes, identical", "No — AutoPilot logs entry decisions, Adjustments logs exit/adjustment decisions", "Only AutoPilot has a real log", "Only Adjustments has a real log"],
          correctIndex: 1,
          explanation: "Two genuinely separate, real logs covering different halves of the trade lifecycle.",
        },
      ],
    }),
    topic({
      key: "workflow-portfolio-review",
      title: "Portfolio Review Workflow",
      summary: "Two accounts, two Health Scores, four AI-review surfaces, and one rebalancing tool with an explicit, honest scope boundary.",
      body: [
        "This platform tracks two genuinely separate accounts that are never blended: the Investing Engine's target-weight portfolios (Portfolio Construction, /stock-analyst/portfolio-construction) and the Options Income Engine's real Paper Trading account. Each has its own real, but structurally different, Portfolio Health feature: Portfolio Construction's Risk tab computes a 3-component capped-blend score (Concentration, Sector Exposure, Beta — breaching either the single-symbol 25% or sector 40% concentration cap force-caps the overall score at 60, regardless of the blend), while the Options side's Portfolio Health Score (/portfolio-dashboard) is a genuinely different 8-factor executive composite (Concentration, Diversification, Event Risk, Net Greeks Exposure, Directional Exposure, Position Sizing Quality, Position Count, Expiration Distribution). Treat these as two distinct concepts, not one feature under two names.",
        "Risk exposure spans three engines with a real, disclosed 4th composition-only surface tying them together: Investing's own risk view, the Trading Engine's portfolio-wide risk (GET /trading/risk, its own 2%-per-position / 6%-portfolio caps), and the Risk Exposure Engine (/risk-exposure-engine) — which reuses all three verbatim plus a disclosed 'Combined' cross-engine view, explicit that it never fabricates a real correlation coefficient across engines it doesn't have data for.",
        "Diversification has its own separate pair of modules: the Options side's Correlation & Concentration Risk overlay (/concentration-risk, categorical clustering by symbol/sector/strategy — honestly not a real covariance-matrix correlation) and Portfolio Construction's own Herfindahl-Hirschman-Index-based diversification score on its Quality tab — again, two separate scores, not one shared calculation.",
        "AI portfolio review draws on 4 genuinely distinct surfaces, already covered individually in the AI Academy: the AI Portfolio Analyst (deterministic, Options-side composition), Portfolio AI's own narration (a real LLM call, but narrating market-wide inputs — not a free-form chat about your specific portfolio), the Institutional AI Coach's Portfolio coach (deterministic, Investing-side), and Institutional Mentor (/institutional-mentor — the one page surfacing both accounts' own review sections together, though the Investing side's sections are lighter-weight summaries compared to the Options side's full 9-category Scorecard).",
        "Rebalancing is genuinely implemented — but only for the Investing Engine's target-weight portfolios. The Rebalancing Engine (/rebalancing-engine) computes real drift and a 'capital movement required' figure against your own stored target weights, and its own source header states this scope boundary explicitly: neither Trading Engine positions nor Options trades carry a stored target-weight field anywhere in this codebase, so rebalancing simply cannot and does not apply to either. It is planning and labeling only — zero automatic execution, zero trade recommendations.",
      ],
      whyItMatters: "Knowing precisely which of this platform's risk/diversification/health figures belong to which account — and that rebalancing genuinely only covers one of the three — prevents the single most likely portfolio-review mistake: assuming a number from one engine describes your exposure platform-wide.",
      difficulty: "advanced",
      whyItExists: "Every module in this review draws from an already-shipped, already-tested engine (Portfolio Construction, the Options Portfolio Dashboard, the 3 risk engines, the 2 diversification modules, the 4 AI-review surfaces, and the Rebalancing Engine) with zero new scoring introduced by this lesson — its only job is making the real account boundaries and the Rebalancing Engine's real scope limit explicit in one place.",
      institutionalThinking: "A professional portfolio review never assumes a single number describes total exposure — it deliberately checks each account's own risk/health/diversification figure separately, and treats a cross-engine 'combined' view (where one exists) as a labeled estimate, never as a precise, blended truth.",
      screenWalkthrough: [
        "Portfolio Construction (/stock-analyst/portfolio-construction) — Risk tab for Investing's own capped-blend score; Quality tab for its HHI-based diversification.",
        "Portfolio Dashboard (/portfolio-dashboard) — the Options Engine's own 8-factor Health Score.",
        "Risk Exposure Engine (/risk-exposure-engine) — Investing, Trading, and Options risk views plus a disclosed Combined view.",
        "Concentration Risk (/concentration-risk) — Options-side categorical clustering.",
        "Institutional Mentor (/institutional-mentor) — both accounts' review sections on one page.",
        "Rebalancing Engine (/rebalancing-engine) — Investing-only drift/rebalance planning.",
      ],
      workflowSteps: [
        "Review each account's own Portfolio Health figure separately — Investing's Risk tab and the Options Portfolio Dashboard are not the same score.",
        "Check risk exposure per engine on the Risk Exposure Engine, reading the Combined view as a labeled estimate, not a precise blend.",
        "Review diversification on Portfolio Construction's Quality tab (Investing) and Concentration Risk (Options) — two separate modules.",
        "Use Institutional Mentor for a single-page summary spanning both accounts.",
        "For target-weight Investing portfolios specifically, check the Rebalancing Engine's drift and capital-movement figures — remembering this never applies to Trading or Options positions.",
      ],
      metricsExplained: [
        { term: "SINGLE_SYMBOL_CONCENTRATION_CAP_PCT / SECTOR_CONCENTRATION_CAP_PCT", explanation: "25%/40% hard caps reused verbatim across Portfolio Construction's Risk tab, the Decision Engine, the Institutional AI Coach's Portfolio coach, and Portfolio Optimisation — one shared source of truth for a concentration breach, Investing-side." },
        { term: "8-factor Options Portfolio Health Score", explanation: "Concentration, Diversification, Event Risk, Net Greeks Exposure, Directional Exposure, Position Sizing Quality, Position Count, Expiration Distribution — a genuinely different composite from Investing's own 3-component Risk tab score." },
        { term: "Rebalancing scope boundary", explanation: "The Rebalancing Engine only ever applies to Investing's own target-weight portfolios — Trading Engine and Options positions carry no stored target-weight field anywhere, by design, so rebalancing cannot cover them." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Reviewing both accounts with the right tool for each",
          steps: [
            "You check Portfolio Construction's Risk tab for your Investing portfolio's capped-blend score and the Options Portfolio Dashboard for your trading account's own 8-factor score, separately.",
            "You visit Institutional Mentor for a combined-page summary, then Rebalancing Engine specifically for your Investing holdings' drift.",
          ],
          note: "Each account got its own correct tool, and the one cross-account rebalancing question stayed scoped to where it actually applies.",
        },
        {
          label: "Average Opportunity",
          title: "Reading the Risk Exposure Engine's Combined view as exact",
          steps: [
            "You see a single 'Combined' risk number on the Risk Exposure Engine and treat it as a precise, unified figure.",
            "You re-read the page's own disclosure that the Combined view relies on a symbol-overlap proxy, never a fabricated real correlation coefficient, and adjust your confidence in that one number accordingly.",
          ],
          note: "The Combined view is genuinely useful directional information — the mistake was over-trusting its precision.",
        },
        {
          label: "Poor Opportunity",
          title: "Expecting Rebalancing to cover a Trading Engine position",
          steps: [
            "A user opens the Rebalancing Engine expecting to see drift/rebalance suggestions for a stop/target Trading Engine position.",
            "The Rebalancing Engine's own scope boundary means Trading Engine positions never appear there at all — no target-weight field exists for them anywhere.",
          ],
          note: "This is the single most important scope limit in this whole lesson to internalize before relying on the Rebalancing Engine at all.",
        },
      ],
      commonMistakes: [
        "Treating the Investing Risk tab's score and the Options Portfolio Health Score as the same feature under two names — they use genuinely different formulas.",
        "Reading the Risk Exposure Engine's 'Combined' view as a precise, fabricated correlation-adjusted figure rather than a disclosed, labeled estimate.",
        "Expecting the Rebalancing Engine to apply to Trading Engine or Options positions — it is explicitly, permanently Investing-only.",
        "Assuming Institutional Mentor's Investing-side review sections are as deep as its Options-side 9-category Scorecard — they're deliberately lighter-weight.",
      ],
      riskWarnings: [
        "No portfolio-review figure on this platform — deterministic score, LLM narration, or rebalancing suggestion — is a trade recommendation or portfolio-optimisation output; every one exists to explain already-computed figures.",
        "The Rebalancing Engine performs zero automatic execution — every rebalance suggestion is planning and labeling only, always requiring your own manual action elsewhere.",
      ],
      bestPractices: [
        "Review each account's own risk/health figure on its own dedicated page before looking for a combined view.",
        "Treat the Risk Exposure Engine's Combined view as directional, not precise, given its own disclosed correlation-proxy limitation.",
        "Use Institutional Mentor as your single-page starting point, then drill into the account-specific page for real depth.",
        "Confirm you're looking at an Investing-side target-weight portfolio before relying on the Rebalancing Engine at all.",
      ],
      aiCoachPrompts: [
        "Institutional AI Coach: explain my Portfolio Coach's read on my current sector concentration.",
        "Institutional Mentor: summarize both my Investing and Options accounts' health in one view.",
        "Ask the Rebalancing Engine's coach panel to explain drift and thresholds in general terms.",
        "Portfolio AI: what does today's Market Briefing suggest about my current risk posture?",
      ],
      relatedModuleHrefs: ["/stock-analyst/portfolio-construction", "/portfolio-dashboard", "/risk-exposure-engine", "/concentration-risk", "/institutional-mentor", "/rebalancing-engine", "/portfolio-analyst", "/portfolio-ai"],
      relatedGlossaryKeys: ["portfolio-health", "concentration-cap", "portfolio-diversification-score", "portfolio-optimisation"],
      nextStepKeys: ["workflow-options"],
      estimatedMinutes: 11,
      knowledgeCheck: [
        {
          prompt: "Are the Investing Engine's Risk tab score and the Options Engine's Portfolio Health Score the same calculation?",
          options: ["Yes, identical", "No — a 3-component capped-blend score (Investing) vs. an 8-factor executive composite (Options)", "Only for symbols in both accounts", "Neither is real"],
          correctIndex: 1,
          explanation: "Two genuinely different formulas for two genuinely different accounts — never interchange them.",
        },
        {
          prompt: "Does the Rebalancing Engine cover Trading Engine or Options positions?",
          options: ["Yes, all three engines equally", "No — explicitly Investing-only, since only Investing holdings carry a stored target-weight field", "Only Options positions", "Only if Live Trading is enabled"],
          correctIndex: 1,
          explanation: "The Rebalancing Engine's own source header states this scope boundary explicitly.",
        },
        {
          prompt: "What does the Risk Exposure Engine's 'Combined' cross-engine view rely on for correlation?",
          options: ["A precise, computed correlation coefficient across all positions", "A disclosed symbol-overlap proxy, never a fabricated correlation coefficient", "It doesn't attempt any cross-engine combination", "Live market correlation data"],
          correctIndex: 1,
          explanation: "The page's own design honestly discloses this limitation rather than fabricating a precise figure it doesn't have.",
        },
        {
          prompt: "Which page shows both the Investing and Options accounts' own review sections together?",
          options: ["Portfolio Construction only", "Institutional Mentor", "The Rebalancing Engine", "Portfolio AI only"],
          correctIndex: 1,
          explanation: "Institutional Mentor surfaces both accounts' review sections on one page, though the Investing sections are lighter-weight than the Options side's full Scorecard.",
        },
        {
          prompt: "Does Rebalancing Engine ever automatically execute a trade?",
          options: ["Yes, once you approve a suggestion", "No — it is planning and labeling only, zero automatic execution", "Only for small drift amounts", "Only in Paper Trading mode"],
          correctIndex: 1,
          explanation: "Its own header states zero automatic rebalancing, zero automatic execution — every suggestion requires your own manual action elsewhere.",
        },
      ],
    }),
    topic({
      key: "workflow-options",
      title: "Options Workflow",
      summary: "From strategy selection to exit planning, using only the 4 structures this platform actually builds — and the honest boundary on what 'probability' means here.",
      body: [
        "Strategy selection carries the same real nuance the Professional Trade Workflow lesson already introduced: the platform teaches 9 named strategies but its live scanner/execution engine only ever builds and prices 4 (iron condor, iron fly, calendar spread, earnings). The Scanner's own strategy filter (/scanner) is where you actually select one of these 4 for a real candidate — the Strategy Framework and Strategy Workbench pages are a separate, Trading-Engine-specific methodology tool, not an options-strategy picker.",
        "Greeks review is real but distributed, not concentrated on one page: per-strike delta/theta on the Option Chain (/options/:symbol), Greeks in context on the Trade Ticket, and net portfolio Greeks (delta/theta/vega) surfaced consistently across Concentration Risk, the Portfolio Dashboard, the Risk Exposure Engine, and both Portfolio AI/Portfolio Analyst — all sourced from the same shared Greeks-computation function, so the number is consistent wherever you see it.",
        "Probability analysis means two genuinely different things depending on which engine you're in, and conflating them is a real, easy mistake: Options POP (probability of profit) is a per-trade figure shown on Scanner results and the Trade Ticket, computed inside the options pricing engine itself. The Trading Engine's own probability cone (/trading-research) is a separate, price-action-based ±1σ/±2σ dispersion estimate over historical volatility — explicitly never a directional forecast. Different math, different engines, don't treat one as a substitute for the other.",
        "Risk assessment on a specific ticket runs through the Trade Ticket's own Pre-Trade Risk Validation section, backed by the same Position Sizing and Portfolio Stress Test tools the Professional Trade Workflow already covers — Stress Test's own preset scenarios (price/IV/time shocks) are re-priced against your real open trades as a hypothetical, in-memory what-if, never persisted as a forecast.",
        "Monitoring positions uses two genuinely separate logs (AutoPilot's entry log, Adjustments' exit/adjustment log — see the Professional Trade Workflow lesson) plus, where a position is tracked in it, the Options Lifecycle Manager's own 8-stage tracker (/options-lifecycle-manager). Its `reviewCadence` field (daily/weekly/monthly/expiration/manual) is a label you set yourself, never a scheduler — nothing fires automatically from it. Exit planning itself (the real roll/convert/close action set, and which of those a human must always submit manually) is already fully taught in this platform's own 'Managing Existing Positions' lesson — this workflow lesson connects to it (Adjustments' Attention Queue → Trade Adjustment Preview's dry run → the real Trade Ticket submission) rather than re-teaching the same mechanics twice.",
      ],
      whyItMatters: "An options workflow built around the real 4-structure execution set, the genuinely distributed Greeks display, and the two distinct probability concepts avoids the most common way this platform's own breadth becomes confusing — mistaking a taught concept, a differently-scoped engine, or a label for something it isn't.",
      difficulty: "advanced",
      whyItExists: "This lesson deliberately does not re-teach exit mechanics already covered in 'Managing Existing Positions,' or Greeks/POP math already covered in the Greeks and Volatility paths — its only new content is the workflow sequencing itself and 3 disclosed distinctions (4-vs-9 strategies, distributed Greeks, two different 'probability' concepts) that only become visible when you look at the whole options workflow at once.",
      institutionalThinking: "A professional options trader keeps a precise mental map of which number came from which engine's own math — Options POP is not the Trading Engine's probability cone, and a taught strategy concept is not automatically a live-tradeable one — because conflating either pair leads to relying on a figure that doesn't actually mean what you think it means.",
      screenWalkthrough: [
        "Scanner (/scanner) — real strategy filter over the 4 live-tradeable structures.",
        "Option Chain (/options/:symbol) — per-strike Greeks.",
        "Trade Ticket — Pre-Trade Risk Validation, Greeks in context, Options POP.",
        "Trading Research (/trading-research) — the separate Probability card (Trading Engine's own dispersion cone).",
        "Portfolio Stress Test (/stress-test) — hypothetical price/IV/time scenarios re-priced against real open trades.",
        "Options Lifecycle Manager (/options-lifecycle-manager) — 8-stage position tracker, user-set review-cadence tag.",
        "Adjustments (/adjustments) and Trade Adjustment Preview (/adjustment-preview) — exit planning, cross-referenced to 'Managing Existing Positions.'",
      ],
      workflowSteps: [
        "Select a strategy from the real 4-structure set via the Scanner's own filter.",
        "Review Greeks across the Option Chain, Trade Ticket, and (post-entry) your portfolio-level pages.",
        "Read Options POP on the ticket itself; separately check the Trading Engine's probability cone if you want a price-action-based dispersion view for the underlying.",
        "Run Position Sizing, Order Preview, and Portfolio Stress Test before submitting.",
        "Monitor via AutoPilot/Adjustments' two logs and, if tracked, the Options Lifecycle Manager.",
        "For exit planning specifics, follow this platform's own 'Managing Existing Positions' lesson — Attention Queue → Trade Adjustment Preview → Trade Ticket submission.",
      ],
      metricsExplained: [
        { term: "Options POP", explanation: "A per-trade probability-of-profit figure computed by the options pricing engine, shown on Scanner results and the Trade Ticket — distinct from the Trading Engine's own probability cone." },
        { term: "Trading Engine probability cone", explanation: "A ±1σ/±2σ dispersion estimate over historical volatility, computed for the underlying's price action — never a directional forecast, and a different calculation entirely from Options POP." },
        { term: "reviewCadence (Options Lifecycle Manager)", explanation: "A user-set label (daily/weekly/monthly/expiration/manual) on a tracked position — descriptive only; nothing fires automatically from it." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Selecting a real, live-tradeable structure and reading both probability figures correctly",
          steps: [
            "You select an iron condor via the Scanner's filter (one of the 4 real structures), read its Options POP on the ticket, and separately check the underlying's Trading Engine probability cone for broader context.",
            "You keep the two probability figures mentally distinct rather than combining them.",
          ],
          note: "Choosing a real, tradeable strategy and correctly distinguishing two genuinely different probability concepts avoids two common mistakes at once.",
        },
        {
          label: "Average Opportunity",
          title: "Using the Options Lifecycle Manager's cadence tag as if it were a reminder system",
          steps: [
            "You set a position's reviewCadence to 'weekly' expecting a notification to fire each week.",
            "You discover, on rereading the feature's own disclosure, that nothing fires automatically — the tag is descriptive only, and you build your own manual habit around it instead.",
          ],
          note: "The tag is genuinely useful as a personal label — the mistake was expecting automation that was never built.",
        },
        {
          label: "Poor Opportunity",
          title: "Trying to select a diagonal spread on the Scanner",
          steps: [
            "A user filters the Scanner for a diagonal spread, expecting it to appear the way iron condor or calendar spread would.",
            "It never will — the real execution engine only builds 4 structures, and diagonal isn't one of them.",
          ],
          note: "Knowing the real 4-structure set in advance prevents a frustrating, avoidable search for a filter option that doesn't exist.",
        },
      ],
      commonMistakes: [
        "Expecting the Scanner to filter by any of the 5 strategies the real execution engine doesn't build.",
        "Conflating Options POP with the Trading Engine's own probability cone — two different calculations, two different engines.",
        "Expecting the Options Lifecycle Manager's reviewCadence tag to trigger a notification or automated action.",
        "Re-deriving exit-planning mechanics from scratch instead of using this platform's own 'Managing Existing Positions' lesson as the reference.",
      ],
      riskWarnings: [
        "Portfolio Stress Test's scenarios are hypothetical, in-memory what-ifs — never persisted as a forecast, and never a guarantee of how a real market move would actually play out.",
        "Neither Options POP nor the Trading Engine's probability cone is a prediction of what will happen — both describe dispersion/likelihood under stated assumptions, never a guaranteed outcome.",
      ],
      bestPractices: [
        "Confirm a strategy is one of the real 4 before relying on the Scanner to filter for it.",
        "Read Greeks from whichever page is most relevant to the moment (Option Chain pre-trade, portfolio pages post-entry) rather than expecting one dedicated 'Portfolio Greeks' page.",
        "Keep Options POP and the Trading Engine's probability cone mentally separate — they answer different questions.",
        "Build your own manual habit around the Options Lifecycle Manager's cadence tags rather than expecting automation.",
      ],
      aiCoachPrompts: [
        "Explain this candidate's Options POP and what it does and doesn't tell me.",
        "How is the Trading Engine's probability cone different from this trade's own POP?",
        "Trading AI Coach: explain today's Scenario coach output for this position.",
        "Journal Coach: summarize how my last 5 closed iron condors actually performed.",
      ],
      relatedModuleHrefs: ["/scanner", "/options/SPY", "/trading-research", "/stress-test", "/options-lifecycle-manager", "/adjustments", "/adjustment-preview", "/strategy-framework"],
      relatedGlossaryKeys: ["defined-risk", "portfolio-greeks", "max-portfolio-risk"],
      nextStepKeys: ["workflow-weekly-monthly-review"],
      estimatedMinutes: 11,
      knowledgeCheck: [
        {
          prompt: "Where does a user actually select one of the 4 real, live-tradeable options strategies?",
          options: ["The Strategy Framework page", "The Scanner's own strategy filter", "The Strategy Academy", "There is no selection mechanism"],
          correctIndex: 1,
          explanation: "The Strategy Framework/Workbench are a separate Trading-Engine methodology tool — the real options-strategy picker is on the Scanner itself.",
        },
        {
          prompt: "Are Options POP and the Trading Engine's probability cone the same calculation?",
          options: ["Yes, identical math", "No — genuinely different engines and formulas, never a substitute for each other", "Only for the 4 tradeable strategies", "Neither is real"],
          correctIndex: 1,
          explanation: "Options POP is per-trade options pricing math; the Trading Engine's cone is a separate, price-action-based dispersion estimate.",
        },
        {
          prompt: "Does setting a position's reviewCadence to 'weekly' in the Options Lifecycle Manager trigger any automatic action?",
          options: ["Yes, a weekly reminder notification fires", "No — it's a descriptive label only; nothing fires automatically", "Yes, but only for iron condors", "It automatically closes the position after a week"],
          correctIndex: 1,
          explanation: "The feature's own disclosure is explicit: it's a tag, never a scheduler.",
        },
        {
          prompt: "Is there one single dedicated 'Portfolio Greeks' page on this platform?",
          options: ["Yes, exactly one page", "No — net Greeks are distributed across Concentration Risk, the Portfolio Dashboard, Risk Exposure Engine, and Portfolio AI/Analyst, from one shared function", "Only on the Trade Ticket", "Greeks are never shown at portfolio level"],
          correctIndex: 1,
          explanation: "Greeks appear consistently across several pages, all sourced from the same underlying computation, rather than one dedicated page.",
        },
        {
          prompt: "Where should you go to learn the real roll/convert/close exit mechanics in depth?",
          options: ["This lesson re-teaches them here", "The existing 'Managing Existing Positions' lesson, which this workflow lesson links to rather than duplicates", "There is no lesson covering exits", "The Strategy Academy"],
          correctIndex: 1,
          explanation: "Exit mechanics are already fully taught elsewhere — this workflow lesson deliberately connects to that content instead of repeating it.",
        },
      ],
    }),
    topic({
      key: "workflow-weekly-monthly-review",
      title: "Weekly & Monthly Review",
      summary: "A genuinely real, user-initiated Workflow Center with named weekly/monthly/quarterly reviews — plus 2 honest gaps: no real per-strategy win rate, and no persisted improvement-plan feature.",
      body: [
        "Performance review draws on 4-5 genuinely distinct modules, and knowing which is which matters: Performance Analytics (/performance, options side) is explicitly **synthetic** — its own source header states the real trades table holds far too few closed positions for meaningful analytics, so this module generates a deterministic, seeded synthetic population instead, never touching real trade data. Trading Analytics Dashboard (/trading-analytics) is real, but activity-based (checklist completion, session activity, real R-multiple distribution from journal entries), not a P&L breakdown. Performance Attribution Engine (/performance-attribution-engine) is real, cross-engine, analytical-only, computing real Sharpe/Sortino ratios from real trade returns across all three accounts. Trade Performance (/trade-performance) is real and local-data-only, explicitly disclosed as never inventing a broker-side realized P&L figure the platform doesn't actually have.",
        "Journaling has 3 genuinely distinct systems: the options-side Journal (/journal, manual entries with mood tagging), the Trading Engine's own Trading Journal (/trading-journal, a separate table, separate CRUD, includes a real delete action the options Journal doesn't), and the AI Trade Journal (/trade-journal-ai) — which despite its name is not a manual-entry system at all, but a deterministic behavioral-analysis and trade-review engine, explicitly self-disclaimed as never a chatbot or trading-signal generator.",
        "AI-assisted reflection is real and specific: the options-side Journal has a genuine AI journal-review feature — submitting a closed trade for a real, streamed LLM-generated review (with a deterministic template fallback), which persists both the review and a `lessonLearned` field back onto your own journal entry. This is the platform's actual 'AI-assisted reflection' capability, distinct from the deterministic AI Trade Journal.",
        "Weekly and monthly review is genuinely real, and worth stating plainly: the Portfolio Workspace's Workflow Center (/portfolio-workspace) has named, real workflow definitions — including weekly, monthly, and quarterly reviews — each with a real step checklist linking to already-shipped pages (a Weekly Review, for instance, steps through Performance & Attribution, Scenario Engine, Watchlists, and Reporting Centre). Starting an instance, checking off steps, and completing it are all real, persisted actions. The one honest limit: cadence here is a **label describing how often a professional would typically run it**, never a scheduler — nothing on this platform fires a workflow automatically on a calendar; you always start it yourself.",
        "Strategy review has a real gap worth disclosing rather than glossing over: no page on this platform shows a genuine, non-synthetic win-rate-by-strategy breakdown — the only win-rate-by-strategy view (on the synthetic Performance Analytics page) is explicitly not real trade data. Real per-strategy figures do exist, just in different forms: checklist-completion-by-strategy (Trading Analytics Dashboard) and capital-allocation-by-strategy (Performance Attribution Engine's income attribution). Improvement planning, finally, does not exist as a platform feature at all — no persisted action-item or improvement-plan tool exists anywhere in this codebase, confirmed by a direct search. Treat it as a manual practice: write your own action items, informed by what the Attention Queue, journal reviews, and Performance Attribution surfaced, outside any platform feature that tracks them for you.",
      ],
      whyItMatters: "A weekly/monthly review built on the real Workflow Center, the correctly-attributed performance modules, and an honest acknowledgment of the two real gaps (per-strategy win rate, improvement-plan tracking) produces a genuinely disciplined cadence — without ever mistaking synthetic data for real history or expecting the platform to schedule or remember something it deliberately doesn't.",
      difficulty: "advanced",
      whyItExists: "This lesson exists specifically to correct a real, disclosed documentation gap: an earlier Learning Centre lesson (still linked below) predates the Portfolio Workspace's Workflow Center and states no dedicated weekly-review feature exists — that was accurate when written and is now stale, since the Workflow Center genuinely ships weekly/monthly/quarterly review workflows today.",
      institutionalThinking: "A professional's weekly and monthly review is a fixed, repeatable checklist run on their own initiative, not something they wait for a system to trigger — and knowing precisely which performance figure is real trade history versus a synthetic stand-in is the single most important honesty check in this entire review cycle.",
      screenWalkthrough: [
        "Portfolio Workspace (/portfolio-workspace) — Workflow Center tab, start a Weekly/Monthly/Quarterly Review instance, check off its real steps.",
        "Performance Attribution Engine (/performance-attribution-engine) — real, cross-engine Sharpe/Sortino and income attribution.",
        "Trading Analytics Dashboard (/trading-analytics) — real activity/checklist/R-multiple analytics.",
        "Trade Performance (/trade-performance) — real, local-data-only trade history analytics.",
        "Journal (/journal) — AI journal-review feature, a real streamed LLM review persisted back to your own entry.",
        "Trading Journal (/trading-journal) and AI Trade Journal (/trade-journal-ai) — the two other, genuinely distinct journal systems.",
      ],
      workflowSteps: [
        "Start a Weekly or Monthly Review instance on the Portfolio Workspace's Workflow Center yourself — nothing triggers it automatically.",
        "Step through its checklist, which links to Performance & Attribution, Scenario Engine, Watchlists, and Reporting Centre.",
        "Review real performance via the Performance Attribution Engine and Trade Performance, keeping the synthetic Performance Analytics page's data clearly labeled as such in your own mind.",
        "Submit a closed trade for AI journal review to get a real, LLM-narrated post-mortem persisted to your journal entry.",
        "Write your own action items based on what the review surfaced — there is no platform feature to track them for you.",
      ],
      metricsExplained: [
        { term: "Workflow Center cadence", explanation: "A descriptive label (daily/weekly/monthly/quarterly/ad hoc) on a named review workflow — never a scheduler; every instance is started manually by the user." },
        { term: "Synthetic vs. real performance data", explanation: "Performance Analytics (/performance) is explicitly synthetic, seeded RNG data; Performance Attribution Engine, Trading Analytics Dashboard, and Trade Performance are all real, disclosed by their own source headers." },
        { term: "AI journal review", explanation: "A real, streamed LLM-generated post-mortem for a closed trade (with a deterministic template fallback), persisting a `lessonLearned` field back onto the journal entry — this platform's actual AI-assisted-reflection feature." },
      ],
      workedExamples: [
        {
          label: "Good Opportunity",
          title: "Running a real Weekly Review instance end to end",
          steps: [
            "You start a Weekly Review on the Portfolio Workspace, step through Performance & Attribution and Watchlists as its checklist directs, and check items off as you complete them.",
            "You submit a closed trade for AI journal review, and write your own action items based on what surfaced — knowing no platform feature will track them for you.",
          ],
          note: "Every step used a genuinely real, persisted feature, and the review ended with a concrete, self-owned follow-up.",
        },
        {
          label: "Average Opportunity",
          title: "Citing Performance Analytics' win rate as real trade history",
          steps: [
            "You reference the 'best strategy' figure on /performance in a review, treating it as your own real track record.",
            "You recheck the page's own source disclosure, confirm it's synthetic, seeded data, and switch to Performance Attribution Engine's real capital-allocation figures instead.",
          ],
          note: "The synthetic figure wasn't fabricated maliciously — the platform discloses it plainly — but citing it as real history would have been a genuine, avoidable mistake.",
        },
        {
          label: "Poor Opportunity",
          title: "Waiting for the platform to remind you to run a Monthly Review",
          steps: [
            "A user sets a position's or workflow's cadence to 'monthly' and waits for a notification to prompt the review.",
            "No notification ever fires — cadence is a label, not a scheduler, on this platform by design.",
          ],
          note: "The Workflow Center is real and genuinely useful, but it requires you to start it yourself, every time.",
        },
      ],
      commonMistakes: [
        "Assuming no weekly-review feature exists — the Portfolio Workspace's Workflow Center genuinely ships one today.",
        "Expecting a review workflow's cadence label to trigger anything automatically — it never does.",
        "Citing the synthetic Performance Analytics page's figures as real trade history.",
        "Expecting a persisted improvement-plan or action-item feature — none exists; this must be a manual practice.",
      ],
      riskWarnings: [
        "Performance Analytics' (/performance) figures are explicitly synthetic and must never be presented or relied upon as real trading history.",
        "An AI journal review is educational reflection, not a trading signal — its persisted lessonLearned text is meant to inform your own future judgment, never to replace it.",
      ],
      bestPractices: [
        "Start your Weekly/Monthly/Quarterly Review instance on a cadence you set yourself, since the platform never will.",
        "Always check which performance page you're looking at before citing a figure — synthetic (/performance) vs. real (Performance Attribution, Trading Analytics, Trade Performance).",
        "Use the AI journal review feature on closed trades specifically for its real, persisted reflection, not as a general chat.",
        "Write your own action items after each review — treat this as a personal practice this platform intentionally doesn't track for you.",
      ],
      aiCoachPrompts: [
        "Journal Coach: review my last closed trade and suggest a lesson learned.",
        "Trading AI Coach: summarize my recent Trading Analytics checklist completion by strategy.",
        "Institutional Mentor: what does my Monthly Review workflow's checklist recommend I look at first?",
        "Ask Performance Attribution to explain my real Sharpe ratio this month.",
      ],
      relatedModuleHrefs: ["/portfolio-workspace", "/performance-attribution-engine", "/trading-analytics", "/trade-performance", "/journal", "/trading-journal", "/trade-journal-ai", "/performance"],
      relatedGlossaryKeys: ["review-workflow-cadence", "llm-narration-source"],
      nextStepKeys: [],
      estimatedMinutes: 12,
      knowledgeCheck: [
        {
          prompt: "Does a real, named Weekly Review workflow exist on this platform today?",
          options: ["No, never implemented", "Yes — the Portfolio Workspace's Workflow Center has a real weekly_review workflow with a persisted step checklist", "Only for Options accounts", "Only in Live Trading mode"],
          correctIndex: 1,
          explanation: "A genuinely real, DB-backed feature (Phase 44) — an earlier Learning Centre lesson predates it and has since been corrected to reflect this.",
        },
        {
          prompt: "Does a Workflow Center review's 'weekly' cadence label trigger anything automatically?",
          options: ["Yes, a scheduled reminder", "No — it's a descriptive label only; every instance is started manually", "Only if notifications are enabled", "Yes, it auto-completes the checklist"],
          correctIndex: 1,
          explanation: "Cadence is metadata describing how often a professional would run it — never a scheduler.",
        },
        {
          prompt: "Which performance module is explicitly built on synthetic, not real, trade data?",
          options: ["Performance Attribution Engine", "Trade Performance", "Performance Analytics (/performance)", "Trading Analytics Dashboard"],
          correctIndex: 2,
          explanation: "Its own source header discloses this directly — the real trades table has too few closed positions for meaningful analytics, so this module uses seeded synthetic data instead.",
        },
        {
          prompt: "What does the real AI journal review feature actually do?",
          options: ["Predicts your next trade's outcome", "Generates a real, streamed LLM post-mortem for a closed trade and persists a lessonLearned field to your journal entry", "Automatically journals every trade for you", "Nothing — it's purely deterministic with no LLM involvement"],
          correctIndex: 1,
          explanation: "A genuine LLM-narrated feature (with a deterministic template fallback), distinct from the deterministic AI Trade Journal.",
        },
        {
          prompt: "Does this platform have a persisted 'improvement plan' or 'action item' feature?",
          options: ["Yes, a full task-tracking system", "No — confirmed absent anywhere in the codebase; this must be a manual, self-directed practice", "Only for Investing accounts", "Only inside the Workflow Center"],
          correctIndex: 1,
          explanation: "A direct search confirms no such feature exists — improvement planning here is honestly taught as a manual practice, never a tracked platform capability.",
        },
      ],
    }),
  ],
