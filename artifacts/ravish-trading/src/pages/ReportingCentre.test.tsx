...
const mockState = vi.hoisted(() => ({
  reportTypes: [
    ...
    { reportType: "options-income-summary", label: "Options Income Summary Report", description: "d", requiresSymbol: false, requiresPortfolio: false },
  ] as unknown[],
...
vi.mock("@workspace/api-client-react", async () => {
  ...
  return {
    ...
    useGetOptionsIncomeSummaryReport: reportResult,
